...
public class TC_5772549_AMER_CH_RetailRegistrationPage_Esupport extends BaseTest {
	@Test
	public void validate_TC_5772549_AMER_CH_RetailRegistrationPage_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _5772549_AMER_CH");
			...
			//obj_EsupportRetailAssetWorkflow.privacyStatement(driver);

		}
		catch(Exception e){

			Assert.fail("Failed while executing test case TC_5772549_AMER_CH_RetailRegistrationPage_Esupport--------->\n  "+e);

...
public class TC_9785921_AMER_ED_LBK_OpenContent_SecurityNotices_Customer_L30_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785921_AMER_ED_LBK_OpenContent_SecurityNotices_Customer_L30_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785921_AMER_ED_LBK_OpenContent_SecurityNotices_Customer_L30_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785921_AMER_ED_LBK_OpenContent_SecurityNotices_Customer_L30_ESUPPORT()--------->\n  "+e);
		}
	}
}

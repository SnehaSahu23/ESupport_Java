...
public class TC_5776294_AMER_IE_DigitalProductsScenariosProductManagementpageusinghorizontaltabsLogoutloginasPartner_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5776294_AMER_IE_DigitalProductsScenariosProductManagementpageusinghorizontaltabsLogoutloginasPartner_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# 5776294_AMER_IE_DigitalProductsScenariosProductManagementpageusinghorizontaltabsLogoutloginasPartner_Esupport");
...
//			obj_EsupportDDLWorkflow.ToClick_Orderdetails(driver);	
		...
		{
			Assert.fail("Failed while executing test case 5776294_AMER_IE_DigitalProductsScenariosProductManagementpageusinghorizontaltabsLogoutloginasPartner_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_5836606_AMER_IE_Coveo_Noresultpageforsecondarylanguageforcountries_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5836606_AMER_IE_Coveo_Noresultpageforsecondarylanguageforcountries_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5836606_AMER_IE_Coveo_Noresultpageforsecondarylanguageforcountries_Esupport");
...
//			obj_EsupportCoveoWorkflow.changeCountry(driver);
		...
		{
			Assert.fail("Failed in TC_5836606_AMER_IE_Coveo_Noresultpageforsecondarylanguageforcountries_Esupport--------->\n  "+e);
		}
	}
}

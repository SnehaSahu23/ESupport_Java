...
public class TC_5795108_AMER_ED_NavigationtoSRSearchpagethroughdirectURL_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5795108_AMER_ED_NavigationtoSRSearchpagethroughdirectURL_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5795108_AMER_ED_NavigationtoSRSearchpagethroughdirectURL_Esupport");
		...
		{
			Assert.fail("Failed while TC_5795108_AMER_ED_NavigationtoSRSearchpagethroughdirectURL_Esupport--------->\n  "+e);
		}

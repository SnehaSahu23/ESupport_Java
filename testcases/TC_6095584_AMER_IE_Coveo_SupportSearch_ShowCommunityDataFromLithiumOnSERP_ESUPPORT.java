...
public class TC_6095584_AMER_IE_Coveo_SupportSearch_ShowCommunityDataFromLithiumOnSERP_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6095584_AMER_IE_Coveo_SupportSearch_ShowCommunityDataFromLithiumOnSERP_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6095584_AMER_IE_Coveo_SupportSearch_ShowCommunityDataFromLithiumOnSERP_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_6095584_AMER_IE_Coveo_SupportSearch_ShowCommunityDataFromLithiumOnSERP_ESUPPORT--------->\n  "+e);
		}
	}
}

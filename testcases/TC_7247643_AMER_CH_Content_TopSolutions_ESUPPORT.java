...
public class TC_7247643_AMER_CH_Content_TopSolutions_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7247643_AMER_CH_Content_TopSolutions_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7247643_AMER_CH_Content_TopSolutions_ESUPPORT()");
		...
		{
			Assert.fail("Failed in TC_7247643_AMER_CH_Content_TopSolutions_ESUPPORT()--------->\n  "+e);
		}
	}
}

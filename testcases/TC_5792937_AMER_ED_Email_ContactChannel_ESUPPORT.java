...
public class TC_5792937_AMER_ED_Email_ContactChannel_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5792937_AMER_ED_Email_ContactChannel_ESUPPORT() 
	{

		try
		{
			
			System.out.println("Starts TC_5792937_AMER_ED_Email_ContactChannel_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5792937_AMER_ED_Email_ContactChannel_ESUPPORT--------->\n  "+e);

...
public class TC_7035662_AMER_CH_UNI_CustomGroupCreationforCPusingAccountSitesSiteGroup extends BaseTest
{
	@Test
	public void validate_TC_7035662_AMER_CH_UNI_CustomGroupCreationforCPusingAccountSitesSiteGroup() 
	{
		try
		{
			System.out.println("Starts TC_7035662_AMER_CH_UNI_CustomGroupCreationforCPusingAccountSitesSiteGroup");
			Thread.sleep(10000);	
			...
			Thread.sleep(10000);	
			obj_EsupportUnifiedPortalWorkflow.selectSiteAndAddToGroup(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed in TC_7035662_AMER_CH_UNI_CustomGroupCreationforCPusingAccountSitesSiteGroup--------->\n  "+e);
		}
	}
}

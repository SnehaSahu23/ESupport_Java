...
public class TC_7056247_AMER_FF_Contact_CONTACTCHANNELS_GENERALPHONENUMBERS_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7056247_AMER_FF_Contact_CONTACTCHANNELS_GENERALPHONENUMBERS_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7056247_AMER_FF_Contact_CONTACTCHANNELS_GENERALPHONENUMBERS_LDELL_ESUPPORT");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7056247_AMER_FF_Contact_CONTACTCHANNELS_GENERALPHONENUMBERS_LDELL_ESUPPORT--------->\n  "+e);

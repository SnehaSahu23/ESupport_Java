...
public class TC_8195314_AMER_IE_Erevenue_OOWCustomer_CartUS extends BaseTest
{
	@Test
	public void validate_TC_8195314_AMER_IE_Erevenue_OOWCustomer_CartUS() 
	{
		try
		{
...
//			obj_EsupportErevenueWorkflow.enterServiceTagAndVerifyHardwareAndSoftwareOfferInCTS(driver);
		...
		{
			Assert.fail("Failed in TC_8195314_AMER_IE_Erevenue_OOWCustomer_CartUS--------->\n  "+e);
		}
	}
}

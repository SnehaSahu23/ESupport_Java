...
public class TC_8438921_AMER_CH_Content_ArticlesDetailsPage_HowToArticlesPage extends BaseTest 
{
	@Test
	public void validate_TC_8438921_AMER_CH_Content_ArticlesDetailsPage_HowToArticlesPage() 
	{
		try
		{
			System.out.println("Starts TC_8438921_AMER_CH_Content_ArticlesDetailsPage_HowToArticlesPage");
...
//			Thread.sleep(5000);
		...
		{
			Assert.fail("Failed in TC_8438921_AMER_CH_Content_ArticlesDetailsPage_HowToArticlesPage--------->\n  "+e);
		}
	}
}

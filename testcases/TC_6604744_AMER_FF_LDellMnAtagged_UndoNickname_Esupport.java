...
public class TC_6604744_AMER_FF_LDellMnAtagged_UndoNickname_Esupport extends BaseTest{
	@Test
	public void validate_TC_6604744_AMER_FF_LDellMnAtagged_UndoNickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6604744_AMER_FF_LDellMnAtagged_UndoNickname_Esupport");
			...
			obj_EsupportIPSWorkflow.UndoNickname(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed in TC_6604744_AMER_FF_LDellMnAtagged_UndoNickname_Esupport--------->\n  "+e);
		}
	}
}

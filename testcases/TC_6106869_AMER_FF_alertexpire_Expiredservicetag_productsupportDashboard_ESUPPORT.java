...
public class TC_6106869_AMER_FF_alertexpire_Expiredservicetag_productsupportDashboard_ESUPPORT extends BaseTest{

	@Test
	public void validate_TC_6106869_AMER_FF_alertexpire_Expiredservicetag_productsupportDashboard_ESUPPORT(){


		try
		{
			System.out.println("Starting TC_6106869_AMER_FF_alertexpire_Expiredservicetag_productsupportDashboard_ESUPPORT..."); 
		...
		{
			Assert.fail("Failed while executing test case TC_6106869_AMER_FF_alertexpire_Expiredservicetag_productsupportDashboard_ESUPPORT--------->\n  "+e);
		}
	}

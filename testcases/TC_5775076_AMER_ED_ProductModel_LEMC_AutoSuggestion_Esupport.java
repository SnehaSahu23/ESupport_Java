...
public class TC_5775076_AMER_ED_ProductModel_LEMC_AutoSuggestion_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5775076_AMER_ED_ProductModel_LEMC_AutoSuggestion_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5775076_AMER_ED_ProductModel_LEMC_AutoSuggestion_Esupport");
...
//			obj_EsupportIntegratedHomePageWorkflow.Emaillogin(driver,  TestNGCreator.TestData.get(Esupport.Username.ordinal()),  TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5775076_AMER_ED_ProductModel_LEMC_AutoSuggestion_Esupport--------->\n  "+e);

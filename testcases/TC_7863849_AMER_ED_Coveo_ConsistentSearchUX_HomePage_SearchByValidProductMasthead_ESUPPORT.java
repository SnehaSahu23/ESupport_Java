...
public class TC_7863849_AMER_ED_Coveo_ConsistentSearchUX_HomePage_SearchByValidProductMasthead_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863849_AMER_ED_Coveo_ConsistentSearchUX_HomePage_SearchByValidProductMasthead_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863849_AMER_ED_Coveo_ConsistentSearchUX_HomePage_SearchByValidProductMasthead_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.SearchLatiInMastHeadAndSearchAutoDisplayedResults(driver);
		...
		{
			Assert.fail("Failed in TC_7863849_AMER_ED_Coveo_ConsistentSearchUX_HomePage_SearchByValidProductMasthead_ESUPPORT  "+e);
		}
	}
}

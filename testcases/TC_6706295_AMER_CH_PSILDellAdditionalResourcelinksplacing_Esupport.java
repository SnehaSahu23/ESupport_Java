...
public class TC_6706295_AMER_CH_PSILDellAdditionalResourcelinksplacing_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6706295_AMER_CH_PSILDellAdditionalResourcelinksplacing_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6706295_AMER_CH_PSILDellAdditionalResourcelinksplacing_Esupport");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed in TC_6706295_AMER_CH_PSILDellAdditionalResourcelinksplacing_Esupport--------->\n  "+e);
		}
	}
}

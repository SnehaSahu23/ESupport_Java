...
public class TC_D920616_AMER_ED_DriversNotifications_CreateEmailSubscriptionSummary_Esupport extends BaseTest
{
	@Test
	public void validate_TC_D920616_AMER_ED_DriversNotifications_CreateEmailSubscriptionSummary_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_D920616_AMER_ED_DriversNotifications_CreateEmailSubscriptionSummary_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while executing TC_D920616_AMER_ED_DriversNotifications_CreateEmailSubscriptionSummary_Esupport--------->\n  "+e);

...
public class TC_D920582_AMER_FF_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920582_AMER_FF_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_D920582_AMER_FF_DriversNotifications_CreateEmailSubscription_Frequency");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_D920582_AMER_FF_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT--------->\n  "+e);

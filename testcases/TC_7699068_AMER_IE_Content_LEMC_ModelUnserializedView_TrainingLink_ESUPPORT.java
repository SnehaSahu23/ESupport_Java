...
public class TC_7699068_AMER_IE_Content_LEMC_ModelUnserializedView_TrainingLink_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7699068_AMER_IE_Content_LEMC_ModelUnserializedView_TrainingLink_ESUPPORT() 
	{
		try
		{
...
//			obj_EsupportCoveoWorkflow.ClickOnTrainingLink(driver);
		...
		{
			Assert.fail("Failed in TC_7699068_AMER_IE_Content_LEMC_ModelUnserializedView_TrainingLink_ESUPPORT()--------->\n  "+e);
		}
	}
}

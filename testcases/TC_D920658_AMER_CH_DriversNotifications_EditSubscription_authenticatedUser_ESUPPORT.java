...
public class TC_D920658_AMER_CH_DriversNotifications_EditSubscription_authenticatedUser_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920658_AMER_CH_DriversNotifications_EditSubscription_authenticatedUser_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_D920658_AMER_CH_DriversNotifications_EditSubscription_authenticatedUser_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_D920658_AMER_CH_DriversNotifications_EditSubscription_authenticatedUser_ESUPPORT--------->\n  "+e);

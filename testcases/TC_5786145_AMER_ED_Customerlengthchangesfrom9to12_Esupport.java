...
public class TC_5786145_AMER_ED_Customerlengthchangesfrom9to12_Esupport extends BaseTest
{

	@Test
	public void validate_TC_5786145_AMER_ED_Customerlengthchangesfrom9to12_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5786145_AMER_ED_Customerlengthchangesfrom9to12_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5786145_AMER_ED_Customerlengthchangesfrom9to12_Esupport--------->\n  "+e);

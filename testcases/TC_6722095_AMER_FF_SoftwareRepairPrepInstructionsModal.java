...
public class TC_6722095_AMER_FF_SoftwareRepairPrepInstructionsModal extends BaseTest
{
	@Test
	public void validate_TC_6722095_AMER_FF_SoftwareRepairPrepInstructionsModal() 
	{
		try
		{
			System.out.println("Starts TC_6722095_AMER_FF_SoftwareRepairPrepInstructionsModal");
		...
		{
			Assert.fail("Failed in TC_6722095_AMER_FF_SoftwareRepairPrepInstructionsModal--------->\n  "+e);
		}
	}
}

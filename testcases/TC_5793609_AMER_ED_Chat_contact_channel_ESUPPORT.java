...
public class TC_5793609_AMER_ED_Chat_contact_channel_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5793609_AMER_ED_Chat_contact_channel_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5793609_AMER_ED_Chat_contact_channel_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5793609_AMER_ED_Chat_contact_channel_ESUPPORT--------->\n  "+e);

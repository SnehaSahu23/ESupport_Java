...
public class TC_7863918_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_OrderStatus_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863918_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_OrderStatus_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863918_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_OrderStatus_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863918_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_OrderStatus_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_9808745_AMER_IE_ManualsAndDocuments_LKB_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9808745_AMER_IE_ManualsAndDocuments_LKB_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9808745_AMER_IE_ManualsAndDocuments_LKB_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_9808745_AMER_IE_ManualsAndDocuments_LKB_ESUPPORT--------->\n  "+e);
		}
	}
}

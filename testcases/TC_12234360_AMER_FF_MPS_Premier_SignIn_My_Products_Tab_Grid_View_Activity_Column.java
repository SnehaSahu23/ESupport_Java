...
public class TC_12234360_AMER_FF_MPS_Premier_SignIn_My_Products_Tab_Grid_View_Activity_Column extends BaseTest
{
	@Test
	public void validate_TC_12234360_AMER_FF_MPS_Premier_SignIn_My_Products_Tab_Grid_View_Activity_Column()
	{
		try
		{
			System.out.println("Starts TC_12234360_AMER_FF_MPS_Premier_SignIn_My_Products_Tab_Grid_View_Activity_Column");
...
//			obj_EsupportMPSWorkflow.ClickOnMyProductAndService(driver);
		...
		{
			Assert.fail("Failed in TC_12234360_AMER_FF_MPS_Premier_SignIn_My_Products_Tab_Grid_View_Activity_Column--------->\n  "+e);
		}
	}
}

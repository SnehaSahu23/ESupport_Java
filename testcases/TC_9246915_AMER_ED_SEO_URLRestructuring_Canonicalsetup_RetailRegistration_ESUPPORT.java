...
public class TC_9246915_AMER_ED_SEO_URLRestructuring_Canonicalsetup_RetailRegistration_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9246915_AMER_ED_SEO_URLRestructuring_Canonicalsetup_RetailRegistration_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9246915_AMER_ED_SEO_URLRestructuring_Canonicalsetup_RetailRegistration_ESUPPORT");
...
//			obj_EsupportSEOWorkflow.validateLanguageCountryInURLForUS_V1(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()));
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9246915_AMER_ED_SEO_URLRestructuring_Canonicalsetup_RetailRegistration_ESUPPORT--------->\n  "+e);

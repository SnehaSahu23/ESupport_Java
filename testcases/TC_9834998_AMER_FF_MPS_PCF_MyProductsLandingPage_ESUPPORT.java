...
public class TC_9834998_AMER_FF_MPS_PCF_MyProductsLandingPage_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9834998_AMER_FF_MPS_PCF_MyProductsLandingPage_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9834998_AMER_FF_MPS_PCF_MyProductsLandingPage_ESUPPORT()");
...
//			obj_EsupportMPSWorkflow.clickSignIn(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9834998_AMER_FF_MPS_PCF_MyProductsLandingPage_ESUPPORT()--------->\n  "+e);
		}
	}
}

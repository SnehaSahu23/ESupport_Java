...
public class TC_5786189_AMER_ED_UserandGroupsScenarios_Roles_Permissions_VerifyAddUserspage_SuperAdmin_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5786189_AMER_ED_UserandGroupsScenarios_Roles_Permissions_VerifyAddUserspage_SuperAdmin_Esupport() 
	{
		...
		try
		{
			...
			System.out.println("Starts TC#_5786189_AMER_ED");
		...
		{
			Assert.fail("Failed while executing test case TC_5786189_AMER_ED_UserandGroupsScenarios_Roles_Permissions_VerifyAddUserspage_SuperAdmin_Esupport--------->\n  "+e);
		}
	}
}
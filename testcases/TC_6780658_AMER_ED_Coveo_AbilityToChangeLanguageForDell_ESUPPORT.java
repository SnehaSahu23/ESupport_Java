...
public class TC_6780658_AMER_ED_Coveo_AbilityToChangeLanguageForDell_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6780658_AMER_ED_Coveo_AbilityToChangeLanguageForDell_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6780658_AMER_ED_Coveo_AbilityToChangeLanguageForDell_ESUPPORT");
...
//			obj_EsupportContentWorkflow.ValidateChangingLanguageFromDropDown(driver);
		...
		{
			Assert.fail("Failed in TC_6780658_AMER_ED_Coveo_AbilityToChangeLanguageForDell_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_5783681_AMER_CH_PDFformatofManuals_ESUPPORT  extends BaseTest 
{
	@Test
	public void validate_TC_5783681_AMER_CH_PDFformatofManuals_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5783681_AMER_CH_PDFformatofManuals_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5783681_AMER_CH_PDFformatofManuals_ESUPPORT--------->\n  "+e);

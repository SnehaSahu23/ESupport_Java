...
public class TC_5775324_AMER_FF_CriticalLinksResources_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5775324_AMER_FF_CriticalLinksResources_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5775324_AMER_FF_CriticalLinksResources_Esupport");
...
//			obj_EsupportIntegratedHomePageWorkflow.ToVerify_WebPartsbelowProductSelector(driver);
		...
		{
			Assert.fail("Failed while TC_5775324_AMER_FF_CriticalLinksResources_Esupport--------->\n  "+e);
		}
	}
}
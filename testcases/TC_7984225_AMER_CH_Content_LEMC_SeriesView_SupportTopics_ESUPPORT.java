...
public class TC_7984225_AMER_CH_Content_LEMC_SeriesView_SupportTopics_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984225_AMER_CH_Content_LEMC_SeriesView_SupportTopics_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984225_AMER_CH_Content_LEMC_SeriesView_SupportTopics_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ToLogin_ValidCredentials(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_7984225_AMER_CH_Content_LEMC_SeriesView_SupportTopics_ESUPPORT--------->\n  "+e);
		}
	}
}

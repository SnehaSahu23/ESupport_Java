...
public class TC_10645674_AMER_CH_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations extends BaseTest 
{
   @Test
   public void Validate_TC_10645674_AMER_CH_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations()
   {
	   try
	   {
...
//			obj_EsupportIncidentsWorkflow.verifyTheChannelNewLayOutForIssueType(driver);
	   ...
	   {
		   Assert.fail("Failed while TC_10645674_AMER_CH_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations--------->\n  "+e);
	   }
   }

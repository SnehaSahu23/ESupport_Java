...
public class TC_7692981_AMER_CH_IPS_LEMC_SerializedRequestequipmentRefreshRequestcontractdetailsModalpopupEmployeelogin extends BaseTest
{
	@Test
	public void validate_TC_7692981_AMER_CH_IPS_LEMC_LEMC_SerializedRequestequipmentRefreshRequestcontractdetailsModalpopupEmployeelogin() 
	{
		try
		{
			System.out.println("Starts TC_7692981_AMER_CH_IPS_LEMC_SerializedRequestequipmentRefreshRequestcontractdetailsModalpopupEmployeelogin");
		...
		{
			Assert.fail("Failed executing TC_7692981_AMER_CH_IPS_LEMC_SerializedRequestequipmentRefreshRequestcontractdetailsModalpopupEmployeelogin--------->\n  "+e);
		}
	}
}

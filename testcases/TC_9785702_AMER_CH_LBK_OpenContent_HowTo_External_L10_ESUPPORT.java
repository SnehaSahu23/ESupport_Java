...
public class TC_9785702_AMER_CH_LBK_OpenContent_HowTo_External_L10_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785702_AMER_CH_LBK_OpenContent_HowTo_External_L10_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785702_AMER_CH_LBK_OpenContent_HowTo_External_L10_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.clickAndVerifyArticlePropertiesDetails(driver);
		...
		{
			Assert.fail("Failed in TC_9785702_AMER_CH_LBK_OpenContent_HowTo_External_L10_ESUPPORT()--------->\n  "+e);
		}
	}
}

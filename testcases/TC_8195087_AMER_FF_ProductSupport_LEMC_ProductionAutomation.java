...
public class TC_8195087_AMER_FF_ProductSupport_LEMC_ProductionAutomation extends BaseTest
{
	@Test
	public void validate_TC_8195087_AMER_FF_ProductSupport_LEMC_ProductionAutomation() 
	{
		try
		{
			System.out.println("Starts TC_8195087_AMER_FF_ProductSupport_LEMC_ProductionAutomation");
...
//			Need Product ID
			...
			Thread.sleep(10000);
			obj_EsupportProductionValidationsWorkflow.verifyIPS_LEMC_SerializedMapFunctionalityForFF(driver);
			Thread.sleep(10000);
...
//			Thread.sleep(10000);
		...
		{
			Assert.fail("Failed executing TC_8195087_AMER_FF_ProductSupport_LEMC_ProductionAutomation--------->\n  "+e);
		}
	}
}

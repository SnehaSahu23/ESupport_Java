...
public class TC_5755096_AMER_CH_Premier_Recent_OrdersPage_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5755096_AMER_CH_Premier_Recent_OrdersPage_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 5755096_AMER_CH");
...
//			obj_EsupportOrderHomeWorkflow.handlePremierPopup(driver);
		...
		//	obj_EsupportOrderHomeWorkflow.handleCookies(driver);
			...
			Assert.fail("Failed while executing test case TC_5755096_AMER_Premier_Recent_OrdersPage_ESUPPORT--------->\n  "+e);

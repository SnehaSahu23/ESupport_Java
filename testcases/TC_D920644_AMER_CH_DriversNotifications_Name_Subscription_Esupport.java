...
public class TC_D920644_AMER_CH_DriversNotifications_Name_Subscription_Esupport extends BaseTest
{
	@Test
	public void validate_TC_D920644_AMER_CH_DriversNotifications_Name_Subscription_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_D920644_AMER_CH_DriversNotifications_Name_Subscription");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_D920644_AMER_CH_DriversNotifications_Name_Subscription_ESUPPORT--------->\n  "+e);

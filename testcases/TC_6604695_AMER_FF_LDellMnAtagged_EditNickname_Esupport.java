...
public class TC_6604695_AMER_FF_LDellMnAtagged_EditNickname_Esupport extends BaseTest{
	@Test
	public void validate_TC_6604695_AMER_FF_LDellMnAtagged_EditNickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6604695_AMER_FF_LDellMnAtagged_EditNickname_Esupport");
		...
		{
			Assert.fail("Failed in TC_6604695_AMER_FF_LDellMnAtagged_EditNickname_Esupport--------->\n  "+e);
		}
	}
}

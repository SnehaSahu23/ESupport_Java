...
public class TC_6082142_AMER_ED_FlexBillingGlobalcountryselector_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6082142_AMER_ED_FlexBillingGlobalcountryselector_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6082142_AMER_ED_FlexBillingGlobalcountryselector_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_6082142_AMER_ED_FlexBillingGlobalcountryselector_Esupport--------->\n  "+e);
		}
	}
}

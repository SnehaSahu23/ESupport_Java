...
public class TC_6082206_AMER_CH_FlexBillingSetCostandAmountfieldformat_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6082206_AMER_CH_FlexBillingSetCostandAmountfieldformat_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6082206_AMER_CH_FlexBillingSetCostandAmountfieldformat_Esupport");
			...
			obj_EsupportDDLWorkflow.verifyAmountFormat(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed while executing test case TC_6082206_AMER_CH_FlexBillingSetCostandAmountfieldformat_Esupport--------->\n  "+e);
		}
	}
}

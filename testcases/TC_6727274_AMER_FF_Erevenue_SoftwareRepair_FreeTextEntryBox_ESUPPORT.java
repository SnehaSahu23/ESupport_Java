...
public class TC_6727274_AMER_FF_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6727274_AMER_FF_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6727274_AMER_FF_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT");
			...
			//obj_EsupportErevenueWorkflow.selectAvailableSlotAndClickNextButton(driver);
			Thread.sleep(5000);
			obj_EsupportErevenueWorkflow.VerifyIssueDetailsPageOfPopUpAfterEnteringSpecialCharacters_FF(driver, TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[2]);
			Thread.sleep(5000);
...
//			
		...
		{
			Assert.fail("Failed in TC_6727274_AMER_FF_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT--------->\n  "+e);
		}
	}
}

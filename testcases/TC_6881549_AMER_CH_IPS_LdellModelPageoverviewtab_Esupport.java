...
public class TC_6881549_AMER_CH_IPS_LdellModelPageoverviewtab_Esupport  extends BaseTest
{
	@Test
	public void validate_TC_6881549_AMER_CH_IPS_LdellModelPageoverviewtab_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6881549_AMER_CH_IPS_LdellModelPageoverviewtab_Esupport");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed in TC_6881549_AMER_CH_IPS_LdellModelPageoverviewtab_Esupport--------->\n  "+e);
		}
	}
}

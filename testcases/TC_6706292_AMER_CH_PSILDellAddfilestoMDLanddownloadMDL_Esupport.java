...
public class TC_6706292_AMER_CH_PSILDellAddfilestoMDLanddownloadMDL_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6706292_AMER_CH_PSILDellAddfilestoMDLanddownloadMDL_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6706292_AMER_CH_PSILDellAddfilestoMDLanddownloadMDL_Esupport");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed in TC_6706292_AMER_CH_PSILDellAddfilestoMDLanddownloadMDL_Esupport--------->\n  "+e);
		}
	}
}

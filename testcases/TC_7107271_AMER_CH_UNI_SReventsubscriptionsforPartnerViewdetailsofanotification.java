...
public class TC_7107271_AMER_CH_UNI_SReventsubscriptionsforPartnerViewdetailsofanotification extends BaseTest
{
	@Test
	public void validate_TC_7107271_AMER_CH_UNI_SReventsubscriptionsforPartnerViewdetailsofanotification()
	{
		try
		{
			System.out.println("Starts TC_7107271_AMER_CH_UNI_SReventsubscriptionsforPartnerViewdetailsofanotification");
			Thread.sleep(10000);	
		...
		{
			Assert.fail("Failed in TC_7107271_AMER_CH_UNI_SReventsubscriptionsforPartnerViewdetailsofanotification--------->\n  "+e);
		}
	}
}

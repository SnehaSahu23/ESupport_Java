...
public class TC_8438937_AMER_CH_Content_StarRatingonNewPages extends BaseTest 
{
	@Test
	public void validate_TC_8438937_AMER_CH_Content_StarRatingonNewPages() 
	{
		try
		{
			System.out.println("Starts TC_8438937_AMER_CH_Content_StarRatingonNewPages");
		...
		{
			Assert.fail("Failed in TC_8438937_AMER_CH_Content_StarRatingonNewPages--------->\n  "+e);
		}
	}
}

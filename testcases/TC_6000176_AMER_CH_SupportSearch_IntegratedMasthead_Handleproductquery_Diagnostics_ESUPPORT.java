...
public class TC_6000176_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_6000176_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6000176_AMER_CH"); 
		...
		{
			Assert.fail("Failed while executing test case TC_6000176_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_6000176_AMER_ED_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_6000176_AMER_ED_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORTextends() 
	{

		try
		{
			System.out.println("Starts TC# 6000176_AMER_ED"); 
		...
		{
			Assert.fail("Failed while executing test case TC_6000176_AMER_ED_SupportSearch_IntegratedMasthead_Handleproductquery_Diagnostics_ESUPPORTextends--------->\n  "+e);
		}
	}
}

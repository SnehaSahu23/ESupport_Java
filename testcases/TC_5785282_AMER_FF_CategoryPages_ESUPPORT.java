...
public class TC_5785282_AMER_FF_CategoryPages_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5785282_AMER_FF_CategoryPages_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5785282_AMER_FF_CategoryPages_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5785282_AMER_FF_CategoryPages_ESUPPORT--------->\n  "+e);

...
public class TC_7124726_AMER_IE_Contact_SPECONTACTCHANNELS_LIveChat_SnapInChat_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7124726_AMER_IE_Contact_SPECONTACTCHANNELS_LIveChat_SnapInChat_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7124726_AMER_IE_Contact_SPECONTACTCHANNELS_LIveChat_SnapInChat_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ClickOnCloseChatButton(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7124726_AMER_IE_Contact_SPECONTACTCHANNELS_LIveChat_SnapInChat_ESUPPORT--------->\n  "+e);

...
public class TC_7044017_AMER_IE_ServiceEventsTab_ServiceRequest_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7044017_AMER_IE_ServiceEventsTab_ServiceRequest_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7044017_AMER_IE_ServiceEventsTab_ServiceRequest_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7044017_AMER_IE_ServiceEventsTab_ServiceRequest_ESUPPORT--------->\n  "+e);
		}
	}
}

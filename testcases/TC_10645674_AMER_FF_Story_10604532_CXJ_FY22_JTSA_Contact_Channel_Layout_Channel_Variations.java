...
public class TC_10645674_AMER_FF_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations extends BaseTest
{
	@Test
	   public void Validate_TC_10645674_AMER_FF_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations()
	   {
		   try
		   {
			   System.out.println("Starts Validate_TC_10645674_AMER_FF_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations");
...
//				obj_EsupportIncidentsWorkflow.verifyTheChannelNewLayOutForIssueType(driver);
		   ...
		   {
			   Assert.fail("Failed while TC_10645674_AMER_FF_Story_10604532_CXJ_FY22_JTSA_Contact_Channel_Layout_Channel_Variations--------->\n  "+e);
		   }
	   }
}

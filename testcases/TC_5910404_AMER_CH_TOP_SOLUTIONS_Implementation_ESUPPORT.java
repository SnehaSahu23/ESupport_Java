...
public class TC_5910404_AMER_CH_TOP_SOLUTIONS_Implementation_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5910404_AMER_CH_TOP_SOLUTIONS_Implementation_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5836926_AMER_CH_TOP_SOLUTIONS_Implementation_ESUPPORT");
			//scenario1
...
//			obj_EsupportCoveoWorkflow.select_product(driver, TestNGCreator.TestData.get(Esupport.SupportValue.ordinal()).split(";")[0]);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_TC_5910404_AMER_CH_TOP_SOLUTIONS_Implementation_ESUPPORT--------->\n  "+e);

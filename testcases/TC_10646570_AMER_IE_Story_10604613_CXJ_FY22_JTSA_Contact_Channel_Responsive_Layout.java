...
public class TC_10646570_AMER_IE_Story_10604613_CXJ_FY22_JTSA_Contact_Channel_Responsive_Layout extends BaseTest
{
	@Test
	public void validate_TC_10646570_AMER_IE_Story_10604613_CXJ_FY22_JTSA_Contact_Channel_Responsive_Layout()
	{
		try
		{
			System.out.println("Starts TC_10646570_AMER_IE_Story_10604613_CXJ_FY22_JTSA_Contact_Channel_Responsive_Layout");
...
//			obj_EsupportIncidentsWorkflow.verifyTheChannelNewLayOutForIssueType(driver);
		...
		{
			Assert.fail("Failed in TC_10646570_AMER_IE_Story_10604613_CXJ_FY22_JTSA_Contact_Channel_Responsive_Layout--------->\n  "+e);
		}
	}
}

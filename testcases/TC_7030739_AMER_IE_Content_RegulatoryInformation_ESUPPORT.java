...
public class TC_7030739_AMER_IE_Content_RegulatoryInformation_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7030739_AMER_IE_Content_RegulatoryInformation_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7030739_AMER_IE_Content_RegulatoryInformation_ESUPPORT()");
		...
		{
			Assert.fail("Failed in TC_7030739_AMER_IE_Content_RegulatoryInformation_ESUPPORT()--------->\n  "+e);
		}
	}
}

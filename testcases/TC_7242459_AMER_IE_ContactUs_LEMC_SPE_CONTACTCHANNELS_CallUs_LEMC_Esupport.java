...
public class TC_7242459_AMER_IE_ContactUs_LEMC_SPE_CONTACTCHANNELS_CallUs_LEMC_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_7242459_AMER_IE_ContactUs_LEMC_SPE_CONTACTCHANNELS_CallUs_LEMC_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_7242459_AMER_IE_ContactUs_LEMC_SPE_CONTACTCHANNELS_CallUs_LEMC_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7242459_AMER_IE_ContactUs_LEMC_SPE_CONTACTCHANNELS_CallUs_LEMC_Esupport--------->\n  "+e);

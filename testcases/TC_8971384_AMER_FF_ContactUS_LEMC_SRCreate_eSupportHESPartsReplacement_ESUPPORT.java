...
public class TC_8971384_AMER_FF_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_8971384_AMER_FF_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8971384_AMER_FF_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidateTimeZome(driver);
			...
			obj_EsupportIncidentsWorkflow.ClickOnCreateServiceRequestButton(driver);
			Thread.sleep(10000);
			obj_EsupportIncidentsWorkflow.ClickOnContinueAndValidateFieldsInForm2ForLEMC_PartsReplacement(driver);
			
			obj_EsupportIncidentsWorkflow.ValidateDetailsInSRCreationFormIssueDetailsTagAndModelAndServiceCode(driver);
//			obj_EsupportIncidentsWorkflow.ValidateDetailsInSRCreationForm2OperatingSystemDropDown(driver);
			
			obj_EsupportIncidentsWorkflow.ValidateForm2WithoutEnteringMandatoryFieldsClickOnSubmitForLEMC_PartsReplacement(driver);
			
//			obj_EsupportIncidentsWorkflow.validateOrderDetailsFiledsAndFillValues(driver);
//			
//			obj_EsupportIncidentsWorkflow.validateShippingDetailsFiledsAndFillValues(driver);
			
			obj_EsupportIncidentsWorkflow.ValidateReqDescTextBoxForLEMCSRCreate(driver);
			//newly added
//			obj_EsupportIncidentsWorkflow.WriteIssueDetailsInTheProblemDescriptionValidateForRecommendedResourcesForLEMC(driver);
			...
			obj_EsupportIncidentsWorkflow.ValidateAndClickOnViewAllLinkInCreateServiceRequestWindowForLEMCUser_PartsReplacement(driver);
//			obj_EsupportIncidentsWorkflow.ClickOnAddAttachmentButtonAndValidatePopUpForLEMC(driver);
			...
			obj_EsupportIncidentsWorkflow.FillAllDetailsInForm2AndClickOnSubmitForLEMC_PartsReplacement(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_8971384_AMER_FF_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT--------->\n  "+e);

...
public class TC_10136487_AMER_FF_IPS_TridenttaggedHeroGeomapDisplaymap_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10136487_AMER_FF_IPS_TridenttaggedHeroGeomapDisplaymap_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_10136487_AMER_FF_IPS_TridenttaggedHeroGeomapDisplaymap_Esupport");
		...
		{
			Assert.fail("Failed in TC_10136487_AMER_FF_IPS_TridenttaggedHeroGeomapDisplaymap_Esupport--------->\n  "+e);
		}
	}
}

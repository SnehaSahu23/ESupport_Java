...
public class TC_7689962_AMER_IE_IPS_LEMC_ConvergedSolutionComponentdetails extends BaseTest
{
	@Test
	public void validate_TC_7689962_AMER_IE_IPS_LEMC_ConvergedSolutionComponentdetails() 
	{
		try
		{
			System.out.println("Starts TC_7689962_AMER_IE_IPS_LEMC_ConvergedSolutionComponentdetails");
...
//			obj_EsupportIPSWorkflow.closeContactUsSlider(driver);
		...
		{
			Assert.fail("Failed executing TC_7689962_AMER_IE_IPS_LEMC_ConvergedSolutionComponentdetails--------->\n  "+e);
		}
	}
}
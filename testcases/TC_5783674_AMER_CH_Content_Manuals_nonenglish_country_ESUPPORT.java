...
public class TC_5783674_AMER_CH_Content_Manuals_nonenglish_country_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5783674_AMER_CH_Content_Manuals_nonenglish_country_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5783674_AMER_CH_Content_Manuals_nonenglish_country_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5783674_AMER_CH_Content_Manuals_nonenglish_country_ESUPPORT--------->\n  "+e);

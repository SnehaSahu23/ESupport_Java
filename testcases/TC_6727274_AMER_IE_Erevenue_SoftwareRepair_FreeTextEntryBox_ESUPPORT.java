...
public class TC_6727274_AMER_IE_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6727274_AMER_IE_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6727274_AMER_IE_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT");
			...
			obj_EsupportErevenueWorkflow.ValidateFreeTextBoxEnteringMoreThan150Characters_IE(driver, TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
			Thread.sleep(5000);
...
//			obj_EsupportErevenueWorkflow.ClickOnXMarkAtTheTopOfPopUp(driver);
		...
		{
			Assert.fail("Failed in TC_6727274_AMER_IE_Erevenue_SoftwareRepair_FreeTextEntryBox_ESUPPORT--------->\n  "+e);
		}
	}
}

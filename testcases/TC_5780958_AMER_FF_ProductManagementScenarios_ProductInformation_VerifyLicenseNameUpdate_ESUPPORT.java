...
public class TC_5780958_AMER_FF_ProductManagementScenarios_ProductInformation_VerifyLicenseNameUpdate_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_5780958_AMER_FF_ProductManagementScenarios_ProductInformation_AddLicenseName_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_5780958_AMER_FF_ProductManagementScenarios_ProductInformation_VerifyLicenseNameUpdate_ESUPPORT");
...
//			obj_EsupportDDLWorkflow.ToClick_ProductNameLink(driver);
		...
		{
			Assert.fail("Failed while executing test case TC_5780958_AMER_FF_ProductManagementScenarios_ProductInformation_VerifyLicenseNameUpdate_ESUPPORT--------->\n  "+e);
		}
	}
}

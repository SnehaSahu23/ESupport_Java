...
public class TC_5781103_AMER_IE_SupportTopicsArticles_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5781103_AMER_IE_SupportTopicsArticles_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5781103_AMER_IE_SupportTopicsArticles_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5781103_AMER_IE_SupportTopicsArticles_ESUPPORT--------->\n  "+e);

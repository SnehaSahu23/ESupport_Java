...
public class TC_6000178_AMER_ED_SupportSearchIntegratedMastheadHandleproductnameinthequeryHome_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6000178_AMER_ED_SupportSearchIntegratedMastheadHandleproductnameinthequeryHome_Esupport() 
	{

		try
		{
			System.out.println("Starts 6000178_AMER_ED_SupportSearchIntegratedMastheadHandleproductnameinthequeryHome_Esupport"); 
		...
		{
			Assert.fail("Failed while executing test case 6000178_AMER_ED_SupportSearchIntegratedMastheadHandleproductnameinthequeryHome_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_5781001_AMER_FF_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5781001_AMER_FF_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC#TC_5781001_AMER_FF_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5781001_AMER_FF_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_Esupport--------->\n  "+e);
		}
	}
}

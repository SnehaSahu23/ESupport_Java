...
public class TC_6780696_AMER_IE_Coveo_VideoTutorialsForVideoSection_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6780696_AMER_IE_Coveo_VideoTutorialsForVideoSection_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6780696_AMER_IE_Coveo_VideoTutorialsForVideoSection_ESUPPORT");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed in TC_6780696_AMER_IE_Coveo_VideoTutorialsForVideoSection_ESUPPORT--------->\n  "+e);
		}
	}
}

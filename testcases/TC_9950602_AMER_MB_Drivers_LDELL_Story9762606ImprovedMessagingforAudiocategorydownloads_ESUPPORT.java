...
import com.dell.delta_uat_automation.utility.MobileReport;
import com.dell.delta_uat_automation.utility.MobileTestNGCreator;
import com.dell.delta_uat_automation.utility.TestNGCreator;

public class TC_9950602_AMER_MB_Drivers_LDELL_Story9762606ImprovedMessagingforAudiocategorydownloads_ESUPPORT extends MobilePage
{
	@Test
	public void validate_TC_9950602_AMER_MB_Drivers_LDELL_Story9762606ImprovedMessagingforAudiocategorydownloads_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9950602_AMER_MB_Drivers_LDELL_Story9762606ImprovedMessagingforAudiocategorydownloads_ESUPPORT");
			Thread.sleep(6000);
...
//            obj_EsupportMobileWorkflow.selectVideoOptionFromCategory(driver, MobileTestNGCreator.TestData.get(Esupport.SearchOption.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9950602_AMER_MB_Drivers_LDELL_Story9762606ImprovedMessagingforAudiocategorydownloads_ESUPPORT--------->\n  "+e);
		}
	}
}

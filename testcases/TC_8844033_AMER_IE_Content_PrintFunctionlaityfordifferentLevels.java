...
public class TC_8844033_AMER_IE_Content_PrintFunctionlaityfordifferentLevels extends BaseTest
{
	@Test
	public void validate_TC_8844033_AMER_IE_Content_PrintFunctionlaityfordifferentLevels() 
	{
		try
		{
			System.out.println("Starts TC_8844033_AMER_IE_Content_PrintFunctionlaityfordifferentLevels");
		...
		{
			Assert.fail("Failed in TC_8844033_AMER_IE_Content_PrintFunctionlaityfordifferentLevels--------->\n  "+e);
		}
	}
}
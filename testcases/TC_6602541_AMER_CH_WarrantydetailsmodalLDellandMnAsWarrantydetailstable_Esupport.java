...
public class TC_6602541_AMER_CH_WarrantydetailsmodalLDellandMnAsWarrantydetailstable_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6602541_AMER_CH_WarrantydetailsmodalLDellandMnAsWarrantydetailstable_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6602541_AMER_CH_WarrantydetailsmodalLDellandMnAsWarrantydetailstable_Esupport");			
		...
		{
			Assert.fail("Failed in TC_6602541_AMER_CH_WarrantydetailsmodalLDellandMnAsWarrantydetailstable_Esupport--------->\n  "+e);
		}
	}
}

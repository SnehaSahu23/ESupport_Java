...
public class TC_10136742_AMER_IE_IPS_TridenttaggedOverviewTab_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10136742_AMER_IE_IPS_TridenttaggedOverviewTab_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_10136742_AMER_IE_IPS_TridenttaggedOverviewTab_Esupport");
		...
		{
			Assert.fail("Failed in TC_10136742_AMER_IE_IPS_TridenttaggedOverviewTab_Esupport--------->\n  "+e);
		}
	}
}

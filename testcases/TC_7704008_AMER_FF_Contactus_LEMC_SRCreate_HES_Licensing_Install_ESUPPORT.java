...
public class TC_7704008_AMER_FF_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704008_AMER_FF_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704008_AMER_FF_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ClickOnAddAttachmentButtonAndValidatePopUpForLEMC(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704008_AMER_FF_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT--------->\n  "+e);

...
public class TC_8255261_AMER_CH_eRevenue_Productionenvironment_Automatedvalidations extends BaseTest
{
	@Test
	public void validate_TC_8255261_AMER_CH_eRevenue_Productionenvironment_Automatedvalidations()
	{
		try
		{
			System.out.println("Starts TC_8255261_AMER_CH_eRevenue_Productionenvironment_Automatedvalidations");
...
//			obj_EsupportProductionValidationsWorkflow.verifySoftwareSupportOfferInContactTechnicalSupport(driver);
		...
		//	obj_EsupportProductionValidationsWorkflow.verifySoftwareSupportOfferSchedulerInCTSPage(driver);
			...
			//Starts TC_8184485_AMER_CH_EREV_EnableIssueList_JourneyforOOWCustomers_onSPEinUS
...
//			obj_EsupportProductionValidationsWorkflow.verifyIssueListInCTSPage(driver);
		...
		{
			Assert.fail("Failed in TC_8255261_AMER_CH_eRevenue_Productionenvironment_Automatedvalidations--------->\n  "+e);
		}
	}
}

...
public class TC_9072848_AMER_CH_SecurityLandingPage_InfoDetails extends BaseTest
{
	@Test
	public void validate_TC_9072848_AMER_CH_SecurityLandingPage_InfoDetails() 
	{
		try
		{
			System.out.println("Starts TC_9072848_AMER_CH_SecurityLandingPage_InfoDetails");
		...
		{
			Assert.fail("Failed in TC_9072848_AMER_CH_SecurityLandingPage_InfoDetails--------->\n  "+e);
		}
	}
}

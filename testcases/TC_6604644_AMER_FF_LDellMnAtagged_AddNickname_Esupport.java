...
public class TC_6604644_AMER_FF_LDellMnAtagged_AddNickname_Esupport extends BaseTest {
	@Test
	public void validate_TC_6604644_AMER_FF_LDellMnAtagged_AddNickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6604644_AMER_FF_LDellMnAtagged_AddNickname_Esupport");
		...
		{
			Assert.fail("Failed in TC_6604644_AMER_FF_LDellMnAtagged_AddNickname_Esupport--------->\n  "+e);
		}
	}
}

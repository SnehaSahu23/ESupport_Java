...
public class TC_5775226_AMER_ED_Recentlyviewed_productpages_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5775226_AMER_ED_Recentlyviewed_productpages_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5775226_AMER_ED_Recentlyviewed_productpages_ESUPPORT");
...
//			obj_EsupportIntegratedHomePageWorkflow.ToVerify_ClickLefticon(driver);
			...
			Assert.fail("Failed while executing test case TC_5775226_AMER_ED_Recentlyviewed_productpages_ESUPPORT--------->\n  "+e);

...
public class TC_6706298_AMER_IE_PSILDellDriversanddownloadsreskinforuntaggedviews_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6706298_AMER_IE_PSILDellDriversanddownloadsreskinforuntaggedviews_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6706298_AMER_IE_PSILDellDriversanddownloadsreskinforuntaggedviews_Esupport");
...
//			obj_EsupportDriverandDownloadsWorkflow.pcfClickViewDetailsLink(driver);				
		...
		{
			Assert.fail("Failed in TC_6706298_AMER_IE_PSILDellDriversanddownloadsreskinforuntaggedviews_Esupport--------->\n  "+e);
		}
	}
}

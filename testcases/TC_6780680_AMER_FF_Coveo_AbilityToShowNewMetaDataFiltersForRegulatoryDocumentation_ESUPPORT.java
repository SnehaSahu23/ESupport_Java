...
public class TC_6780680_AMER_FF_Coveo_AbilityToShowNewMetaDataFiltersForRegulatoryDocumentation_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6780680_AMER_FF_Coveo_AbilityToShowNewMetaDataFiltersForRegulatoryDocumentation_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6780680_AMER_FF_Coveo_AbilityToShowNewMetaDataFiltersForRegulatoryDocumentation_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_6780680_AMER_FF_Coveo_AbilityToShowNewMetaDataFiltersForRegulatoryDocumentation_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_8145376_AMER_FF_Coveo_ConsistentSearchUX_Content_RedirectionImprovementTo_ServiceTag_SRnumber_SerialNumber_search_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_8145376_AMER_FF_Coveo_ConsistentSearchUX_Content_RedirectionImprovementTo_ServiceTag_SRnumber_SerialNumber_search_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_8145376_AMER_FF_Coveo_ConsistentSearchUX_Content_RedirectionImprovementTo_ServiceTag_SRnumber_SerialNumber_search_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_8145376_AMER_FF_Coveo_ConsistentSearchUX_Content_RedirectionImprovementTo_ServiceTag_SRnumber_SerialNumber_search_ESUPPORT--------->\n  "+e);
		}
	}
}

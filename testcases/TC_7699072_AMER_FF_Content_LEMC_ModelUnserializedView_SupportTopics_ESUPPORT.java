...
public class TC_7699072_AMER_FF_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7699072_AMER_FF_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT() 
	{
		try
		{
...
//			obj_EsupportIPSWorkflow.clickSignInHereLink(driver);
		...
		{
			Assert.fail("Failed in TC_7699072_AMER_FF_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT--------->\n  "+e);
		}
	}
}

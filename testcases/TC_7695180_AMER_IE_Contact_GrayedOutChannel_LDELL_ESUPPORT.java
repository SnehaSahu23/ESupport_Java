...
public class TC_7695180_AMER_IE_Contact_GrayedOutChannel_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7695180_AMER_IE_Contact_GrayedOutChannel_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7695180_AMER_IE_Contact_GrayedOutChannel_LDELL_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7695180_AMER_IE_Contact_GrayedOutChannel_LDELL_ESUPPORT--------->\n  "+e);

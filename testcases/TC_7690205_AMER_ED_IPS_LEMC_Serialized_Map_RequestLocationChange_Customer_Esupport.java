...
public class TC_7690205_AMER_ED_IPS_LEMC_Serialized_Map_RequestLocationChange_Customer_Esupport extends BaseTest
{
	@Test
	public void validate_TC_7690205_AMER_ED_IPS_LEMC_Serialized_Map_RequestLocationChange_Customer_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7690205_AMER_ED_IPS_LEMC_Serialized_Map_RequestLocationChange_Customer_Esupport");
		...
		{
			Assert.fail("Failed executing TC_7690205_AMER_ED_IPS_LEMC_Serialized_Map_RequestLocationChange_Customer_Esupport--------->\n  "+e);
		}
	}
}

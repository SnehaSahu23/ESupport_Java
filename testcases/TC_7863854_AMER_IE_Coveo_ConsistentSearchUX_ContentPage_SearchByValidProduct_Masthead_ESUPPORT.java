...
public class TC_7863854_AMER_IE_Coveo_ConsistentSearchUX_ContentPage_SearchByValidProduct_Masthead_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863854_AMER_IE_Coveo_ConsistentSearchUX_ContentPage_SearchByValidProduct_Masthead_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863854_AMER_IE_Coveo_ConsistentSearchUX_ContentPage_SearchByValidProduct_Masthead_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.ValidateSearchForKeywordLatiAndClickOnViewAllResultsForAutoDisplayedResult(driver);
		...
		{
			Assert.fail("Failed in TC_7863854_AMER_IE_Coveo_ConsistentSearchUX_ContentPage_SearchByValidProduct_Masthead_ESUPPORT--------->\n  "+e);
		}
	}
}

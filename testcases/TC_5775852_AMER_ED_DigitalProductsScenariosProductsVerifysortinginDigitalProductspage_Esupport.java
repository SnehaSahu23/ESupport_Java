...
public class TC_5775852_AMER_ED_DigitalProductsScenariosProductsVerifysortinginDigitalProductspage_Esupport extends BaseTest {
	@Test
	public void validate_TC_5775852_AMER_ED_DigitalProductsScenariosProductsVerifysortinginDigitalProductspage_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5775852_AMER_ED_DigitalProductsScenariosProductsVerifysortinginDigitalProductspage_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5775253_AMER_ED_LoginScenariosAuthenticationVerifyInvalidCredentials_Esupport--------->\n  "+e);
		}
	}
}

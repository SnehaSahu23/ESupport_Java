...
public class TC_12281353_AMER_CH_MPS_Premier_Switching_Premier_Account extends BaseTest
{
	@Test
	public void validate_TC_12281353_AMER_CH_MPS_Premier_Switching_Premier_Account()
	{
		try
		{
		...
		{
			Assert.fail("Failed in TC_12281353_AMER_CH_MPS_Premier_Switching_Premier_Account--------->\n  "+e);
		}
	}

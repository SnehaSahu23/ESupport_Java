...
public class TC_5781001_AMER_CH_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5781001_AMER_CH_SavedSearchScenarios_SavedSearch_EditCriteria_saveHistory_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC#_5781001_AMER_CH");
		...
		{
			Assert.fail("Failed while executing test case TC_5784146_AMER_CH_SearchScenarios_CreateDateRangesearch_OrderHistory_ESUPPORT--------->\n  "+e);
		}
	}
}
...
public class TC_7062899_AMER_FF_Content_SearchBox_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7062899_AMER_FF_Content_SearchBox_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7062899_AMER_FF_Content_SearchBox_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7062899_AMER_FF_Content_SearchBox_ESUPPORT--------->\n  "+e);
		}
	}
}

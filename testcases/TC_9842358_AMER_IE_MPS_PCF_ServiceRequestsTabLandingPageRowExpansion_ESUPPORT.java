...
public class TC_9842358_AMER_IE_MPS_PCF_ServiceRequestsTabLandingPageRowExpansion_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9842358_AMER_IE_MPS_PCF_ServiceRequestsTabLandingPageRowExpansion_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9842358_AMER_IE_MPS_PCF_ServiceRequestsTabLandingPageRowExpansion_ESUPPORT()");
...
//			obj_EsupportMPSWorkflow.clickSignIn(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9842358_AMER_IE_MPS_PCF_ServiceRequestsTabLandingPageRowExpansion_ESUPPORT()--------->\n  "+e);
		}
	}
}

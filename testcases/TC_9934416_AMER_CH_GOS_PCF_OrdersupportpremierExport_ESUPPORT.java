...
public class TC_9934416_AMER_CH_GOS_PCF_OrdersupportpremierExport_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_9934416_AMER_CH_GOS_PCF_OrdersupportpremierExport_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_9934416_AMER_CH_GOS_PCF_OrdersupportpremierExport_ESUPPORT");        
			...
			Assert.fail("Failed while executing test case TC_9934416_AMER_CH_GOS_PCF_OrdersupportpremierExport_ESUPPORT--------->\n  "+e);

...
public class TC_6795403_AMER_CH_UpdateOfferCardswithLearnMoreLink extends BaseTest
{
	@Test
	public void validate_TC_6795403_AMER_CH_UpdateOfferCardswithLearnMoreLink() 
	{
		try
		{
			System.out.println("Starts TC_6795403_AMER_CH_UpdateOfferCardswithLearnMoreLink");
...
//			obj_EsupportErevenueWorkflow.clickLearnMoreLinkHardwareRepairExpress(driver);
		...
		{
			Assert.fail("Failed in TC_6795403_AMER_CH_UpdateOfferCardswithLearnMoreLink--------->\n  "+e);
		}
	}
}

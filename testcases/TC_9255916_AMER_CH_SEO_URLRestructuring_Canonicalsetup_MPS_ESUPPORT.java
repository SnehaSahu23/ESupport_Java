...
public class TC_9255916_AMER_CH_SEO_URLRestructuring_Canonicalsetup_MPS_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9255916_AMER_CH_SEO_URLRestructuring_Canonicalsetup_MPS_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9255916_AMER_CH_SEO_URLRestructuring_Canonicalsetup_MPS_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9255916_AMER_CH_SEO_URLRestructuring_Canonicalsetup_MPS_ESUPPORT--------->\n  "+e);

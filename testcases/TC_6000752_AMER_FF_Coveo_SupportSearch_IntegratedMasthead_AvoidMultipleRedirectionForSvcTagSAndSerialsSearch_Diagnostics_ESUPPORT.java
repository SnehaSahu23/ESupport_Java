...
public class TC_6000752_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Diagnostics_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000752_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Diagnostics_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000752_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Diagnostics_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000752_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Diagnostics_ESUPPORT--------->\n  "+e);
		}
	}
}

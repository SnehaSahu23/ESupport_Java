...
public class TC_7690098_AMER_MB_IPS_LEMC_Serialized_Map_DisplayLocation_Esupport extends MobilePage
{
	@Test
	public void validate_TC_7690098_AMER_MB_IPS_LEMC_Serialized_Map_DisplayLocation_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7690098_AMER_MB_IPS_LEMC_Serialized_Map_DisplayLocation_Esupport");
		...
		{
			Assert.fail("Failed executing TC_7690098_AMER_MB_IPS_LEMC_Serialized_Map_DisplayLocation_Esupport--------->\n  "+e);
		}
	}
}

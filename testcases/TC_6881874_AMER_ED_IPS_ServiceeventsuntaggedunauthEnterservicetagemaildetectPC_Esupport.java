...
public class TC_6881874_AMER_ED_IPS_ServiceeventsuntaggedunauthEnterservicetagemaildetectPC_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6881874_AMER_ED_IPS_ServiceeventsuntaggedunauthEnterservicetagemaildetectPC_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6881874_AMER_ED_IPS_ServiceeventsuntaggedunauthEnterservicetagemaildetectPC_Esupport");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed in TC_6881874_AMER_ED_IPS_ServiceeventsuntaggedunauthEnterservicetagemaildetectPC_Esupport--------->\n  "+e);
		}
	}
}

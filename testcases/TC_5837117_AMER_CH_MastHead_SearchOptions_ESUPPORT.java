...
public class TC_5837117_AMER_CH_MastHead_SearchOptions_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5837117_AMER_CH_MastHead_SearchOptions_ESUPPORT() 
	{
...
//			obj_EsupportCoveoWorkflow.clickLatitudeSuggestionsSupportPage(driver,TestNGCreator.TestData.get(Esupport.SupportValue.ordinal()).split(";")[1]);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5837117_AMER_CH_MastHead_SearchOptions_ESUPPORT--------->\n  "+e);

...
public class TC_9785907_AMER_CH_LBK_OpenContent_TechnicalAdvisory_Partner_L40_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785907_AMER_CH_LBK_OpenContent_TechnicalAdvisory_Partner_L40_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785907_AMER_CH_LBK_OpenContent_TechnicalAdvisory_Partner_L40_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785907_AMER_CH_LBK_OpenContent_TechnicalAdvisory_Partner_L40_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_7704578_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESproductsBaseForm_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704578_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESproductsBaseForm_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704578_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESproductsBaseForm_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ClickOnAddAttachmentButtonAndValidatePopUpForLEMC(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704578_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESproductsBaseForm_ESUPPORT--------->\n  "+e);

...
public class TC_6000838_AMER_ED_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ProductSupport_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000838_AMER_ED_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ProductSupport_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000838_AMER_ED_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ProductSupport_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000838_AMER_ED_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ProductSupport_ESUPPORT--------->\n  "+e);
		}
	}
}

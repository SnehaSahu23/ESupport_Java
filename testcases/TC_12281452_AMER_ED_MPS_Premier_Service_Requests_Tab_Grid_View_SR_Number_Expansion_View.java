...
public class TC_12281452_AMER_ED_MPS_Premier_Service_Requests_Tab_Grid_View_SR_Number_Expansion_View extends BaseTest
{
    @Test
    public void validate_TC_12281452_AMER_ED_MPS_Premier_Service_Requests_Tab_Grid_View_SR_Number_Expansion_View()
    {
    	try
		{
		...
		{
			Assert.fail("Failed in TC_12281452_AMER_ED_MPS_Premier_Service_Requests_Tab_Grid_View_SR_Number_Expansion_View--------->\n  "+e);
		}
    }
}
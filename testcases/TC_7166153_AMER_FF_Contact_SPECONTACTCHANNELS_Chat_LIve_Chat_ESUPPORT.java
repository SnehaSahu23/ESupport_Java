...
public class TC_7166153_AMER_FF_Contact_SPECONTACTCHANNELS_Chat_LIve_Chat_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7166153_AMER_FF_Contact_SPECONTACTCHANNELS_Chat_LIve_Chat_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7166153_AMER_FF_Contact_SPECONTACTCHANNELS_Chat_LIve_Chat_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7166153_AMER_FF_Contact_SPECONTACTCHANNELS_Chat_LIve_Chat_ESUPPORT--------->\n  "+e);

...
public class TC_7123075_AMER_IE_Contact_SPECountryRedirectionPopup_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7123075_AMER_IE_Contact_SPECountryRedirectionPopup_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7123075_AMER_IE_Contact_SPECountryRedirectionPopup_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7123075_AMER_IE_Contact_SPECountryRedirectionPopup_ESUPPORT--------->\n  "+e);

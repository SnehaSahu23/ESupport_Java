...
public class TC_12300227_AMER_ED_MPS_Premier_Service_Requests_Tab_Export_Table_Search_Box extends BaseTest
{
	@Test
    public void validate_TC_12300227_AMER_ED_MPS_Premier_Service_Requests_Tab_Export_Table_Search_Box()
    {
    	try
		{
		...
		{
			Assert.fail("Failed in TC_12300227_AMER_ED_MPS_Premier_Service_Requests_Tab_Export_Table_Search_Box--------->\n  "+e);
		}
    }

...
public class TC_9081572_AMER_IE_Dispatches_PARTSONLY_STATUSATTRIBUTESAndCHEVRONS extends BaseTest 
{
	@Test
	public void validate_TC_9081572_AMER_IE_Dispatches_PARTSONLY_STATUSATTRIBUTESAndCHEVRONS() 
	{

		try
		{
			System.out.println("Starts TC_9081572_AMER_IE_Dispatches_PARTSONLY_STATUSATTRIBUTESAndCHEVRONS");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9081572_AMER_IE_Dispatches_PARTSONLY_STATUSATTRIBUTESAndCHEVRONS--------->\n  "+e);

...
public class TC_5712722_AMER_FF_ChooseFrom_AllProducts_Unauthenticated_Esupport extends BaseTest{
	
	@Test
	public void validate_TC_5712722_AMER_FF_ChooseFrom_AllProducts_Unauthenticated_Esupport(){
		
		
		try
		{
			System.out.println("Starting TC_5712722_AMER_FF_ChooseFrom_AllProducts_Unauthenticated_Esupport..."); 
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SupportValue.ordinal()).split(";")[1]);
			

		}catch(Exception e)
		{
			Assert.fail("Failed while executing test case TC_5712722_AMER_FF_ChooseFrom_AllProducts_Unauthenticated_Esupport--------->\n  "+e);
		}
	}

...
public class TC_5795667_AMER_IE_ContactOrderSupport_EmailoptionSingleOrder_Esupport extends BaseTest 
{
        @Test
        public void validate_TC_5795667_AMER_IE_ContactOrderSupport_EmailoptionSingleOrder_Esupport() 
        {
                try
                {
                        System.out.println("Starts TC_5795667_AMER_IE_ContactOrderSupport_EmailoptionSingleOrder_Esupport");
                ...
                {
                        Assert.fail("Failed in TC_5795667_AMER_IE_ContactOrderSupport_EmailoptionSingleOrder--------->\n  "+e);
                }
        }
}

...
public class TC_7057409_AMER_FF_Contact_SelfHelpOptions_OnlineSupportResources_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7057409_AMER_FF_Contact_SelfHelpOptions_OnlineSupportResources_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7057409_AMER_FF_Contact_SelfHelpOptions_OnlineSupportResources_LDELL_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ClickOnSupportAndContactSupportAndTechnicalSupport(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7057409_AMER_FF_Contact_SelfHelpOptions_OnlineSupportResources_LDELL_ESUPPORT--------->\n  "+e);

...
public class TC_9950600_AMER_CH_Story9906253ImprovedMessagingforNetworkcategorydownloads_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_9950600_AMER_CH_Story9906253ImprovedMessagingforNetworkcategorydownloads_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9950600_AMER_CH_Story9906253ImprovedMessagingforNetworkcategorydownloads_ESUPPORT");
...
//			obj_EsupportDriverandDownloadsWorkflow.clickTroubleShootLink(driver,TestNGCreator.TestData.get(Esupport.Dpid.ordinal()), TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9950600_AMER_CH_Story9906253ImprovedMessagingforNetworkcategorydownloads_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_5783661_AMER_ED_Content_Manuals_Documents_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5783661_AMER_ED_Content_Manuals_Documents_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5783661_AMER_ED_Content_Manuals_Documents_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5783661_AMER_ED_Content_Manuals_Documents_ESUPPORT--------->\n  "+e);

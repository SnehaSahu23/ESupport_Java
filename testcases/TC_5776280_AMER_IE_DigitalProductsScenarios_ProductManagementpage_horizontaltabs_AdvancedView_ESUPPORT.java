...
public class TC_5776280_AMER_IE_DigitalProductsScenarios_ProductManagementpage_horizontaltabs_AdvancedView_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_5776280_AMER_IE_DigitalProductsScenarios_ProductManagementpage_horizontaltabs_AdvancedView_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# _5776280_AMER_IE");
		...
		{
			Assert.fail("Failed while executing test case TC_5776280_AMER_IE_DigitalProductsScenarios_ProductManagementpage_horizontaltabs_AdvancedView_ESUPPORT--------->\n  "+e);
		}
	}
}
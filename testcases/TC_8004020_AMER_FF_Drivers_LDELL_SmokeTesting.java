...
public class TC_8004020_AMER_FF_Drivers_LDELL_SmokeTesting extends BaseTest
{
	@Test
	public void validate_TC_8004020_AMER_FF_Drivers_LDELL_SmokeTesting() 
	{
		try
		{
			System.out.println("Starts TC_8004020_AMER_FF_Drivers_LDELL_SmokeTesting");
		...
		{
			Assert.fail("Failed in TC_8004020_AMER_FF_Drivers_LDELL_SmokeTesting--------->\n  "+e);
		}
	}
}

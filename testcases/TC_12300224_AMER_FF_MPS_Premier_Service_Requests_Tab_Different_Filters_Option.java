...
public class TC_12300224_AMER_FF_MPS_Premier_Service_Requests_Tab_Different_Filters_Option extends BaseTest 
{
	@Test
    public void validate_TC_12300224_AMER_FF_MPS_Premier_Service_Requests_Tab_Different_Filters_Option()
    {
    	try
		{
...
//			obj_EsupportMPSWorkflow.ClickOnServiceTag_Filter(driver);
		...
		{
			Assert.fail("Failed in TC_12300224_AMER_FF_MPS_Premier_Service_Requests_Tab_Different_Filters_Option--------->\n  "+e);
		}
    }
}

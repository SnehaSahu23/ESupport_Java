...
public class TC_9247120_AMER_IE_SEO_URLRestructuring_Canonicalsetup_DDL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9247120_AMER_IE_SEO_URLRestructuring_Canonicalsetup_DDL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9247120_AMER_IE_SEO_URLRestructuring_Canonicalsetup_DDL_ESUPPORT");
...
//			obj_EsupportSEOWorkflow.validateLanguageCountryInURLForUS_V1(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()));
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9247120_AMER_IE_SEO_URLRestructuring_Canonicalsetup_DDL_ESUPPORT--------->\n  "+e);

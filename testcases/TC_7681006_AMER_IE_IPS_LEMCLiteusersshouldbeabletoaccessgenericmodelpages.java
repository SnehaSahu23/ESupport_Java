...
public class TC_7681006_AMER_IE_IPS_LEMCLiteusersshouldbeabletoaccessgenericmodelpages extends BaseTest{
	@Test
	public void validate_TC_7681006_AMER_IE_IPS_LEMCLiteusersshouldbeabletoaccessgenericmodelpages() 
	{
		try
		{
			System.out.println("Starts TC_7681006_AMER_IE_IPS_LEMCLiteusersshouldbeabletoaccessgenericmodelpages");
...
//Level 10 User
		...
		{
			Assert.fail("Failed in TC_7681006_AMER_IE_IPS_LEMCLiteusersshouldbeabletoaccessgenericmodelpages--------->\n  "+e);
		}
	}
}

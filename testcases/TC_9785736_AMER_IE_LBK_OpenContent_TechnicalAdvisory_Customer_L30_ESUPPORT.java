...
public class TC_9785736_AMER_IE_LBK_OpenContent_TechnicalAdvisory_Customer_L30_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785736_AMER_IE_LBK_OpenContent_TechnicalAdvisory_Customer_L30_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785736_AMER_IE_LBK_OpenContent_TechnicalAdvisory_Customer_L30_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785736_AMER_IE_LBK_OpenContent_TechnicalAdvisory_Customer_L30_ESUPPORT()--------->\n  "+e);
		}
	}
}

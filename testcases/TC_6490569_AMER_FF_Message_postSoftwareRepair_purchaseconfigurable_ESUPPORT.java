...
public class TC_6490569_AMER_FF_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_6490569_AMER_FF_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_6490569_AMER_FF_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT");  
			...
			Assert.fail("Failed while executing test case TC_6490569_AMER_FF_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT--------->\n  "+e);

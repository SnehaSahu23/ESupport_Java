...
public class TC_19214795_AMER_CH_authenticatedUsers_NotificationSummaryPage_CancelBehavior_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_19214795_AMER_CH_authenticatedUsers_NotificationSummaryPage_CancelBehavior_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_19214795_AMER_CH_authenticatedUsers_NotificationSummaryPage_CancelBehavior_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_19214795_AMER_CH_authenticatedUsers_NotificationSummaryPage_CancelBehavior_ESUPPORT--------->\n  "+e);

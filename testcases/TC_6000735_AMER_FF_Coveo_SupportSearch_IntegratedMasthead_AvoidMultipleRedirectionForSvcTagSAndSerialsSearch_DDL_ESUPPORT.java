...
public class TC_6000735_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_DDL_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000735_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_DDL_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000735_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_DDL_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000735_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_DDL_ESUPPORT--------->\n  "+e);
		}
	}
}

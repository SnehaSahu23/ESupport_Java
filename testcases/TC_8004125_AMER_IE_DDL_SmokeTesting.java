...
public class TC_8004125_AMER_IE_DDL_SmokeTesting extends BaseTest 
{
	@Test
	public void validate_TC_8004125_AMER_IE_DDL_SmokeTesting() 
	{

		try
		{
			System.out.println("Starts TC_8004125_AMER_IE_DDL_SmokeTesting");
		...
		{
			Assert.fail("Failed while TC_8004125_AMER_IE_DDL_SmokeTesting--------->\n  "+e);
		}
	}
}
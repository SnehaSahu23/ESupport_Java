...
public class TC_6063667_AMER_IE_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_6063667_AMER_IE_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6063667_AMER_IE"); 
		...
		{
			Assert.fail("Failed while executing test case TC_6063667_AMER_IE_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT--------->\n  "+e);
		}
	}
}

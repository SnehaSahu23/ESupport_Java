...
public class TC_9160946_AMER_IE_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS extends BaseTest 
{
	@Test
	public void validate_TC_9160946_AMER_IE_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS() 
	{

		try
		{
			System.out.println("Starts TC_9160946_AMER_IE_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS");
			...
			obj_EsupportIncidentsWorkflow.verifyServiceScheduledSection(driver);
			obj_EsupportIncidentsWorkflow.verifyTechnicianEnrouteSection(driver);
			...
			Thread.sleep(5000);
			obj_EsupportIncidentsWorkflow.verifyLaborOnlyClosedSection(driver);
			obj_EsupportIncidentsWorkflow.verifyCustomerInformation(driver);
		}
		catch(Exception e)
		{

			Assert.fail("Failed while TC_9160946_AMER_IE_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS--------->\n  "+e);

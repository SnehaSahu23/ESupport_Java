...
public class TC_5836650_AMER_CH_Support_Search_IntegratedUX_Handle_alphanumeric_characters_Esupport extends BaseTest {
	@Test
	public void validate_TC_5836650_AMER_CH_Support_Search_IntegratedUX_Handle_alphanumeric_characters_Esupport() 
	{
...
//			obj_EsupportCoveoWorkflow.handleCookies(driver);
			...
			Assert.fail("Failed while executing test case TC_5836650_AMER_CH_Support_Search_IntegratedUX_Handle_alphanumeric_characters_Esupport--------->\n  "+e);

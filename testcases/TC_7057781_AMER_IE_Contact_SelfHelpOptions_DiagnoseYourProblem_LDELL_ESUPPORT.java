...
public class TC_7057781_AMER_IE_Contact_SelfHelpOptions_DiagnoseYourProblem_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7057781_AMER_IE_Contact_SelfHelpOptions_DiagnoseYourProblem_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7057781_AMER_IE_Contact_SelfHelpOptions_DiagnoseYourProblem_LDELL_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.clickChangeProductLink(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7057781_AMER_IE_Contact_SelfHelpOptions_DiagnoseYourProblem_LDELL_ESUPPORT--------->\n  "+e);

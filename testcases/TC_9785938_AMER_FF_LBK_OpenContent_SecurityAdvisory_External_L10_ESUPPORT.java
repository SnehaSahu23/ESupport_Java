...
public class TC_9785938_AMER_FF_LBK_OpenContent_SecurityAdvisory_External_L10_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785938_AMER_FF_LBK_OpenContent_SecurityAdvisory_External_L10_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785938_AMER_FF_LBK_OpenContent_SecurityAdvisory_External_L10_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785938_AMER_FF_LBK_OpenContent_SecurityAdvisory_External_L10_ESUPPORT()--------->\n  "+e);
		}
	}
}

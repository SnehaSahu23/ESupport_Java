...
public class TC_9327565_AMER_CH_SLP_SmokeTesting extends BaseTest
{
	@Test
	public void validate_TC_9327565_AMER_CH_SLP_SmokeTesting() 
	{
		try
		{
			System.out.println("Starts TC_9327565_AMER_CH_SLP_SmokeTesting");
		...
		{
			Assert.fail("Failed in TC_9327565_AMER_CH_SLP_SmokeTesting--------->\n  "+e);
		}
	}
}
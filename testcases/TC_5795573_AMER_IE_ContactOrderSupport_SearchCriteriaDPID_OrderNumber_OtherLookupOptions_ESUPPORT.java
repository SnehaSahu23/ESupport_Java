...
public class TC_5795573_AMER_IE_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5795573_AMER_IE_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5795573_AMER_IE_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5795573_AMER_IE_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_ESUPPORT--------->\n  "+e);

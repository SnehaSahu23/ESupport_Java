...
public class TC_6886328_AMER_ED_Coveo_HandlePartialDoubleQuotesInTheSearchQuery_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6886328_AMER_ED_Coveo_HandlePartialDoubleQuotesInTheSearchQuery_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6886328_AMER_ED_Coveo_HandlePartialDoubleQuotesInTheSearchQuery_ESUPPORT");
...
//			obj_EsupportContentWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		{
			Assert.fail("Failed in TC_6886328_AMER_ED_Coveo_HandlePartialDoubleQuotesInTheSearchQuery_ESUPPORT--------->\n  "+e);
		}
	}
}

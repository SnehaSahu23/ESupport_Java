...
public class TC_7510707_AMER_FF_ServiceEvents_LEMC_ServiceEventstab_Pickdaterange extends BaseTest
{
	@Test
	public void validate_TC_7510707_AMER_FF_ServiceEvents_LEMC_ServiceEventstab_Pickdaterange() 
	{
		try
		{
			System.out.println("Starts TC_7510707_AMER_FF_ServiceEvents_LEMC_ServiceEventstab_Pickdaterange");
		...
		{
			Assert.fail("Failed in TC_7510707_AMER_FF_ServiceEvents_LEMC_ServiceEventstab_Pickdaterange--------->\n  "+e);
		}
	}
}

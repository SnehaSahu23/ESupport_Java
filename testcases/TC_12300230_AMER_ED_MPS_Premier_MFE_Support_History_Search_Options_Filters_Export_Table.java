...
public class TC_12300230_AMER_ED_MPS_Premier_MFE_Support_History_Search_Options_Filters_Export_Table extends BaseTest
{
	@Test
    public void validate_TC_12300230_AMER_ED_MPS_Premier_MFE_Support_History_Search_Options_Filters_Export_Table()
    {
    	try
		{
		...
		{
			Assert.fail("Failed in TC_12300230_AMER_ED_MPS_Premier_MFE_Support_History_Search_Options_Filters_Export_Table--------->\n  "+e);
		}
    }
}

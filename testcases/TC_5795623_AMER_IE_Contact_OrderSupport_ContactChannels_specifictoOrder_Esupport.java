...
public class TC_5795623_AMER_IE_Contact_OrderSupport_ContactChannels_specifictoOrder_Esupport extends BaseTest {


              @Test
              public void validate_TC_5795623_AMER_IE_Contact_OrderSupport_ContactChannels_specifictoOrder_Esupport() 
              {
                             try
                             {
                             ...
                             {
                                           Assert.fail("Failed while executing test case TC_5795623_AMER_IE_Contact_OrderSupport_ContactChannels_specifictoOrder_Esupport--------->\n  "+e);
                             }
              }

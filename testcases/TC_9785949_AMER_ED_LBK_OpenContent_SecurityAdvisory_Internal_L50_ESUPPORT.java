...
public class TC_9785949_AMER_ED_LBK_OpenContent_SecurityAdvisory_Internal_L50_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785949_AMER_ED_LBK_OpenContent_SecurityAdvisory_Internal_L50_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785949_AMER_ED_LBK_OpenContent_SecurityAdvisory_Internal_L50_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785949_AMER_ED_LBK_OpenContent_SecurityAdvisory_Internal_L50_ESUPPORT()--------->\n  "+e);
		}
	}
}

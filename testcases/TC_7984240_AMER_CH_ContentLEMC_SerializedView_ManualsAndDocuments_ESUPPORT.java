...
public class TC_7984240_AMER_CH_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984240_AMER_CH_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984240_AMER_CH_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ValidateChangingLanguageFromDropDownForManualsAndDocuments(driver);
		...
		{
			Assert.fail("Failed in TC_7984240_AMER_CH_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_9950598_AMER_MB_Drivers_LDELL_Story9906162ImprovedMessagingforBIOScategorydownloads_ESUPPORT extends MobilePage
{
	@Test
	public void validate_TC_9950598_AMER_MB_Drivers_LDELL_Story9906162ImprovedMessagingforBIOScategorydownloads_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9950598_AMER_MB_Drivers_LDELL_Story9906162ImprovedMessagingforBIOScategorydownloads_ESUPPORT");
			Thread.sleep(6000);
...
//            obj_EsupportMobileWorkflow.selectVideoOptionFromCategory(driver, MobileTestNGCreator.TestData.get(Esupport.SearchOption.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9950598_AMER_MB_Drivers_LDELL_Story9906162ImprovedMessagingforBIOScategorydownloads_ESUPPORT--------->\n  "+e);
		}
	}
}

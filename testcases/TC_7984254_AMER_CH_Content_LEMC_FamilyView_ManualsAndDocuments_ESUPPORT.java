...
public class TC_7984254_AMER_CH_Content_LEMC_FamilyView_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984254_AMER_CH_Content_LEMC_FamilyView_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984254_AMER_CH_Content_LEMC_FamilyView_ManualsAndDocuments_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnBackToDocumentationTab(driver);
		...
		{
			e.printStackTrace();
			Assert.fail("Failed in TC_7984254_AMER_CH_Content_LEMC_FamilyView_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

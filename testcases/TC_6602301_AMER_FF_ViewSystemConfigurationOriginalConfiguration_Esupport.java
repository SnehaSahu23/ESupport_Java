...
public class TC_6602301_AMER_FF_ViewSystemConfigurationOriginalConfiguration_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6602301_AMER_FF_ViewSystemConfigurationOriginalConfiguration_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6602301_AMER_FF_ViewSystemConfigurationOriginalConfiguration_Esupport");
		...
		{
			Assert.fail("Failed in TC_6602301_AMER_FF_ViewSystemConfigurationOriginalConfiguration_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_5775013_AMER_CH_EnterAServiceRequest_LEMCServiceRequest_Esupport extends BaseTest{
	
	@Test
	public void validate_TC_5775013_AMER_CH_EnterAServiceRequest_LEMCServiceRequest_Esupport(){
		
		try
		{
			System.out.println("Starting 5775013..."); 
		...
		{
			Assert.fail("Failed while executing test case TC_5775013_AMER_EnterAServiceRequest_LEMCServiceRequest_Esupport--------->\n  "+e);
		}

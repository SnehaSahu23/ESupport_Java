...
public class TC_8971384_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_8971384_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8971384_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ClickOnAddAttachmentButtonAndValidatePopUpForLEMC(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_8971384_AMER_IE_ContactUS_LEMC_SRCreate_eSupportHESPartsReplacement_ESUPPORT--------->\n  "+e);

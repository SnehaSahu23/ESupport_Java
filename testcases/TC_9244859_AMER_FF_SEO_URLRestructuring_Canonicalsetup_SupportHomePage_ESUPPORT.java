...
public class TC_9244859_AMER_FF_SEO_URLRestructuring_Canonicalsetup_SupportHomePage_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9244859_AMER_FF_SEO_URLRestructuring_Canonicalsetup_SupportHomePage_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9244859_AMER_FF_SEO_URLRestructuring_Canonicalsetup_SupportHomePage_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9244859_AMER_FF_SEO_URLRestructuring_Canonicalsetup_SupportHomePage_ESUPPORT--------->\n  "+e);

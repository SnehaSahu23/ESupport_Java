...
public class TC_7699072_AMER_CH_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7699072_AMER_CH_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT() 
	{
		try
		{
...
//			obj_EsupportIncidentsWorkflow.ToLogin_ValidCredentials(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_7699072_AMER_CH_Content_LEMC_ModelUnserializedView_SupportTopics_ESUPPORT--------->\n  "+e);
		}
	}
}

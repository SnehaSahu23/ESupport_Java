...
public class TC_9256870_AMER_IE_SEO_URLRestructuring_Canonicalsetup_CoveoSearch_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9256870_AMER_IE_SEO_URLRestructuring_Canonicalsetup_CoveoSearch_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9256870_AMER_IE_SEO_URLRestructuring_Canonicalsetup_CoveoSearch_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9256870_AMER_IE_SEO_URLRestructuring_Canonicalsetup_CoveoSearch_ESUPPORT--------->\n  "+e);

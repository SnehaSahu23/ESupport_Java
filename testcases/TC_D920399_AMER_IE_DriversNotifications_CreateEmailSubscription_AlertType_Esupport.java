...
public class TC_D920399_AMER_IE_DriversNotifications_CreateEmailSubscription_AlertType_Esupport extends BaseTest {
	@Test
	public void validate_TC_D920399_AMER_IE_DriversNotifications_CreateEmailSubscription_AlertType_Esupport() 
	{
		try
		{
		...
		{
			Assert.fail("Failed while executing test case TC_D920399_AMER_IE_DriversNotifications_CreateEmailSubscription_AlertType_Esupport--------->\n  "+e);
		}
	}
}

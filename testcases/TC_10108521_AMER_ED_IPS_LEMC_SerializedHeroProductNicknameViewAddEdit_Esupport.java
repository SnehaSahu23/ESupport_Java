...
public class TC_10108521_AMER_ED_IPS_LEMC_SerializedHeroProductNicknameViewAddEdit_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10108521_AMER_ED_IPS_LEMC_SerializedHeroProductNicknameViewAddEdit_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_10108521_AMER_ED_IPS_LEMC_SerializedHeroProductNicknameViewAddEdit_Esupport");
		...
		{
			Assert.fail("Failed in TC_10108521_AMER_ED_IPS_LEMC_SerializedHeroProductNicknameViewAddEdit_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_7704008_AMER_IE_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704008_AMER_IE_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704008_AMER_IE_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidateTimeZome(driver);
			...
			obj_EsupportIncidentsWorkflow.ValidateForm2WithoutEnteringMandatoryFieldsClickOnSubmitForLEMC(driver);
...
//			obj_EsupportIncidentsWorkflow.ClickOnAddAttachmentButtonAndValidatePopUpForLEMC(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704008_AMER_IE_Contactus_LEMC_SRCreate_HES_Licensing_Install_ESUPPORT--------->\n  "+e);

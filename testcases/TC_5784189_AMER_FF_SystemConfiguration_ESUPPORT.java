...
public class TC_5784189_AMER_FF_SystemConfiguration_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5784189_AMER_FF_SystemConfiguration_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5784189_AMER_FF_SystemConfiguration_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5784189_AMER_FF_SystemConfiguration_ESUPPORT--------->\n  "+e);

...
public class TC_9899095_AMER_IE_GOS_PCF_DPIDSearchOrdercollectionview_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_9899095_AMER_IE_GOS_PCF_DPIDSearchOrdercollectionview_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_9899095_AMER_IE_GOS_PCF_DPIDSearchOrdercollectionview_ESUPPORT");        
			...
			Assert.fail("Failed while executing test case TC_9899095_AMER_IE_GOS_PCF_DPIDSearchOrdercollectionview_ESUPPORT--------->\n  "+e);

...
public class TC_5785256_AMER_CH_SystemConfigurationOriginalConfiguration_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5785256_AMER_CH_SystemConfigurationOriginalConfiguration_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5785256_AMER_CH_SystemConfigurationOriginalConfiguration_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5785256_AMER_CH_SystemConfigurationOriginalConfiguration_ESUPPORT--------->\n  "+e);

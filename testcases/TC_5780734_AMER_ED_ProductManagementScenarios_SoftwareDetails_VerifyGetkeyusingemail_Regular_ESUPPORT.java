...
public class TC_5780734_AMER_ED_ProductManagementScenarios_SoftwareDetails_VerifyGetkeyusingemail_Regular_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5780734_AMER_ED_ProductManagementScenarios_SoftwareDetails_VerifyGetkeyusingemail_Regular_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5780734_AMER_ED_ProductManagementScenarios_SoftwareDetails_VerifyGetkeyusingemail_Regular_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_1862483_AMER_ED_DriversNotifications_UnabletocreateSubscription_ESUPPORT--------->\n  "+e);

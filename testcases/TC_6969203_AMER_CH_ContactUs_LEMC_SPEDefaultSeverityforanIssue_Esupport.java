...
public class TC_6969203_AMER_CH_ContactUs_LEMC_SPEDefaultSeverityforanIssue_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6969203_AMER_CH_ContactUs_LEMC_SPEDefaultSeverityforanIssue_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_6969203_AMER_CH_ContactUs_LEMC_SPEDefaultSeverityforanIssue_Esupport");
...
//			obj_EsupportIPSWorkflow.clickSignInHereLink(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_6969203_AMER_CH_ContactUs_LEMC_SPEDefaultSeverityforanIssue_Esupport--------->\n  "+e);

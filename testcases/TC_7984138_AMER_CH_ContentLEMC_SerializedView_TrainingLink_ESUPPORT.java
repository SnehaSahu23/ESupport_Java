...
public class TC_7984138_AMER_CH_ContentLEMC_SerializedView_TrainingLink_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984138_AMER_CH_ContentLEMC_SerializedView_TrainingLink_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984138_AMER_CH_ContentLEMC_SerializedView_TrainingLink_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnXButtonAfterClickingOnChangeProductForLEMCUser(driver);
		...
		{
			Assert.fail("Failed in TC_7984138_AMER_CH_ContentLEMC_SerializedView_TrainingLink_ESUPPORT()--------->\n  "+e);
		}
	}
}

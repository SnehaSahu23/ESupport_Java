...
public class TC_7689994_AMER_IE_IPS_LEMC_ConvergedSolutionMapLocation extends BaseTest
{
	@Test
	public void validate_TC_7689994_AMER_IE_IPS_LEMC_ConvergedSolutionMapLocation() 
	{
		try
		{
			System.out.println("Starts TC_7689994_AMER_IE_IPS_LEMC_ConvergedSolutionMapLocation");
		...
		{
			Assert.fail("Failed executing TC_7689994_AMER_IE_IPS_LEMC_ConvergedSolutionMapLocation--------->\n  "+e);
		}
	}
}
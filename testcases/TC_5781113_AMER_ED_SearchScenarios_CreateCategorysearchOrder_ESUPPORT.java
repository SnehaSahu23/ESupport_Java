...
public class TC_5781113_AMER_ED_SearchScenarios_CreateCategorysearchOrder_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_5781113_AMER_ED_SearchScenarios_CreateCategorysearchOrder_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# _5781113_AMER_ED");
		...
		{
			Assert.fail("Failed while executing test case TC_5781113_AMER_ED_SearchScenarios_CreateCategorysearchOrder_ESUPPORT--------->\n  "+e);
		}
	}
}

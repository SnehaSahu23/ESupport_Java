...
public class TC_7758963_AMER_CH_Portal_DatePicker_DateRangeLimitsForRespectiveSummaryViews_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7758963_AMER_CH_Portal_DatePicker_DateRangeLimitsForRespectiveSummaryViews_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7758963_AMER_CH_Portal_DatePicker_DateRangeLimitsForRespectiveSummaryViews_ESUPPORT");
...
//			obj_EsupportPortalWorkflow.ClickOnFilterAndValidateIBStatusDefaultNotSelectedOptionsDisplayedInInstallBasePage(driver);
		...
		{
			Assert.fail("Failed in TC_7758963_AMER_CH_Portal_DatePicker_DateRangeLimitsForRespectiveSummaryViews_ESUPPORT--------->\n  "+e);
		}
	}
}

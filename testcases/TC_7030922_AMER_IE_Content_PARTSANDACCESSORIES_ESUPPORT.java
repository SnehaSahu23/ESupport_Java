...
public class TC_7030922_AMER_IE_Content_PARTSANDACCESSORIES_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7030922_AMER_IE_Content_PARTSANDACCESSORIES_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7030922_AMER_IE_Content_PARTSANDACCESSORIES_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7030922_AMER_IE_Content_PARTSANDACCESSORIES_ESUPPORT--------->\n  "+e);
		}
	}
}

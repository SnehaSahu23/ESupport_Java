...
public class TC_5869571_AMER_IE_ContactUSslider_Webparts_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5869571_AMER_IE_ContactUSslider_Webparts_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 5869571_AMER_IE_ContactUSslider_Webparts_ESUPPORT");
			...
			Assert.fail("Failed while executing test case TC_5869571_AMER_IE_ContactUSslider_Webparts_ESUPPORT--------->\n  "+e);

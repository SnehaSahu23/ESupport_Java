...
public class TC_6706303_AMER_IE_PSILDellDriversanddownloadsreskinAdditionalfeatures extends BaseTest
{
	@Test
	public void validate_TC_6706303_AMER_IE_PSILDellDriversanddownloadsreskinAdditionalfeatures() 
	{
		try
		{
			System.out.println("Starts TC_6706303_AMER_IE_PSILDellDriversanddownloadsreskinAdditionalfeatures");
		...
		{
			Assert.fail("Failed in TC_6706303_AMER_IE_PSILDellDriversanddownloadsreskinAdditionalfeatures--------->\n  "+e);
		}
	}
}

...
public class TC_9785917_AMER_CH_LBK_OpenContent_SecurityNotices_External_L10_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785917_AMER_CH_LBK_OpenContent_SecurityNotices_External_L10_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785917_AMER_CH_LBK_OpenContent_SecurityNotices_External_L10_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785917_AMER_CH_LBK_OpenContent_SecurityNotices_External_L10_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_7947923_AMER_CH_Content_LEMC_AutomationModelUnserializedView_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7947923_AMER_CH_Content_LEMC_AutomationModelUnserializedView_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7947923_AMER_CH_Content_LEMC_AutomationModelUnserializedView_ManualsAndDocuments_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnBackToDocumentationTab(driver);
		...
		{
			Assert.fail("Failed in TC_7947923_AMER_CH_Content_LEMC_AutomationModelUnserializedView_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

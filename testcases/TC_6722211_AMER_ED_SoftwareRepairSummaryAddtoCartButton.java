...
public class TC_6722211_AMER_ED_SoftwareRepairSummaryAddtoCartButton extends BaseTest
{
	@Test
	public void validate_TC_6722211_AMER_ED_SoftwareRepairSummaryAddtoCartButton() 
	{
		try
		{
			System.out.println("Starts TC_6722211_AMER_ED_SoftwareRepairSummaryAddtoCartButton");
		...
		{
			Assert.fail("Failed in TC_6722211_AMER_ED_SoftwareRepairSummaryAddtoCartButton--------->\n  "+e);
		}
	}
}

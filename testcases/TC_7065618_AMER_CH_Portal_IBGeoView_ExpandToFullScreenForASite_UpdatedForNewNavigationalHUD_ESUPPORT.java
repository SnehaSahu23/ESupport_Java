...
public class TC_7065618_AMER_CH_Portal_IBGeoView_ExpandToFullScreenForASite_UpdatedForNewNavigationalHUD_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7065618_AMER_CH_Portal_IBGeoView_ExpandToFullScreenForASite_UpdatedForNewNavigationalHUD_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7065618_AMER_CH_Portal_IBGeoView_ExpandToFullScreenForASite_UpdatedForNewNavigationalHUD_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7065618_AMER_CH_Portal_IBGeoView_ExpandToFullScreenForASite_UpdatedForNewNavigationalHUD_ESUPPORT--------->\n  "+e);
		}
	}
}

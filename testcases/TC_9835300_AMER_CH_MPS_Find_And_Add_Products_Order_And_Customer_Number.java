...
public class TC_9835300_AMER_CH_MPS_Find_And_Add_Products_Order_And_Customer_Number extends BaseTest
{
   @Test
   public void validate_TC_9835300_AMER_CH_MPS_Find_And_Add_Products_Order_And_Customer_Number()
   {
	   try
	   {
		...
		{
			Assert.fail("Failed in TC_9835300_AMER_CH_MPS_Find_And_Add_Products_Order_And_Customer_Number()--------->\n  "+e);
		}
   }
}

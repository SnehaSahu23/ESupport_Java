...
public class TC_9018106_AMER_FF_SecurityLandingPage_Openlink_in_newtab extends BaseTest
{
	@Test
	public void validate_TC_9018106_AMER_FF_SecurityLandingPage_Openlink_in_newtab() 
	{
		try
		{
			System.out.println("Starts TC_9018106_AMER_FF_SecurityLandingPage_Openlink_in_newtab");
		...
		{
			Assert.fail("Failed in TC_9018106_AMER_FF_SecurityLandingPage_Openlink_in_newtab--------->\n  "+e);
		}
	}
}

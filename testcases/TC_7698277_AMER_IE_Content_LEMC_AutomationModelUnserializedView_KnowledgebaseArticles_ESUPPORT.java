...
public class TC_7698277_AMER_IE_Content_LEMC_AutomationModelUnserializedView_KnowledgebaseArticles_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7698277_AMER_IE_Content_LEMC_AutomationModelUnserializedView_KnowledgebaseArticles_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7698277_AMER_IE_Content_LEMC_AutomationModelUnserializedView_KnowledgebaseArticles_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		{
			Assert.fail("Failed in TC_7698277_AMER_IE_Content_LEMC_AutomationModelUnserializedView_KnowledgebaseArticles_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_8754174_AMER_CH_UnifiedProfile_CustomGroups_Story8261844PflowCreateaCustomgroupUsingSitesLayout_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8754174_AMER_CH_UnifiedProfile_CustomGroups_Story8261844PflowCreateaCustomgroupUsingSitesLayout_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8754174_AMER_CH_UnifiedProfile_CustomGroups_Story8261844PflowCreateaCustomgroupUsingSitesLayout_ESUPPORT");
			Thread.sleep(6000);	
...
//			Thread.sleep(6000);
			...
			Assert.fail("Failed while executing test case TC_8754174_AMER_CH_UnifiedProfile_CustomGroups_Story8261844PflowCreateaCustomgroupUsingSitesLayout_ESUPPORT--------->\n  "+e);

...
public class TC_10147110_AMER_IE_IPS_LDellModelOverviewtab_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10147110_AMER_IE_IPS_LDellModelOverviewtab_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_10147110_AMER_IE_IPS_LDellModelOverviewtab_Esupport");
		...
		{
			Assert.fail("Failed in TC_10147110_AMER_IE_IPS_LDellModelOverviewtab_Esupport--------->\n  "+e);
		}
	}
}
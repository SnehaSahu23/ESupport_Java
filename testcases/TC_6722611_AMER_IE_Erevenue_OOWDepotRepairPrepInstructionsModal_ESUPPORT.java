...
public class TC_6722611_AMER_IE_Erevenue_OOWDepotRepairPrepInstructionsModal_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6722611_AMER_IE_Erevenue_OOWDepotRepairPrepInstructionsModal_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6722611_AMER_IE_Erevenue_OOWDepotRepairPrepInstructionsModal_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_6722611_AMER_IE_Erevenue_OOWDepotRepairPrepInstructionsModal_ESUPPORT--------->\n  "+e);
		}
	}
}

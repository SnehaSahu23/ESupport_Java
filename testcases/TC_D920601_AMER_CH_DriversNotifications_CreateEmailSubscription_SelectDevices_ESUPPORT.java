...
public class TC_D920601_AMER_CH_DriversNotifications_CreateEmailSubscription_SelectDevices_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920601_AMER_CH_DriversNotifications_CreateEmailSubscription_SelectDevices_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while executing TC_D920601_AMER_CH_DriversNotifications_CreateEmailSubscription_SelectDevices--------->\n  "+e);

...
public class TC_5784146_AMER_FF_SearchScenarios_CreateDateRangesearch_OrderHistory_ESUPPORT extends BaseTest
{	
	@Test
	public void validate_TC_5784146_AMER_FF_SearchScenarios_CreateDateRangesearch_OrderHistory_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_5784146_AMER_FF_SearchScenarios_CreateDateRangesearch_OrderHistory_ESUPPORT");
		...
		{
			Assert.fail("Failed while executing test case TC_5784146_AMER_FF_SearchScenarios_CreateDateRangesearch_OrderHistory_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_1862483_AMER_FF_DriversNotifications_UnabletocreateSubscription_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_1862483_AMER_FF_DriversNotifications_UnabletocreateSubscription_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_1862483_AMER_FF_DriversNotifications_UnabletocreateSubscription_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_1862483_AMER_FF_DriversNotifications_UnabletocreateSubscription_ESUPPORT--------->\n  "+e);

...
public class TC_6877603_AMER_ED_Contact_ConsumeRecentlyViewedProductsService_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_6877603_AMER_ED_Contact_ConsumeRecentlyViewedProductsService_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_6877603_AMER_ED_Contact_ConsumeRecentlyViewedProductsService_LDELL_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_6877603_AMER_ED_Contact_ConsumeRecentlyViewedProductsService_LDELL_ESUPPORT--------->\n  "+e);

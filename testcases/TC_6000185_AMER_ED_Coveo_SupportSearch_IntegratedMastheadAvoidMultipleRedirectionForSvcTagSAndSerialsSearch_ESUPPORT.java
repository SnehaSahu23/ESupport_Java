...
public class TC_6000185_AMER_ED_Coveo_SupportSearch_IntegratedMastheadAvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000185_AMER_ED_Coveo_SupportSearch_IntegratedMastheadAvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000185_AMER_ED_Coveo_SupportSearch_IntegratedMastheadAvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000185_AMER_ED_Coveo_SupportSearch_IntegratedMastheadAvoidMultipleRedirectionForSvcTagSAndSerialsSearch_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_6818358_AMER_IE_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6818358_AMER_IE_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6818358_AMER_IE_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport");
...
//			Thread.sleep(5000);
		...
		{
			Assert.fail("FailIE in TC_6818358_AMER_IE_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport--------->\n  "+e);
		}
	}
}

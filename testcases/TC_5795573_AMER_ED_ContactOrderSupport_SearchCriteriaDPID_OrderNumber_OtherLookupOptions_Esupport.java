...
public class TC_5795573_AMER_ED_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5795573_AMER_ED_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5795573_AMER_ED_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5795573_AMER_ED_ContactOrderSupport_SearchCriteriaDPID_OrderNumber_OtherLookupOptions_Esupport--------->\n  "+e);

...
public class TC_9835063_AMER_CH_MPS_PCF_CreateEditGroupsSaveAndAddProductsCompleteAddingItemsToGroup_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9835063_AMER_CH_MPS_PCF_CreateEditGroupsSaveAndAddProductsCompleteAddingItemsToGroup_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9835063_AMER_CH_MPS_PCF_CreateEditGroupsSaveAndAddProductsCompleteAddingItemsToGroup_ESUPPORT()");
...
//			obj_EsupportMPSWorkflow.clickOnSaveGroup(driver);
		...
		{
			Assert.fail("Failed in TC_9835063_AMER_CH_MPS_PCF_CreateEditGroupsSaveAndAddProductsCompleteAddingItemsToGroup_ESUPPORT()--------->\n  "+e);
		}
	}
}

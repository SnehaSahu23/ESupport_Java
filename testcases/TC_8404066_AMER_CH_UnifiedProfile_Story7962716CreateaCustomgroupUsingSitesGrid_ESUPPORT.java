...
public class TC_8404066_AMER_CH_UnifiedProfile_Story7962716CreateaCustomgroupUsingSitesGrid_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8404066_AMER_CH_UnifiedProfile_Story7962716CreateaCustomgroupUsingSitesGrid_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8404066_AMER_CH_UnifiedProfile_Story7962716CreateaCustomgroupUsingSitesGrid_ESUPPORT");
			Thread.sleep(6000);	
			...
			Assert.fail("Failed while executing test case TC_8404066_AMER_CH_UnifiedProfile_Story7962716CreateaCustomgroupUsingSitesGrid_ESUPPORT--------->\n  "+e);

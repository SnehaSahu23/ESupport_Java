...
public class TC_9021048_AMER_FF_SecurityLandingPage_Datepicker extends BaseTest
{
	@Test
	public void validate_TC_9021048_AMER_FF_SecurityLandingPage_Datepicker() 
	{
		try
		{
			System.out.println("Starts TC_9021048_AMER_FF_SecurityLandingPage_Datepicker");
		...
		{
			Assert.fail("Failed in TC_9021048_AMER_FF_SecurityLandingPage_Datepicker--------->\n  "+e);
		}
	}
}
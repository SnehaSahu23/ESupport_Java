...
public class TC_5784080_AMER_ED_WarrantyTabs_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5784080_AMER_ED_WarrantyTabs_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5784080_AMER_ED_WarrantyTabs_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5784080_AMER_ED_WarrantyTabs_ESUPPORT--------->\n  "+e);

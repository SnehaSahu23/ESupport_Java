...
public class TC_5786145_AMER_IE_Customerlengthchangesfrom9to12_Esupport extends BaseTest
{

	@Test
	public void validate_TC_5786145_AMER_IE_Customerlengthchangesfrom9to12_Esupport() 
	{

		try
		{
			Thread.sleep(10000);
			System.out.println("Starts TC_5786145_AMER_IE_Customerlengthchangesfrom9to12_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5786145_AMER_IE_Customerlengthchangesfrom9to12_Esupport--------->\n  "+e);

...
public class TC_5774887_AMER_CH_EnterLEMC_Serialnumber_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5774887_AMER_CH_EnterLEMC_Serialnumber_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5774887_AMER_CH_EnterLEMC_Serialnumber_ESUPPORT");
			...
			Assert.fail("Failed while executing test case TC_5774887_AMER_CH_EnterLEMC_Serialnumber_ESUPPORT--------->\n  "+e);

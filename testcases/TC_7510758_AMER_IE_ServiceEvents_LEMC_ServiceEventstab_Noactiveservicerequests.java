...
public class TC_7510758_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Noactiveservicerequests extends BaseTest
{
	@Test
	public void validate_TC_7510758_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Noactiveservicerequests() 
	{
		try
		{
			System.out.println("Starts TC_7510758_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Noactiveservicerequests");
		...
		{
			Assert.fail("Failed in TC_7510758_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Noactiveservicerequests--------->\n  "+e);
		}
	}
}

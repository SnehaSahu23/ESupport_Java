...
public class TC_5782402_AMER_CH_Transactional_Customers_US_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5782402_AMER_CH_Transactional_Customers_US_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 5782402_AMER_CH");
...
//			obj_EsupportRecentOrderWorkflow.clickOrderStatusLink(driver);
			...
			Assert.fail("Failed while executing test case TC_5782402_AMER_CH_Transactional_Customers_US_ESUPPORT--------->\n  "+e);

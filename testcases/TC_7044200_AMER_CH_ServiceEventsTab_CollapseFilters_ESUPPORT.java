...
public class TC_7044200_AMER_CH_ServiceEventsTab_CollapseFilters_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7044200_AMER_CH_ServiceEventsTab_CollapseFilters_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7044200_AMER_CH_ServiceEventsTab_CollapseFilters_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7044200_AMER_CH_ServiceEventsTab_CollapseFilters_ESUPPORT--------->\n  "+e);
		}
	}
}

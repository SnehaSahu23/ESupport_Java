...
public class TC_7863935_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_DDL_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863935_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_DDL_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863935_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_DDL_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863935_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_DDL_ESUPPORT--------->\n  "+e);
		}
	}
}

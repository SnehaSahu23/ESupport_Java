...
public class TC_5712722_AMER_CH_ChooseFrom_AllProducts_Unauthenticated_Esupport extends BaseTest{
	
	@Test
	public void validate_TC_5712722_AMER_CH_ChooseFrom_AllProducts_Unauthenticated_Esupport(){
		
		
		try
		{
			System.out.println("Starting 5712722_AMER_CH_ChooseFrom_AllProducts_Unauthenticated_Esupport..."); 
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SupportValue.ordinal()).split(";")[1]);
		...
		{
			Assert.fail("Failed while executing test case TC_5712722_AMER_CH_ChooseFrom_AllProducts_Unauthenticated_Esupport--------->\n  "+e);
		}
	}

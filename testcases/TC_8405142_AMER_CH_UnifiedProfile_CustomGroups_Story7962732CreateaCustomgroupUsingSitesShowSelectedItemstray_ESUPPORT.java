...
public class TC_8405142_AMER_CH_UnifiedProfile_CustomGroups_Story7962732CreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8405142_AMER_CH_UnifiedProfile_CustomGroups_Story7962732CreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8405142_AMER_CH_UnifiedProfile_CustomGroups_Story7962732CreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT");
			Thread.sleep(6000);	
			...
			Assert.fail("Failed while executing test case TC_8405142_AMER_CH_UnifiedProfile_CustomGroups_Story7962732CreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT--------->\n  "+e);

...
public class TC_8979843_AMER_IE_Dispatches_PartsandLaborChevrons_AttributesandUpdate extends BaseTest 
{
	@Test
	public void validate_TC_8979843_AMER_IE_Dispatches_PartsandLaborChevrons_AttributesandUpdate() 
	{

		try
		{
			System.out.println("Starts TC_8979843_AMER_IE_Dispatches_PartsandLaborChevrons_AttributesandUpdate");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_8979843_AMER_IE_Dispatches_PartsandLaborChevrons_AttributesandUpdate--------->\n  "+e);

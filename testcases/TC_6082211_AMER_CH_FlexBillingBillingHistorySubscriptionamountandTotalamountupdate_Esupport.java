...
public class TC_6082211_AMER_CH_FlexBillingBillingHistorySubscriptionamountandTotalamountupdate_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6082211_AMER_CH_FlexBillingBillingHistorySubscriptionamountandTotalamountupdate_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6082211_AMER_CH_FlexBillingBillingHistorySubscriptionamountandTotalamountupdate_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_6082211_AMER_CH_FlexBillingBillingHistorySubscriptionamountandTotalamountupdate_Esupport--------->\n  "+e);
		}
	}
}

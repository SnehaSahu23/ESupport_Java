...
public class TC_6881549_AMER_MB_IPS_LdellModelPageoverviewtab_Esupport extends MobilePage
{
	@Test
	public void validate_TC_6881549_AMER_MB_IPS_LdellModelPageoverviewtab_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6881549_AMER_MB_IPS_LdellModelPageoverviewtab_Esupport");
			Thread.sleep(6000);
...
//            obj_EsupportMobileWorkflow.verifyOverviewTabDetails_EnterServiceTag(driver);
            ...
            obj_EsupportMobileWorkflow.enterServiceTagModalPopup(driver, MobileTestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()));
            obj_EsupportMobileWorkflow.verifyOverviewTabDetails_SignIn(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed in TC_6881549_AMER_MB_IPS_LdellModelPageoverviewtab_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_6818358_AMER_FF_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6818358_AMER_FF_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6818358_AMER_FF_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport");
...
//			Thread.sleep(5000);
		...
		{
			Assert.fail("Failed in TC_6818358_AMER_FF_IPS_LDellOverviewTagExpiredtagRenewWarrantyinformationModalPopup_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_6063618_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryDDL_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6063618_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryDDL_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_6063618_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryDDL_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_6063618_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryDDL_Esupport--------->\n  "+e);

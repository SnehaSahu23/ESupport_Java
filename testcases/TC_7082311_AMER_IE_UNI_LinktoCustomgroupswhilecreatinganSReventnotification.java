...
public class TC_7082311_AMER_IE_UNI_LinktoCustomgroupswhilecreatinganSReventnotification extends BaseTest
{
	@Test
	public void validate_TC_7082311_AMER_IE_UNI_LinktoCustomgroupswhilecreatinganSReventnotification() 
	{
		try
		{
			System.out.println("Starts TC_7082311_AMER_IE_UNI_LinktoCustomgroupswhilecreatinganSReventnotification");
			Thread.sleep(10000);	
		...
		{
			Assert.fail("Failed in TC_7082311_AMER_IE_UNI_LinktoCustomgroupswhilecreatinganSReventnotification--------->\n  "+e);
		}
	}
}

...
public class TC_6490459_AMER_IE_FreeText_EntryBox_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6490459_AMER_IE_FreeText_EntryBox_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _6490459_AMER_IE");
		...
		{
			Assert.fail("Failed while executing test case TC_6490459_AMER_IE_FreeText_EntryBox_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_6107708_AMER_ED_Premier_PQAThomesearch_POsearch_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_6107708_AMER_ED_Premier_PQAThomesearch_POsearch_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6107708_AMER_ED");
...
//			obj_EsupportRecentOrderWorkflow.clickOrderStatusLink(driver);
			...
			Assert.fail("Failed while executing test case TC_6107708_AMER_ED_Premier_PQAThomesearch_POsearch_ESUPPORT--------->\n  "+e);

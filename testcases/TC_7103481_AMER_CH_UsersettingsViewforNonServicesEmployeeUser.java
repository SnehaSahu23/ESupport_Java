...
public class TC_7103481_AMER_CH_UsersettingsViewforNonServicesEmployeeUser extends BaseTest
{
	@Test
	public void validate_TC_7103481_AMER_CH_UsersettingsViewforNonServicesEmployeeUser() 
	{
		try
		{
			System.out.println("Starts TC_7103481_AMER_CH_UsersettingsViewforNonServicesEmployeeUser");
			Thread.sleep(10000);
		...
		{
			Assert.fail("Failed in TC_7103481_AMER_CH_UsersettingsViewforNonServicesEmployeeUser--------->\n  "+e);
		}
	}
}

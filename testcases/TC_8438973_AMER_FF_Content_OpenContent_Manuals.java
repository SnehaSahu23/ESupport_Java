...
public class TC_8438973_AMER_FF_Content_OpenContent_Manuals extends BaseTest {


	@Test
	public void validate_TC_8438973_AMER_FF_Content_OpenContent_Manuals() 
	{
		try
		{
			System.out.println("Starts TC_8438973_AMER_FF_Content_OpenContent_Manuals");
		...
		{
			Assert.fail("Failed in TC_8438973_AMER_FF_Content_OpenContent_Manuals--------->\n  "+e);
		}
	}
}

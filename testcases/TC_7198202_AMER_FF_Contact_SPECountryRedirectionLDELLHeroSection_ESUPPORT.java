...
public class TC_7198202_AMER_FF_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7198202_AMER_FF_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7198202_AMER_FF_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT");
			//for guest user
...
//			obj_EsupportIPSWorkflow.signOut(driver);
		...
		{
			Assert.fail("Failed in TC_7198202_AMER_FF_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT--------->\n  "+e);
		}
	}
}

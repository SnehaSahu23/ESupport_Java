...
public class TC_7247383_AMER_IE_ServiceEventsTab_Activeeventstoggle_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7247383_AMER_IE_ServiceEventsTab_Activeeventstoggle_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7247383_AMER_IE_ServiceEventsTab_Activeeventstoggle_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7247383_AMER_IE_ServiceEventsTab_Activeeventstoggle_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_7863878_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadSearch_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863878_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadSearch_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863878_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadSearch_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863878_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadSearch_ESUPPORT--------->\n  "+e);
		}
	}
}

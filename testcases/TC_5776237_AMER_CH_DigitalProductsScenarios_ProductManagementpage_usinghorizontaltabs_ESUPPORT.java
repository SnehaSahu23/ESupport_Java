...
public class TC_5776237_AMER_CH_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5776237_AMER_CH_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5776237_AMER_CH_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT--------->\n  "+e);

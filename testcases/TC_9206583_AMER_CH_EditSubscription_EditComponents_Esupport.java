...
public class TC_9206583_AMER_CH_EditSubscription_EditComponents_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_9206583_AMER_CH_EditSubscription_EditComponents_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_9206583_AMER_CH_EditSubscription_EditComponents_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9206583_AMER_CH_EditSubscription_EditComponents_Esupport--------->\n  "+e);

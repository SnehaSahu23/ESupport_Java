...
public class TC_9257027_AMER_CH_SEO_URLRestructuring_Canonicalsetup_ContentSecurity_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9257027_AMER_CH_SEO_URLRestructuring_Canonicalsetup_ContentSecurity_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9257027_AMER_CH_SEO_URLRestructuring_Canonicalsetup_ContentSecurity_ESUPPORT");
...
//			obj_EsupportSEOWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9257027_AMER_CH_SEO_URLRestructuring_Canonicalsetup_ContentSecurity_ESUPPORT--------->\n  "+e);

...
public class TC_6602837_AMER_FF_WarrantydetailsmodalLDellandMnAsImportantinformationnote_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6602837_AMER_FF_WarrantydetailsmodalLDellandMnAsImportantinformationnote_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6602837_AMER_FF_WarrantydetailsmodalLDellandMnAsImportantinformationnote_Esupport");
		...
		{
			Assert.fail("Failed in TC_6602837_AMER_FF_WarrantydetailsmodalLDellandMnAsImportantinformationnote_Esupport--------->\n  "+e);
		}
	}
}

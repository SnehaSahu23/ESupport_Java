...
public class TC_6881214_AMER_ED_IPS_WarrantydetailsmodalLDellandMnAPrintandimportantinformation_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6881214_AMER_ED_IPS_WarrantydetailsmodalLDellandMnAPrintandimportantinformation_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6881214_AMER_ED_IPS_WarrantydetailsmodalLDellandMnAPrintandimportantinformation_Esupport");
...
//			driver.navigate().back();
		...
		{
			Assert.fail("Failed in TC_6881214_AMER_ED_IPS_WarrantydetailsmodalLDellandMnAPrintandimportantinformation_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_7171054_AMER_FF_IPS_LEMC_EnterProductID_AuthenticatedUser_model_series_family_page_Esupport extends BaseTest
{
	@Test
	public void validate_TC_7171054_AMER_FF_IPS_LEMC_EnterProductID_AuthenticatedUser_model_series_family_page_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7171054_AMER_FF_IPS_LEMC_EnterProductID_AuthenticatedUser_model_series_family_page_Esupport");
...
//			obj_EsupportIPSWorkflow.clickEnterServiceTagPopupCloseButton(driver);
		...
		{
			Assert.fail("Failed executing TC_7171054_AMER_FF_IPS_LEMC_EnterProductID_AuthenticatedUser_model_series_family_page_Esupport--------->\n  "+e);
		}
	}
}

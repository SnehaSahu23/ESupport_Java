...
public class TC_8413997_AMER_CH_UnifiedProfile_CustomGroups_Story7962734CreateaCustomgroupUsingSitesShowSelectedItemstrayAssetPreview_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8413997_AMER_CH_UnifiedProfile_CustomGroups_Story7962734CreateaCustomgroupUsingSitesShowSelectedItemstrayAssetPreview_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8413997_AMER_CH_UnifiedProfile_CustomGroups_Story7962734CreateaCustomgroupUsingSitesShowSelectedItemstrayAssetPreview_ESUPPORT");
			Thread.sleep(6000);	
			...
			Assert.fail("Failed while executing test case TC_8413997_AMER_CH_UnifiedProfile_CustomGroups_Story7962734CreateaCustomgroupUsingSitesShowSelectedItemstrayAssetPreview_ESUPPORT--------->\n  "+e);

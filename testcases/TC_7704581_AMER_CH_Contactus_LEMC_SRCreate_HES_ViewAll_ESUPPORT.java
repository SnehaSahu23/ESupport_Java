...
public class TC_7704581_AMER_CH_Contactus_LEMC_SRCreate_HES_ViewAll_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704581_AMER_CH_Contactus_LEMC_SRCreate_HES_ViewAll_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704581_AMER_CH_Contactus_LEMC_SRCreate_HES_ViewAll_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ToLogin_ValidCredentials(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704581_AMER_CH_Contactus_LEMC_SRCreate_HES_ViewAll_ESUPPORT--------->\n  "+e);

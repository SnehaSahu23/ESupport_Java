...
public class TC_7037106_AMER_CH_UnifiedPortal_CustomGroupsCreationMyProductGroupsCount extends BaseTest
{
	@Test
	public void validate_TC_7037106_AMER_CH_UnifiedPortal_CustomGroupsCreationMyProductGroupsCount() 
	{
		try
		{
			...
			Thread.sleep(10000);	
			obj_EsupportUnifiedPortalWorkflow.verifyProductsCount(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed in TC_7037106_AMER_CH_UnifiedPortal_CustomGroupsCreationMyProductGroupsCount--------->\n  "+e);
		}
	}
}

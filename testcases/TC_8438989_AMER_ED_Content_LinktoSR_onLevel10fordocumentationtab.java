...
public class TC_8438989_AMER_ED_Content_LinktoSR_onLevel10fordocumentationtab extends BaseTest {


	@Test
	public void validate_TC_8438989_AMER_ED_Content_LinktoSR_onLevel10fordocumentationtab() 
	{
		try
		{
			System.out.println("Starts TC_8438989_AMER_ED_Content_LinktoSR_onLevel10fordocumentationtab");
		...
		{
			Assert.fail("Failed in TC_8438989_AMER_ED_Content_LinktoSR_onLevel10fordocumentationtab--------->\n  "+e);
		}
	}
}

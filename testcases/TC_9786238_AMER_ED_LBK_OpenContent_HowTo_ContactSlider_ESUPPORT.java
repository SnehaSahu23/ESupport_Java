...
public class TC_9786238_AMER_ED_LBK_OpenContent_HowTo_ContactSlider_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9786238_AMER_ED_LBK_OpenContent_HowTo_ContactSlider_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9786238_AMER_ED_LBK_OpenContent_HowTo_ContactSlider_ESUPPORT()");
...
//			obj_EsupportIPSWorkflow.clickSignIn(driver);
		...
		{
			Assert.fail("Failed in TC_9786238_AMER_ED_LBK_OpenContent_HowTo_ContactSlider_ESUPPORT()--------->\n  "+e);
		}
	}
}

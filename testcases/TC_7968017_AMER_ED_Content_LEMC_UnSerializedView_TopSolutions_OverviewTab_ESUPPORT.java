...
public class TC_7968017_AMER_ED_Content_LEMC_UnSerializedView_TopSolutions_OverviewTab_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7968017_AMER_ED_Content_LEMC_UnSerializedView_TopSolutions_OverviewTab_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7968017_AMER_ED_Content_LEMC_UnSerializedView_TopSolutions_OverviewTab_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnLinkToServiceRequestLogoOfTopSolutionsForLEMCUserInOverviewTab(driver);
		...
		{
			Assert.fail("Failed in TC_7968017_AMER_ED_Content_LEMC_UnSerializedView_TopSolutions_OverviewTab_ESUPPORT()--------->\n  "+e);
		}
	}
}

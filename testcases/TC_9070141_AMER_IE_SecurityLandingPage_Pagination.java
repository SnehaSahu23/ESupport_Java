...
public class TC_9070141_AMER_IE_SecurityLandingPage_Pagination extends BaseTest
{
	@Test
	public void validate_TC_9070141_AMER_IE_SecurityLandingPage_Pagination() 
	{
		try
		{
			System.out.println("Starts TC_9070141_AMER_IE_SecurityLandingPage_Pagination");
		...
		{
			Assert.fail("Failed in TC_9070141_AMER_IE_SecurityLandingPage_Pagination--------->\n  "+e);
		}
	}
}

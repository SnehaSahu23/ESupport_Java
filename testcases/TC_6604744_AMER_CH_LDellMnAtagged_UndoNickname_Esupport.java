...
public class TC_6604744_AMER_CH_LDellMnAtagged_UndoNickname_Esupport extends BaseTest{
	@Test
	public void validate_TC_6604744_AMER_CH_LDellMnAtagged_UndoNickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6604744_AMER_CH_LDellMnAtagged_UndoNickname_Esupport");
		...
		{
			Assert.fail("Failed in TC_6604744_AMER_CH_LDellMnAtagged_UndoNickname_Esupport--------->\n  "+e);
		}
	}
}

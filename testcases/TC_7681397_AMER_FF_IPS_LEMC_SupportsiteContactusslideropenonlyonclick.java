...
public class TC_7681397_AMER_FF_IPS_LEMC_SupportsiteContactusslideropenonlyonclick extends BaseTest
{
	@Test
	public void validate_TC_7681397_AMER_FF_IPS_LEMC_SupportsiteContactusslideropenonlyonclick() 
	{
		try
		{
			System.out.println("Starts TC_7681397_AMER_FF_IPS_LEMC_SupportsiteContactusslideropenonlyonclick");
		...
		{
			Assert.fail("Failed in TC_7681397_AMER_FF_IPS_LEMC_SupportsiteContactusslideropenonlyonclick--------->\n  "+e);
		}
	}
}

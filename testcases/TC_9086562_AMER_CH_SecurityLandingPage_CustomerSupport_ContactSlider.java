...
public class TC_9086562_AMER_CH_SecurityLandingPage_CustomerSupport_ContactSlider extends BaseTest
{
	@Test
	public void validate_TC_9086562_AMER_CH_SecurityLandingPage_CustomerSupport_ContactSlider() 
	{
		try
		{
			System.out.println("Starts TC_9086562_AMER_CH_SecurityLandingPage_CustomerSupport_ContactSlider");
		...
		{
			Assert.fail("Failed in TC_9086562_AMER_CH_SecurityLandingPage_CustomerSupport_ContactSlider--------->\n  "+e);
		}
	}
}

...
public class TC_8754727_AMER_CH_UnifiedProfile_CustomGroups_Story8297583PEflowCreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8754727_AMER_CH_UnifiedProfile_CustomGroups_Story8297583PEflowCreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8754727_AMER_CH_UnifiedProfile_CustomGroups_Story8297583PEflowCreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT");
			Thread.sleep(6000);	
			...
			Assert.fail("Failed while executing test case TC_8754727_AMER_CH_UnifiedProfile_CustomGroups_Story8297583PEflowCreateaCustomgroupUsingSitesShowSelectedItemstray_ESUPPORT--------->\n  "+e);

...
public class TC_7704561_AMER_ED_ContactUS_LEMC_SPEContactUS_SRCreationHES_EditMyPreferences_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704561_AMER_ED_ContactUS_LEMC_SPEContactUS_SRCreationHES_EditMyPreferences_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704561_AMER_ED_ContactUS_LEMC_SPEContactUS_SRCreationHES_EditMyPreferences_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidationContactChannelsAreGreyedOut(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704561_AMER_ED_ContactUS_LEMC_SPEContactUS_SRCreationHES_EditMyPreferences_ESUPPORT--------->\n  "+e);

...
public class TC_5786195_AMER_IE_UserandGroupsScenarios_RolesPermissions_VerifyCreateEditProductGroup_SuperAdmin_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5786195_AMER_IE_UserandGroupsScenarios_RolesPermissions_VerifyCreateEditProductGroup_SuperAdmin_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _5786195_AMER_IE");
		...
		{
			Assert.fail("Failed while executing test case TC_5786195_AMER_IE_UserandGroupsScenarios_RolesPermissions_VerifyCreateEditProductGroup_SuperAdmin_Esupport--------->\n  "+e);
		}
	}
}

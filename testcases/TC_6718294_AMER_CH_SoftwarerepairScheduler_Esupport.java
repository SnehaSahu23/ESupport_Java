...
public class TC_6718294_AMER_CH_SoftwarerepairScheduler_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6718294_AMER_CH_SoftwarerepairScheduler_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6718294_AMER_CH_SoftwarerepairScheduler_Esupport");
...
//			obj_EsupportErevenueWorkflow.clickAddToCartButton(driver);
		...
		{
			Assert.fail("Failed in TC_6718294_AMER_CH_SoftwarerepairScheduler_Esupport--------->\n  "+e);
		}
	}
}

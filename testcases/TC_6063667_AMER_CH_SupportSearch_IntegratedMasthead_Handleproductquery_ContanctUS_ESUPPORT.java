...
public class TC_6063667_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_6063667_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6063667_AMER_CH"); 
...
//			obj_EsupportCoveoWorkflow.ToVerify_searchServiceTagsupportpage(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()).split(";")[3]);
		...
		{
			Assert.fail("Failed while executing test case TC_6063667_AMER_CH_SupportSearch_IntegratedMasthead_Handleproductquery_ContanctUS_ESUPPORT--------->\n  "+e);
		}
	}
}

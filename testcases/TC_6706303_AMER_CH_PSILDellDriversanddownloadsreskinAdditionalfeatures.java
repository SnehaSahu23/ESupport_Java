...
public class TC_6706303_AMER_CH_PSILDellDriversanddownloadsreskinAdditionalfeatures extends BaseTest
{
	@Test
	public void validate_TC_6706303_AMER_CH_PSILDellDriversanddownloadsreskinAdditionalfeatures() 
	{
		try
		{
			System.out.println("Starts TC_6706303_AMER_CH_PSILDellDriversanddownloadsreskinAdditionalfeatures");
		...
		{
			Assert.fail("Failed in TC_6706303_AMER_CH_PSILDellDriversanddownloadsreskinAdditionalfeatures--------->\n  "+e);
		}
	}
}

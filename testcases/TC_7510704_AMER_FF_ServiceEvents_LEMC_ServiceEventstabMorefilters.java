...
public class TC_7510704_AMER_FF_ServiceEvents_LEMC_ServiceEventstabMorefilters extends BaseTest
{
	@Test
	public void validate_TC_7510704_AMER_FF_ServiceEvents_LEMC_ServiceEventstabMorefilters() 
	{
		try
		{
			System.out.println("Starts TC_7510704_AMER_FF_ServiceEvents_LEMC_ServiceEventstabMorefilters");
		...
		{
			Assert.fail("Failed in TC_7510704_AMER_FF_ServiceEvents_LEMC_ServiceEventstabMorefilters--------->\n  "+e);
		}
	}
}

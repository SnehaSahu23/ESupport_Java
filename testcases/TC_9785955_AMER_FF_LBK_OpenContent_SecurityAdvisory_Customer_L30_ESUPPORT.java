...
public class TC_9785955_AMER_FF_LBK_OpenContent_SecurityAdvisory_Customer_L30_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785955_AMER_FF_LBK_OpenContent_SecurityAdvisory_Customer_L30_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785955_AMER_FF_LBK_OpenContent_SecurityAdvisory_Customer_L30_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785955_AMER_FF_LBK_OpenContent_SecurityAdvisory_Customer_L30_ESUPPORT()--------->\n  "+e);
		}
	}
}

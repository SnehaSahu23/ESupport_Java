...
public class TC_5780284_AMER_ED_Contactusjumppage_DellEMCProducts__LEMCCustomer_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_5780284_AMER_ED_Contactusjumppage_DellEMCProducts__LEMCCustomer_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 5780284_AMER_ED_Contactusjumppage_DellEMCProducts__LEMCCustomer_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.ClickSignIn(driver);
			...
			Assert.fail("Failed while executing test case TC_5780284_AMER_ED_Contactusjumppage_DellEMCProducts__LEMCCustomer_ESUPPORT--------->\n  "+e);

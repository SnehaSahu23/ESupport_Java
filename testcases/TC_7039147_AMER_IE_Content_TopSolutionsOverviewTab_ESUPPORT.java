...
public class TC_7039147_AMER_IE_Content_TopSolutionsOverviewTab_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7039147_AMER_IE_Content_TopSolutionsOverviewTab_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7039147_AMER_IE_Content_TopSolutionsOverviewTab_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7039147_AMER_IE_Content_TopSolutionsOverviewTab_ESUPPORT--------->\n  "+e);
		}
	}
}

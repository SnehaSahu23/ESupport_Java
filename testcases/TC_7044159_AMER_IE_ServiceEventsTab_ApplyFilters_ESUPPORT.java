...
public class TC_7044159_AMER_IE_ServiceEventsTab_ApplyFilters_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7044159_AMER_IE_ServiceEventsTab_ApplyFilters_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7044159_AMER_IE_ServiceEventsTab_ApplyFilters_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7044159_AMER_IE_ServiceEventsTab_ApplyFilters_ESUPPORT--------->\n  "+e);
		}
	}
}

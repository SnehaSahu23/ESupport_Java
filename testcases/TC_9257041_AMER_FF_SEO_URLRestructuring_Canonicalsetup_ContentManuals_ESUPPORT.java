...
public class TC_9257041_AMER_FF_SEO_URLRestructuring_Canonicalsetup_ContentManuals_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9257041_AMER_FF_SEO_URLRestructuring_Canonicalsetup_ContentManuals_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9257041_AMER_FF_SEO_URLRestructuring_Canonicalsetup_ContentManuals_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9257041_AMER_FF_SEO_URLRestructuring_Canonicalsetup_ContentManuals_ESUPPORT--------->\n  "+e);

...
public class TC_5775867_AMER_ED_Masthead_Support_links_LEMC_hotuser_or_employee_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5775867_AMER_ED_Masthead_Support_links_LEMC_hotuser_or_employee_ESUPPORT() 
	{

		try
		{
			Thread.sleep(10000);
			System.out.println("Starts TC_5775867_AMER_ED_Masthead_Support_links_LEMC_hotuser_or_employee_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.handleCookies(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5775867_AMER_ED_Masthead_Support_links_LEMC_hotuser_or_employee_ESUPPORT--------->\n  "+e);

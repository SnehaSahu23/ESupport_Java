...
public class TC_5795418_AMER_CH_SR_Details_page_Actions_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5795418_AMER_CH_SR_Details_page_Actions_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5795418_AMER_CH_SR_Details_page_Actions_ESUPPORT--------->\n  "+e);

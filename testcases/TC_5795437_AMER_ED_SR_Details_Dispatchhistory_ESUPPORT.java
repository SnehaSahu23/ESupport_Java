...
public class TC_5795437_AMER_ED_SR_Details_Dispatchhistory_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5795437_AMER_ED_SR_Details_Dispatchhistory_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5795437_AMER_ED_SR_Details_Dispatchhistory_ESUPPORT--------->\n  "+e);

...
public class TC_D920601_AMER_DriversNotifications_CreateEmailSubscription_SelectDevices_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920601_AMER_DriversNotifications_CreateEmailSubscription_SelectDevices_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_D920601_AMER_DriversNotifications_CreateEmailSubscription_SelectDevices");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while executing TC_D920601_AMER_DriversNotifications_CreateEmailSubscription_SelectDevices--------->\n  "+e);

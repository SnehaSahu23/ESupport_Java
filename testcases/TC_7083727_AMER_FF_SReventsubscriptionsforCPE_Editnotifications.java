...
public class TC_7083727_AMER_FF_SReventsubscriptionsforCPE_Editnotifications extends BaseTest
{
	@Test
	public void validate_TC_7083727_AMER_FF_SReventsubscriptionsforCPE_Editnotifications() 
	{
		try
		{
			System.out.println("Starts TC_7083727_AMER_FF_SReventsubscriptionsforCPE_Editnotifications");
			Thread.sleep(10000);	
		...
		{
			Assert.fail("Failed in TC_7083727_AMER_FF_SReventsubscriptionsforCPE_Editnotifications--------->\n  "+e);
		}
	}
}
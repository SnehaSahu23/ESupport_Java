...
public class TC_6490569_AMER_IE_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_6490569_AMER_IE_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6490569_AMER_IE");  
			...
			Assert.fail("Failed while executing test case TC_6490569_AMER_IE_Message_postSoftwareRepair_purchaseconfigurable_ESUPPORT--------->\n  "+e);

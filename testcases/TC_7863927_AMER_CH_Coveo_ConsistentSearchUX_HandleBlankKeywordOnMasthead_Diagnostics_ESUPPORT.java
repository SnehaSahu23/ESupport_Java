...
public class TC_7863927_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_Diagnostics_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863927_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_Diagnostics_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863927_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_Diagnostics_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863927_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_Diagnostics_ESUPPORT--------->\n  "+e);
		}
	}
}

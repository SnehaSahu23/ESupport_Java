...
public class TC_7863892_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadDrivers_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863892_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadDrivers_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863892_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadDrivers_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863892_AMER_CH_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadDrivers_ESUPPORT--------->\n  "+e);
		}
	}
}

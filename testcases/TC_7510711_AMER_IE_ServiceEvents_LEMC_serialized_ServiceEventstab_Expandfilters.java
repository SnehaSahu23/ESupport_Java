...
public class TC_7510711_AMER_IE_ServiceEvents_LEMC_serialized_ServiceEventstab_Expandfilters extends BaseTest
{
	@Test
	public void validate_TC_7510711_AMER_IE_ServiceEvents_LEMC_serialized_ServiceEventstab_Expandfilters() 
	{
		try
		{
			System.out.println("Starts TC_7510711_AMER_IE_ServiceEvents_LEMC_serialized_ServiceEventstab_Expandfilters");
		...
		{
			Assert.fail("Failed in TC_7510711_AMER_IE_ServiceEvents_LEMC_serialized_ServiceEventstab_Expandfilters--------->\n  "+e);
		}
	}
}

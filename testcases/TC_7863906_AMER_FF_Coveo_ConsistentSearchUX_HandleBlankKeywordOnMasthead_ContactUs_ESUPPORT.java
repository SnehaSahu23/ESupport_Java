...
public class TC_7863906_AMER_FF_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_ContactUs_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863906_AMER_FF_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_ContactUs_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863906_AMER_FF_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_ContactUs_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863906_AMER_FF_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMasthead_ContactUs_ESUPPORT--------->\n  "+e);
		}
	}
}

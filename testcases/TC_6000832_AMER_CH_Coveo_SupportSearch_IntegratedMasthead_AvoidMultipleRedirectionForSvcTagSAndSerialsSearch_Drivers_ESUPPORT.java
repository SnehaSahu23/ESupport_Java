...
public class TC_6000832_AMER_CH_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Drivers_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000832_AMER_CH_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Drivers_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000832_AMER_CH_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Drivers_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000832_AMER_CH_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_Drivers_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_7863884_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadIPS_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863884_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadIPS_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863884_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadIPS_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863884_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadIPS_ESUPPORT--------->\n  "+e);
		}
	}
}

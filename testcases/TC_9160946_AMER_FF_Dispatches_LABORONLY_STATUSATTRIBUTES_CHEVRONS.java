...
public class TC_9160946_AMER_FF_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS extends BaseTest 
{
	@Test
	public void validate_TC_9160946_AMER_FF_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS() 
	{

		try
		{
			System.out.println("Starts TC_9160946_AMER_FF_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9160946_AMER_FF_Dispatches_LABORONLY_STATUSATTRIBUTES_CHEVRONS--------->\n  "+e);

...
public class TC_8438934_AMER_IE_Content_ArticlesDetailPage_AbilitytoshowvariousfieldsbasedonLevel50content_RESTRICTEDAGENT extends BaseTest
{
	@Test
	public void validate_TC_8438934_AMER_IE_Content_ArticlesDetailPage_AbilitytoshowvariousfieldsbasedonLevel50content_RESTRICTEDAGENT() 
	{
		try
		{
			System.out.println("Starts TC_8438934_AMER_IE_Content_ArticlesDetailPage_AbilitytoshowvariousfieldsbasedonLevel50content_RESTRICTEDAGENT");
		...
		{
			Assert.fail("Failed in TC_8438934_AMER_IE_Content_ArticlesDetailPage_AbilitytoshowvariousfieldsbasedonLevel50content_RESTRICTEDAGENT--------->\n  "+e);
		}
	}
}
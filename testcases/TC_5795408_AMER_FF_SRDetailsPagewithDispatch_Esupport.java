...
public class TC_5795408_AMER_FF_SRDetailsPagewithDispatch_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5795408_AMER_FF_SRDetailsPagewithDispatch_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5795408_AMER_FF_SRDetailsPagewithDispatch_Esupport");
		...
		{
			Assert.fail("Failed while TC_5795408_AMER_FF_SRDetailsPagewithDispatch_Esupport--------->\n  "+e);
		}

...
public class TC_7984232_AMER_FF_Content_LEMC_FamilyView_SupportTopics_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984232_AMER_FF_Content_LEMC_FamilyView_SupportTopics_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984232_AMER_FF_Content_LEMC_FamilyView_SupportTopics_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7984232_AMER_FF_Content_LEMC_FamilyView_SupportTopics_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_6063713_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryProductSupport_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6063713_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryProductSupport_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_6063713_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryProductSupport_Esupport"); 
		...
		{
			Assert.fail("Failed while executing test case TC_6063713_AMER_FF_SupportSearchIntegratedMastheadHandleproductnameinthequeryProductSupport_Esupport--------->\n  "+e);
		}
	}
}

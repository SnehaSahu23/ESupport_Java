...
public class TC_8184899_AMER_IE_EREV_Offer_PurchaseUI_inUS extends BaseTest
{
	@Test
	public void validate_TC_8184899_AMER_IE_EREV_Offer_PurchaseUI_inUS() 
	{
		try
		{
			System.out.println("Starts TC_8184899_AMER_IE_EREV_Offer_PurchaseUI_inUS");
		...
		{
			Assert.fail("Failed in TC_8184899_AMER_IE_EREV_Offer_PurchaseUI_inUS--------->\n  "+e);
		}
	}
}

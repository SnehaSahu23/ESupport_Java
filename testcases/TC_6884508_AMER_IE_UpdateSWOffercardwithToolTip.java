...
public class TC_6884508_AMER_IE_UpdateSWOffercardwithToolTip extends BaseTest
{
	@Test
	public void validate_TC_6884508_AMER_IE_UpdateSWOffercardwithToolTip() 
	{
		try
		{
			System.out.println("Starts TC_6884508_AMER_IE_UpdateSWOffercardwithToolTip");
		...
		{
			Assert.fail("Failed in TC_6884508_AMER_IE_UpdateSWOffercardwithToolTip--------->\n  "+e);
		}
	}
}

...
public class TC_5775076_AMER_CH_ProductModel_LEMC_AutoSuggestion_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5775076_AMER_CH_ProductModel_LEMC_AutoSuggestion_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5775076_AMER_CH_ProductModel_LEMC_AutoSuggestion_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5775076_AMER_CH_ProductModel_LEMC_AutoSuggestion_Esupport--------->\n  "+e);

...
public class TC_6706300_AMER_IE_PSILDelldriversanddownloadsreskinMultipledownloads_Esupport  extends BaseTest
{
	@Test
	public void validate_TC_6706300_AMER_IE_PSILDelldriversanddownloadsreskinMultipledownloads_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6706300_AMER_IE_PSILDelldriversanddownloadsreskinMultipledownloads_Esupport");
...
//			obj_EsupportDriverandDownloadsWorkflow.pcfClickViewDetailsLink(driver);				
		...
		{
			Assert.fail("Failed in TC_6706300_AMER_IE_PSILDelldriversanddownloadsreskinMultipledownloads_Esupport--------->\n  "+e);
		}
	}
}

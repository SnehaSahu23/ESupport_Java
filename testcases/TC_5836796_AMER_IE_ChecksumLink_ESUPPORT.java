...
public class TC_5836796_AMER_IE_ChecksumLink_ESUPPORT extends BaseTest {
        @Test
        public void validate_TC_5836796_AMER_IE_ChecksumLink_ESUPPORT() 
        {
...
//                        obj_EsupportCoveoWorkflow.ClickSignIn(driver);
                        ...
                        Assert.fail("Failed while executing test case TC_5836796_AMER_IE_ChecksumLink_ESUPPORT--------->\n  "+e);

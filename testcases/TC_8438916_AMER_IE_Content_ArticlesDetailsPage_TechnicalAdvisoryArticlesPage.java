...
public class TC_8438916_AMER_IE_Content_ArticlesDetailsPage_TechnicalAdvisoryArticlesPage extends BaseTest 
{
	@Test
	public void validate_TC_8438916_AMER_IE_Content_ArticlesDetailsPage_TechnicalAdvisoryArticlesPage() 
	{
		try
		{
			System.out.println("Starts TC_8438916_AMER_IE_Content_ArticlesDetailsPage_TechnicalAdvisoryArticlesPage");
			...
			obj_EsupportContentWorkflow.verifyArticleContentDetailsTechnicalAdvisory(driver);
			...
			obj_EsupportContentWorkflow.clickAndVerifyArticleTechnicalAdvisoryInformation(driver);
		...
		{
			Assert.fail("Failed in TC_8438916_AMER_IE_Content_ArticlesDetailsPage_TechnicalAdvisoryArticlesPage--------->\n  "+e);
		}
	}
}

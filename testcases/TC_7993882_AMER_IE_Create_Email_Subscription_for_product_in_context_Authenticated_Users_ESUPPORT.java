...
public class TC_7993882_AMER_IE_Create_Email_Subscription_for_product_in_context_Authenticated_Users_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_7993882_AMER_IE_Create_Email_Subscription_for_product_in_context_Authenticated_Users_ESUPPORT() 
	{
		...
		try
		{
			...
			Assert.fail("Failed while executing test case TC_7993882_AMER_IE_Create_Email_Subscription_for_product_in_context_Authenticated_Users_ESUPPORT--------->\n  "+e);

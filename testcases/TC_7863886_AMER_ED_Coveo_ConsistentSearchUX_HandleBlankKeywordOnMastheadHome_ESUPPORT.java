...
public class TC_7863886_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadHome_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7863886_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadHome_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7863886_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadHome_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7863886_AMER_ED_Coveo_ConsistentSearchUX_HandleBlankKeywordOnMastheadHome_ESUPPORT--------->\n  "+e);
		}
	}
}

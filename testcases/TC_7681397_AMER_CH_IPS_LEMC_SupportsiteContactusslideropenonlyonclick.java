...
public class TC_7681397_AMER_CH_IPS_LEMC_SupportsiteContactusslideropenonlyonclick extends BaseTest
{
	@Test
	public void validate_TC_7681397_AMER_CH_IPS_LEMC_SupportsiteContactusslideropenonlyonclick() 
	{
		try
		{
			System.out.println("Starts TC_7681397_AMER_CH_IPS_LEMC_SupportsiteContactusslideropenonlyonclick");
...
//			Thread.sleep(10000);
		...
		{
			Assert.fail("Failed in TC_7681397_AMER_CH_IPS_LEMC_SupportsiteContactusslideropenonlyonclick--------->\n  "+e);
		}
	}
}

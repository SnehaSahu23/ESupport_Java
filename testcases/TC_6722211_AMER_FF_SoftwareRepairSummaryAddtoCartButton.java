...
public class TC_6722211_AMER_FF_SoftwareRepairSummaryAddtoCartButton extends BaseTest
{
	@Test
	public void validate_TC_6722211_AMER_FF_SoftwareRepairSummaryAddtoCartButton() 
	{
		try
		{
			System.out.println("Starts TC_6722211_AMER_FF_SoftwareRepairSummaryAddtoCartButton");
		...
		{
			Assert.fail("Failed in TC_6722211_AMER_FF_SoftwareRepairSummaryAddtoCartButton--------->\n  "+e);
		}
	}
}

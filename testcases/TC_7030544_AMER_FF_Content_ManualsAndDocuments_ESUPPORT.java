...
public class TC_7030544_AMER_FF_Content_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7030544_AMER_FF_Content_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
		...
		{
			Assert.fail("Failed in TC_7030544_AMER_FF_Content_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

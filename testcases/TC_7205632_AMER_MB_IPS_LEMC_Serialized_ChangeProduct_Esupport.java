...
public class TC_7205632_AMER_MB_IPS_LEMC_Serialized_ChangeProduct_Esupport extends MobilePage
{
	@Test
	public void validate_TC_7205632_AMER_MB_IPS_LEMC_Serialized_ChangeProduct_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7205632_AMER_MB_IPS_LEMC_Serialized_ChangeProduct_Esupport");
			Thread.sleep(6000);
		...
		{
			Assert.fail("Failed in TC_7205632_AMER_MB_IPS_LEMC_Serialized_ChangeProduct_Esupport--------->\n  "+e);
		}
	}
}

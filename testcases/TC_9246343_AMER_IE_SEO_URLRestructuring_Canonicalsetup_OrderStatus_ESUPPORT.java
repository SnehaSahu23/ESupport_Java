...
public class TC_9246343_AMER_IE_SEO_URLRestructuring_Canonicalsetup_OrderStatus_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9246343_AMER_IE_SEO_URLRestructuring_Canonicalsetup_OrderStatus_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9246343_AMER_IE_SEO_URLRestructuring_Canonicalsetup_OrderStatus_ESUPPORT");
...
//			obj_EsupportSEOWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9246343_AMER_IE_SEO_URLRestructuring_Canonicalsetup_OrderStatus_ESUPPORT--------->\n  "+e);

...
public class TC_6877493_AMER_FF_Coveo_SupportSearchShowFeaturedResultBasedOnResourceType_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6877493_AMER_FF_Coveo_SupportSearchShowFeaturedResultBasedOnResourceType_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6877493_AMER_FF_Coveo_SupportSearchShowFeaturedResultBasedOnResourceType_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.SelectDellSupportVideos(driver, TestNGCreator.TestData.get(Esupport.Dpid.ordinal()));
		...
		{
			Assert.fail("Failed in TC_6877493_AMER_FF_Coveo_SupportSearchShowFeaturedResultBasedOnResourceType_ESUPPORT--------->\n  "+e);
		}
	}
}

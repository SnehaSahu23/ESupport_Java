...
public class TC_7350845_AMER_CH_Portal_SRVisualization_TotalSRsDefaultedToOpenSRs extends BaseTest
{
	@Test
	public void validate_TC_7350845_AMER_CH_Portal_SRVisualization_TotalSRsDefaultedToOpenSRs() 
	{
		try
		{
			System.out.println("Starts TC_7350845_AMER_CH_Portal_SRVisualization_TotalSRsDefaultedToOpenSRs");
		...
		{
			Assert.fail("Failed in TC_7350845_AMER_CH_Portal_SRVisualization_TotalSRsDefaultedToOpenSRs--------->\n  "+e);
		}
	}
}

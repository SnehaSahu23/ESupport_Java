...
public class TC_6604705_AMER_FF_LDellMnAtagged_DeleteNickname_Esupport extends BaseTest{
	@Test
	public void validate_TC_6604705_AMER_FF_LDellMnAtagged_DeleteNickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6604705_AMER_FF_LDellMnAtagged_DeleteNickname_Esupport");
		...
		{
			Assert.fail("Failed in TC_6604705_AMER_FF_LDellMnAtagged_DeleteNickname_Esupport--------->\n  "+e);
		}
	}
}

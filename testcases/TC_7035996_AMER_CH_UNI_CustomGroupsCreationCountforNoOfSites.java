...
public class TC_7035996_AMER_CH_UNI_CustomGroupsCreationCountforNoOfSites extends BaseTest
{
	@Test
	public void validate_TC_7035996_AMER_CH_UNI_CustomGroupsCreationCountforNoOfSites() 
	{
		try
		{
			System.out.println("Starts TC_7035996_AMER_CH_UNI_CustomGroupsCreationCountforNoOfSites");
			Thread.sleep(10000);	
		...
		//	driver.navigate().refresh();
			...
			Thread.sleep(10000);	
			obj_EsupportUnifiedPortalWorkflow.verifyAccountSitesCount(driver);
		}
		catch(Exception e)
		{
			Assert.fail("Failed in TC_7035996_AMER_CH_UNI_CustomGroupsCreationCountforNoOfSites--------->\n  "+e);
		}
	}
}

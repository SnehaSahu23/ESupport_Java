...
public class TC_5786155_AMER_IE_FAQScenariosFAQVerifyFAQpage_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5786155_AMER_IE_FAQScenariosFAQVerifyFAQpage_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5786155_AMER_IE_FAQScenariosFAQVerifyFAQpage_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5786155_AMER_IE_FAQScenariosFAQVerifyFAQpage_Esupport--------->\n  "+e);
		}
	}
}

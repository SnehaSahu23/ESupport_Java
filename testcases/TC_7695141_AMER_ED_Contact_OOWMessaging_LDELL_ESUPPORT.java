...
public class TC_7695141_AMER_ED_Contact_OOWMessaging_LDELL_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7695141_AMER_ED_Contact_OOWMessaging_LDELL_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7695141_AMER_ED_Contact_OOWMessaging_LDELL_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7695141_AMER_ED_Contact_OOWMessaging_LDELL_ESUPPORT--------->\n  "+e);

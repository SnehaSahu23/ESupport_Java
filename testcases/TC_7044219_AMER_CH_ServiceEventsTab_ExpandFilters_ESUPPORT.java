...
public class TC_7044219_AMER_CH_ServiceEventsTab_ExpandFilters_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7044219_AMER_CH_ServiceEventsTab_ExpandFilters_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7044219_AMER_CH_ServiceEventsTab_ExpandFilters_ESUPPORT");
			...
			obj_EsupportServiceEventsWorkflow.ClickExpandIconNextToEventTypeServiceRequestOnLeftPanel(driver);
		...
		{
			Assert.fail("Failed in TC_7044219_AMER_CH_ServiceEventsTab_ExpandFilters_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_7124245_AMER_CH_Contact_SPECONTACTCHANNELSTechDirect_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7124245_AMER_CH_Contact_SPECONTACTCHANNELSTechDirect_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7124245_AMER_CH_Contact_SPECONTACTCHANNELSTechDirect_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidationTellusTheNatureOfTheRequestAndDropdownEnabledAfterProductIdentification(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7124245_AMER_CH_Contact_SPECONTACTCHANNELSTechDirect_ESUPPORT--------->\n  "+e);

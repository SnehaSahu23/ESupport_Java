...
public class TC_9244250_AMER_CH_SEO_URLRestructuring_Canonicalsetup_DriversAndDownloads_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9244250_AMER_CH_SEO_URLRestructuring_Canonicalsetup_DriversAndDownloads_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9244250_AMER_CH_SEO_URLRestructuring_Canonicalsetup_DriversAndDownloads_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9244250_AMER_CH_SEO_URLRestructuring_Canonicalsetup_DriversAndDownloads_ESUPPORT--------->\n  "+e);

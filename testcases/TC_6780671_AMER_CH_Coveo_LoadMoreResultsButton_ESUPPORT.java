...
public class TC_6780671_AMER_CH_Coveo_LoadMoreResultsButton_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6780671_AMER_CH_Coveo_LoadMoreResultsButton_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6780671_AMER_CH_Coveo_LoadMoreResultsButton_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.ClickShowMoreButton(driver);
		...
		{
			Assert.fail("Failed in TC_6780671_AMER_CH_Coveo_LoadMoreResultsButton_ESUPPORT--------->\n  "+e);
		}
	}
}

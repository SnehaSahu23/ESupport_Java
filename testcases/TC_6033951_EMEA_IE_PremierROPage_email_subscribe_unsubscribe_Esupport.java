...
public class TC_6033951_EMEA_IE_PremierROPage_email_subscribe_unsubscribe_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6033951_EMEA_IE_PremierROPage_email_subscribe_unsubscribe_Esupport() 
	{
		try
		{
			System.out.println("Starts TC# _6033951_EMEA_IE");		
...
//			obj_EsupportRecentOrderWorkflow.clickOrderStatusLink(driver);
		...
		{
			Assert.fail("Failed while executing test case TC_6033951_EMEA_IE_PremierROPage_email_subscribe_unsubscribe_Esupport --------->\n  "+e);
		}
	}
}

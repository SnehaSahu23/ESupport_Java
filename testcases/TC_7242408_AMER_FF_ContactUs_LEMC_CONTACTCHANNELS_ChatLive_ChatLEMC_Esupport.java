...
public class TC_7242408_AMER_FF_ContactUs_LEMC_CONTACTCHANNELS_ChatLive_ChatLEMC_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_7242408_AMER_FF_ContactUs_LEMC_CONTACTCHANNELS_ChatLive_ChatLEMC_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_7242408_AMER_FF_ContactUs_LEMC_CONTACTCHANNELS_ChatLive_ChatLEMC_Esupport");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7242408_AMER_FF_ContactUs_LEMC_CONTACTCHANNELS_ChatLive_ChatLEMC_Esupport--------->\n  "+e);

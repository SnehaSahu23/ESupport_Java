...
public class TC_6963752_AMER_IE_ContactUs_SPE_BROWSEALLPRODUCTSBUTTON_LDELL extends BaseTest 
{
	@Test
	public void validate_TC_6963752_AMER_IE_ContactUs_SPE_BROWSEALLPRODUCTSBUTTON_LDELL() 
	{
		try
		{
			System.out.println("Starts TC_6963752_AMER_IE_ContactUs_SPE_BROWSEALLPRODUCTSBUTTON_LDELL");
...
//			obj_EsupportIncidentsWorkflow.SelectIssueFromDropDown(driver, TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(",")[2]);
		...
		{
			Assert.fail("Failed while executing TC_6963752_AMER_IE_ContactUs_SPE_BROWSEALLPRODUCTSBUTTON_LDELL--------->\n  "+e);
		}

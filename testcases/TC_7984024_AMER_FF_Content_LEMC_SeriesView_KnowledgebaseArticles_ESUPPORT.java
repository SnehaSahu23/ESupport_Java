...
public class TC_7984024_AMER_FF_Content_LEMC_SeriesView_KnowledgebaseArticles_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984024_AMER_FF_Content_LEMC_SeriesView_KnowledgebaseArticles_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984024_AMER_FF_Content_LEMC_SeriesView_KnowledgebaseArticles_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		{
			Assert.fail("Failed in TC_7984024_AMER_FF_Content_LEMC_SeriesView_KnowledgebaseArticles_ESUPPORT()--------->\n  "+e);
		}
	}
}
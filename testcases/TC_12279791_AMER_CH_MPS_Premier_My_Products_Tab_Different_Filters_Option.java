...
public class TC_12279791_AMER_CH_MPS_Premier_My_Products_Tab_Different_Filters_Option extends BaseTest 
{
	@Test
	public void validate_TC_12279791_AMER_CH_MPS_Premier_My_Products_Tab_Different_Filters_Option()
	{
		try
		{
		...
		{
			Assert.fail("Failed in TC_12279791_AMER_CH_MPS_Premier_My_Products_Tab_Different_Filters_Option--------->\n  "+e);
		}
	}
}

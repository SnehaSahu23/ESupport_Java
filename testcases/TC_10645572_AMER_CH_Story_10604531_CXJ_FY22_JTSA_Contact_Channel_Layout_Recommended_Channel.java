...
public class TC_10645572_AMER_CH_Story_10604531_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel extends BaseTest
{
  
	@Test
	public void validate_TC_10645572_AMER_CH_Story_10604531_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel()
	{
		try
		{
			System.out.println("Starts validate_TC_10645572_AMER_CH_Story_10604531_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel");
...
//			obj_EsupportIncidentsWorkflow.clickOnNextButtonOnProductPage(driver);
		...
		{
			Assert.fail("Failed while TC_10645572_AMER_CH_Story_10604531_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel--------->\n  "+e);
		}
	}

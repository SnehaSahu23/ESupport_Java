...
public class TC_6000799_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_OrderStatus_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_6000799_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_OrderStatus_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_6000799_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_OrderStatus_ESUPPORT");
...
//			obj_EsupportCoveoWorkflow.Logout(driver);
		...
		{
			Assert.fail("Failed in TC_6000799_AMER_FF_Coveo_SupportSearch_IntegratedMasthead_AvoidMultipleRedirectionForSvcTagSAndSerialsSearch_OrderStatus_ESUPPORT--------->\n  "+e);
		}
	}
}

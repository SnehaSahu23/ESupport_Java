...
public class TC_6033966_AP_IE_Premier_Recent_OrdersPage_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_6033966_AP_IE_Premier_Recent_OrdersPage_ESUPPORT() 
	{
...
//			obj_EsupportRecentOrderWorkflow.clickOrderStatusLink(driver);
			...
			Assert.fail("Failed while executing test case TC_6033966_AP_Premier_Recent_OrdersPage_ESUPPORT--------->\n  "+e);

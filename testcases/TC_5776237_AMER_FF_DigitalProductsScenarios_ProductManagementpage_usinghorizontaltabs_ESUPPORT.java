...
public class TC_5776237_AMER_FF_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5776237_AMER_FF_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5776237_AMER_FF_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5776237_AMER_FF_DigitalProductsScenarios_ProductManagementpage_usinghorizontaltabs_ESUPPORT--------->\n  "+e);

...
public class TC_8225108_AMER_IE_Erevenue_CallbackScheduler_SoftwareOfferUS extends BaseTest
{
	@Test
	public void validate_TC_8225108_AMER_IE_Erevenue_CallbackScheduler_SoftwareOfferUS() 
	{
		try
		{
			System.out.println("Starts TC_8225108_AMER_IE_Erevenue_CallbackScheduler_SoftwareOfferUS");
		...
		{
			Assert.fail("Failed in TC_8225108_AMER_IE_Erevenue_CallbackScheduler_SoftwareOfferUS--------->\n  "+e);
		}
	}
}

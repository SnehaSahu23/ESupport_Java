...
public class TC_8963624_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Milestones extends BaseTest
{
	@Test
	public void validate_TC_8963624_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Milestones() 
	{
		try
		{
			System.out.println("Starts TC_8963624_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Milestones");
		...
		{
			Assert.fail("Failed in TC_8963624_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Milestones--------->\n  "+e);
		}
	}
}

...
public class TC_6107700_AMER_ED_POSearch_capability_Specialchar_casesensitive_Esupport extends BaseTest {
	@Test
	public void validate_TC_6107700_AMER_ED_POSearch_capability_Specialchar_casesensitive_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# 6107700_AMER_ED");
...
//			obj_EsupportRecentOrderWorkflow.clickOrderStatusLink(driver);
			...
			Assert.fail("Failed while executing test case TC_6107700_AMER_ED_POSearch_capability_Specialchar_casesensitive_Esupport--------->\n  "+e);

...
public class TC_5772549_AMER_IE_RetailRegistrationPage_Esupport extends BaseTest {
	@Test
	public void validate_TC_5772549_AMER_IE_RetailRegistrationPage_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _5772549_AMER_IE");
			...
			Assert.fail("Failed while executing test case TC_5772549_AMER_IE_RetailRegistrationPage_Esupport--------->\n  "+e);

...
public class TC_5775823_AMER_ED_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport  extends BaseTest
{
	@Test
	public void validate_TC_5775823_AMER_ED_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _5775823_AMER_ED");
		...
		{
			Assert.fail("Failed while executing test case TC_5775823_AMER_ED_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_7704562_AMER_ED_ContactUS_LEMC_SRCreate_HESOSUpgrade_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704562_AMER_ED_ContactUS_LEMC_SRCreate_HESOSUpgrade_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704562_AMER_ED_ContactUS_LEMC_SRCreate_HESOSUpgrade_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidateDatePicker_Form2(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704562_AMER_ED_ContactUS_LEMC_SRCreate_HESOSUpgrade_ESUPPORT--------->\n  "+e);

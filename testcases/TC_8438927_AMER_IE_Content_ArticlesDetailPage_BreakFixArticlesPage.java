...
public class TC_8438927_AMER_IE_Content_ArticlesDetailPage_BreakFixArticlesPage extends BaseTest 
{
	@Test
	public void validate_TC_8438927_AMER_IE_Content_ArticlesDetailPage_BreakFixArticlesPage() 
	{
		try
		{
			System.out.println("Starts TC_8438927_AMER_IE_Content_ArticlesDetailPage_BreakFixArticlesPage()");
		...
		{
			Assert.fail("Failed in TC_8438927_AMER_IE_Content_ArticlesDetailPage_BreakFixArticlesPage()--------->\n  "+e);
		}
	}
}

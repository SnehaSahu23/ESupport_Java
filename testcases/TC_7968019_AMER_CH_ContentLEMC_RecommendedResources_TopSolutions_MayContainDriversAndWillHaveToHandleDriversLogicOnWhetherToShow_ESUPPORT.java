...
public class TC_7968019_AMER_CH_ContentLEMC_RecommendedResources_TopSolutions_MayContainDriversAndWillHaveToHandleDriversLogicOnWhetherToShow_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7968019_AMER_CH_ContentLEMC_RecommendedResources_TopSolutions_MayContainDriversAndWillHaveToHandleDriversLogicOnWhetherToShow_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7968019_AMER_CH_ContentLEMC_RecommendedResources_TopSolutions_MayContainDriversAndWillHaveToHandleDriversLogicOnWhetherToShow_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickSearchProductForLEMC(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()));
		...
		{
			Assert.fail("Failed in TC_7968019_AMER_CH_ContentLEMC_RecommendedResources_TopSolutions_MayContainDriversAndWillHaveToHandleDriversLogicOnWhetherToShow_ESUPPORT()--------->\n  "+e);
		}
	}
}

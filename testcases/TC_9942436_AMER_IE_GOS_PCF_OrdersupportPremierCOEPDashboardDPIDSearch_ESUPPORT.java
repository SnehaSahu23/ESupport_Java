...
public class TC_9942436_AMER_IE_GOS_PCF_OrdersupportPremierCOEPDashboardDPIDSearch_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_9942436_AMER_IE_GOS_PCF_OrdersupportPremierCOEPDashboardDPIDSearch_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_9942436_AMER_IE_GOS_PCF_OrdersupportPremierCOEPDashboardDPIDSearch_ESUPPORT");        
			...
			Assert.fail("Failed while executing test case TC_9942436_AMER_IE_GOS_PCF_OrdersupportPremierCOEPDashboardDPIDSearch_ESUPPORT--------->\n  "+e);

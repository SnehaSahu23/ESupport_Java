...
public class TC_5786141_AMER_CH_Test_for_Groupstab_Esupport extends BaseTest {


	@Test
	public void validate_TC_5786141_AMER_CH_Test_for_Groupstab_Esupport() 
	{
		try
		{
			
			System.out.println("Starts TC# 5786141_AMER_CH");  
		...
		{
			Assert.fail("Failed while executing test case TC_5786141_AMER_CH_Test_for_Groupstab_Esupport--------->\n  "+e);
		}
	}

...
public class TC_8194733_AMER_CH_EREV_EnableSoftwarerepairOfferinUS extends BaseTest
{
	@Test
	public void validate_TC_8194733_AMER_CH_EREV_EnableSoftwarerepairOfferinUS() 
	{
		try
		{
			System.out.println("Starts TC_8194733_AMER_CH_EREV_EnableSoftwarerepairOfferinUS");
...
//			obj_EsupportErevenueWorkflow.selectIssueAndSubIssueFromDropdownOverviewTab(driver, TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[1], TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()).split(";")[2]);
		...
		{
			Assert.fail("Failed in TC_8194733_AMER_CH_EREV_EnableSoftwarerepairOfferinUS--------->\n  "+e);
		}
	}
}

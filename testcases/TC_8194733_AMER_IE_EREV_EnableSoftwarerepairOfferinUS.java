...
public class TC_8194733_AMER_IE_EREV_EnableSoftwarerepairOfferinUS extends BaseTest
{
	@Test
	public void validate_TC_8194733_AMER_IE_EREV_EnableSoftwarerepairOfferinUS() 
	{
		try
		{
			System.out.println("Starts TC_8194733_AMER_IE_EREV_EnableSoftwarerepairOfferinUS");
		...
		{
			Assert.fail("Failed in TC_8194733_AMER_IE_EREV_EnableSoftwarerepairOfferinUS--------->\n  "+e);
		}
	}
}

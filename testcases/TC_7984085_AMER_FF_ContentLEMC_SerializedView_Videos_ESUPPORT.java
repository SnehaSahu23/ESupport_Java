...
public class TC_7984085_AMER_FF_ContentLEMC_SerializedView_Videos_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7984085_AMER_FF_ContentLEMC_SerializedView_Videos_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984085_AMER_FF_ContentLEMC_SerializedView_Videos_ESUPPORT");
...
//			obj_EsupportIPSWorkflow.clickSignInHereLink(driver);
		...
		{
			Assert.fail("Failed in TC_7984085_AMER_FF_ContentLEMC_SerializedView_Videos_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_7232010_AMER_ED_IPS_LEMC_Serialized_Channels_ContactUs_Slider_Authenticated_Esupport extends BaseTest
{
	@Test
	public void validate_TC_7232010_AMER_ED_IPS_LEMC_Serialized_Channels_ContactUs_Slider_Authenticated_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7232010_AMER_ED_IPS_LEMC_Serialized_Channels_ContactUs_Slider_Authenticated_Esupport");
...
//			obj_EsupportIPSWorkflow.ClickOnAccountTeamAndVerifyTeamMembers(driver);
		...
		{
			Assert.fail("Failed executing TC_7232010_AMER_ED_IPS_LEMC_Serialized_Channels_ContactUs_Slider_Authenticated_Esupport--------->\n  "+e);
		}
	}
}

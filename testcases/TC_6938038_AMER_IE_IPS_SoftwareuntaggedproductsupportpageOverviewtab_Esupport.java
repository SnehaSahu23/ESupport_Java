...
public class TC_6938038_AMER_IE_IPS_SoftwareuntaggedproductsupportpageOverviewtab_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6938038_AMER_IE_IPS_SoftwareuntaggedproductsupportpageOverviewtab_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_6938038_AMER_IE_IPS_SoftwareuntaggedproductsupportpageOverviewtab_Esupport");
...
//			obj_EsupportIPSWorkflow.clickLatitudeSubProduct(driver,TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()));
		...
		{
			Assert.fail("FailIE in TC_6938038_AMER_IE_IPS_SoftwareuntaggedproductsupportpageOverviewtab_Esupport--------->\n  "+e);
		}
	}
}

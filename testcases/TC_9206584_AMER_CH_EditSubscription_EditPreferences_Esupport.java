...
public class TC_9206584_AMER_CH_EditSubscription_EditPreferences_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_9206584_AMER_CH_EditSubscription_EditPreferences_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_9206584_CH_AMER_EditSubscription_EditPreferences");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9206584_AMER_CH_EditSubscription_EditPreferences_Esupport--------->\n  "+e);

...
public class TC_6082233_AMER_FF_MoveGetalltextbasedkeystotopofpage_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6082233_AMER_FF_MoveGetalltextbasedkeystotopofpage_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6082233_AMER_FF_MoveGetalltextbasedkeystotopofpage_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_6082233_AMER_FF_MoveGetalltextbasedkeystotopofpage_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_12281051_AMER_FF_MPS_Premier_Exporting_Table_Search_Box extends BaseTest
{
	   @Test
	   public void validate_TC_12281051_AMER_FF_MPS_Premier_Exporting_Table_Search_Box()
	   {
		  try
		  {
		  ...
		  {
				Assert.fail("Failed in TC_12281051_AMER_FF_MPS_Premier_Exporting_Table_Search_Box--------->\n  "+e);
		  }
	   }

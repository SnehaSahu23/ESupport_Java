...
public class TC_5910404_AMER_FF_TOP_SOLUTIONS_Implementation_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5910404_AMER_FF_TOP_SOLUTIONS_Implementation_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5910404_AMER_FF_TOP_SOLUTIONS_Implementation_ESUPPORT");
			//scenario1
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5910404_AMER_FF_TOP_SOLUTIONS_Implementation_ESUPPORT--------->\n  "+e);

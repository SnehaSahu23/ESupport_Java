...
public class TC_7984199_AMER_IE_Content_LEMC_FamilyView_TrainingLink_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984199_AMER_IE_Content_LEMC_FamilyView_TrainingLink_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984199_AMER_IE_Content_LEMC_FamilyView_TrainingLink_ESUPPORT()");
...
//			obj_EsupportCoveoWorkflow.ClickOnTrainingLink(driver);
		...
		{
			Assert.fail("Failed in TC_7984199_AMER_IE_Content_LEMC_FamilyView_TrainingLink_ESUPPORT()--------->\n  "+e);
		}
	}
}

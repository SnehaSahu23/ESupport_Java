...
public class TC_7510759_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_activeeventstoggle extends BaseTest
{
	@Test
	public void validate_TC_7510759_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_activeeventstoggle() 
	{
		try
		{
			System.out.println("Starts TC_7510759_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_activeeventstoggle");
		...
		{
			Assert.fail("Failed in TC_7510759_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_activeeventstoggle--------->\n  "+e);
		}
	}
}
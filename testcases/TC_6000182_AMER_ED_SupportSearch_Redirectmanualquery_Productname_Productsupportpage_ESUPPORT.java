...
public class TC_6000182_AMER_ED_SupportSearch_Redirectmanualquery_Productname_Productsupportpage_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_6000182_AMER_ED_SupportSearch_Redirectmanualquery_Productname_Productsupportpage_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6000182_AMER_ED"); 
...
//			obj_EsupportCoveoWorkflow.ToVerify_searchServiceTagsupportpage(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()).split(";")[3]);
		...
		{
			Assert.fail("Failed while executing test case TC_6000182_AMER_ED_SupportSearch_Redirectmanualquery_Productname_Productsupportpage_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_D920648_AMER_FF_DriversNotifications_PathbackDnD_authenticatedUser_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920648_AMER_FF_DriversNotifications_PathbackDnD_authenticatedUser_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_D920648_AMER_FF_DriversNotifications_PathbackDnD_authenticatedUser_ESUPPORT--------->\n  "+e);

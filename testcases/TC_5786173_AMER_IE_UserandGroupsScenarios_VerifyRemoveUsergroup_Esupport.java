...
public class TC_5786173_AMER_IE_UserandGroupsScenarios_VerifyRemoveUsergroup_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5786173_AMER_IE_UserandGroupsScenarios_VerifyRemoveUsergroup_Esupport() 
	{
		String UserGroupName;
		try
		{
			System.out.println("Starts TC#_5786173_AMER_IE");
		...
		{
			Assert.fail("Failed while executing test case TC_5786173_AMER_IE_UserandGroupsScenarios_VerifyRemoveUsergroup_Esupport--------->\n  "+e);
		}
	}
}
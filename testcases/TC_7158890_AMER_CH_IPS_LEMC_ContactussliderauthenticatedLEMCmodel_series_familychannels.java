...
public class TC_7158890_AMER_CH_IPS_LEMC_ContactussliderauthenticatedLEMCmodel_series_familychannels extends BaseTest
{
	@Test
	public void validate_TC_7158890_AMER_CH_IPS_LEMC_ContactussliderauthenticatedLEMCmodel_series_familychannels() 
	{
		try
		{
			System.out.println("Starts TC_7158890_AMER_CH_IPS_LEMC_ContactussliderauthenticatedLEMCmodel_series_familychannels");
		...
		{
			Assert.fail("Failed in TC_7158890_AMER_CH_IPS_LEMC_ContactussliderauthenticatedLEMCmodel_series_familychannels--------->\n  "+e);
		}
	}
}

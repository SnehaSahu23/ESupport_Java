...
public class TC_7663920_AMER_FF_IPS_LEMC_VerifyAdvisoriesTab_Esupport extends BaseTest
{
	@Test
	public void validate_TC_7663920_AMER_FF_IPS_LEMC_VerifyAdvisoriesTab_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_7663920_AMER_FF_IPS_LEMC_VerifyAdvisoriesTab_Esupport");
...
//			obj_EsupportIPSWorkflow.ClickOnFirstAdvisoryIDFromGrid(driver);
		...
		{
			Assert.fail("Failed executing TC_7663920_AMER_FF_IPS_LEMC_VerifyAdvisoriesTab_Esupport--------->\n  "+e);
		}
	}
}

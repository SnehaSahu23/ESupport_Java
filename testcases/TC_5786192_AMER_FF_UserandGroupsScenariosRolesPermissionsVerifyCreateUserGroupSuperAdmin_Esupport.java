...
public class TC_5786192_AMER_FF_UserandGroupsScenariosRolesPermissionsVerifyCreateUserGroupSuperAdmin_Esupport extends BaseTest
{	
	@Test
	public void validate_TC_5786192_AMER_FF_UserandGroupsScenariosRolesPermissionsVerifyCreateUserGroupSuperAdmin_Esupport() 
	{
		
		try
		{
			System.out.println("Starts TC_5786192_AMER_FF_UserandGroupsScenariosRolesPermissionsVerifyCreateUserGroupSuperAdmin_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5786192_AMER_FF_UserandGroupsScenariosRolesPermissionsVerifyCreateUserGroupSuperAdmin_Esupport--------->\n  "+e);
		}
	}
}

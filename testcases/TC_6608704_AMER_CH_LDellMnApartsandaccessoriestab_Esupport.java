...
public class TC_6608704_AMER_CH_LDellMnApartsandaccessoriestab_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6608704_AMER_CH_LDellMnApartsandaccessoriestab_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6608704_AMER_CH_LDellMnApartsandaccessoriestab_Esupport");
		...
		{
			Assert.fail("Failed in TC_6608704_AMER_CH_LDellMnApartsandaccessoriestab_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_5775823_AMER_FF_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5775823_AMER_FF_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# TC_5775823_AMER_FF_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5775823_AMER_FF_DigitalProductsScenarios_VerifyItemsperpage_Productspage_Esupport--------->\n  "+e);
		}
	}
}

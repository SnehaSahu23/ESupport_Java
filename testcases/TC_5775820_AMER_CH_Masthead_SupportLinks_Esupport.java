...
public class TC_5775820_AMER_CH_Masthead_SupportLinks_Esupport extends BaseTest{
	
	
	@Test
	public void validate_TC_5775820_AMER_CH_Masthead_SupportLinks_Esupport(){
		

		try
		{
			System.out.println("Starting 5775820..."); 
		...
		{
			Assert.fail("Failed while executing test case TC_5775820_AMER_CH_Masthead_SupportLinks_Esupport--------->\n  "+e);
		}

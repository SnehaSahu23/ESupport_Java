...
public class TC_10820686_AMER_IE_Story_10817039_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel_Logic extends BaseTest
{
	@Test
	public void validate_TC_10820686_AMER_IE_Story_10817039_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel_Logic()
	{
		try
		{
			System.out.println("Starts validate_TC_10820686_AMER_IE_Story_10817039_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel_Logic");
...
//			obj_EsupportIncidentsWorkflow.verifyRecommendTileOnOverViewTab(driver);//IssueType
		...
		{
			Assert.fail("Failed while TC_10820686_AMER_IE_Story_10817039_CXJ_FY22_JTSA_Contact_Channel_Layout_Recommended_Channel_Logic--------->\n  "+e);
		}
	}
}

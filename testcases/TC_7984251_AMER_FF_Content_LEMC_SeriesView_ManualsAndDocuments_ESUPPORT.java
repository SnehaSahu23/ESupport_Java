...
public class TC_7984251_AMER_FF_Content_LEMC_SeriesView_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984251_AMER_FF_Content_LEMC_SeriesView_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984251_AMER_FF_Content_LEMC_SeriesView_ManualsAndDocuments_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnBackToDocumentationTab(driver);
		...
		{
			Assert.fail("Failed in TC_7984251_AMER_FF_Content_LEMC_SeriesView_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

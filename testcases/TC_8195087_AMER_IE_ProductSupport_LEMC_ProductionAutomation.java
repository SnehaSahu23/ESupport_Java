...
public class TC_8195087_AMER_IE_ProductSupport_LEMC_ProductionAutomation extends BaseTest
{
	@Test
	public void validate_TC_8195087_AMER_IE_ProductSupport_LEMC_ProductionAutomation() 
	{
		try
		{
			System.out.println("Starts TC_8195087_AMER_IE_ProductSupport_LEMC_ProductionAutomation");
...
//			Thread.sleep(10000);
		...
		{
			Assert.fail("Failed executing TC_8195087_AMER_IE_ProductSupport_LEMC_ProductionAutomation--------->\n  "+e);
		}
	}
}

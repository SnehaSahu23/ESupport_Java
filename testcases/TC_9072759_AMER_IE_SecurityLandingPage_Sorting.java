...
public class TC_9072759_AMER_IE_SecurityLandingPage_Sorting extends BaseTest
{
	@Test
	public void validate_TC_9072759_AMER_IE_SecurityLandingPage_Sorting() 
	{
		try
		{
			System.out.println("Starts TC_9072759_AMER_IE_SecurityLandingPage_Sorting");
		...
		{
			Assert.fail("Failed in TC_9072759_AMER_IE_SecurityLandingPage_Sorting--------->\n  "+e);
		}
	}
}

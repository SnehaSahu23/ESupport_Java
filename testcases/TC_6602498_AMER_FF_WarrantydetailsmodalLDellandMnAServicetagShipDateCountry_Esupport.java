...
public class TC_6602498_AMER_FF_WarrantydetailsmodalLDellandMnAServicetagShipDateCountry_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6602498_AMER_FF_WarrantydetailsmodalLDellandMnAServicetagShipDateCountry_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6602498_AMER_FF_WarrantydetailsmodalLDellandMnAServicetagShipDateCountry_Esupport");
		...
		{
			Assert.fail("Failed in TC_6602498_AMER_FF_WarrantydetailsmodalLDellandMnAServicetagShipDateCountry_Esupport--------->\n  "+e);
		}
	}
}

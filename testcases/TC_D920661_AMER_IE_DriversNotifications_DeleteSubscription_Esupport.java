...
public class TC_D920661_AMER_IE_DriversNotifications_DeleteSubscription_Esupport extends BaseTest {

	@Test
	public void validate_TC_D920661_AMER_IE_DriversNotifications_DeleteSubscription_Esupport() 
	{
		try
		{
		...
		{
			Assert.fail("Failed while executing test case TC_D920661_AMER_IE_DriversNotifications_DeleteSubscription_Esupport--------->\n  "+e);
		}
	}
}

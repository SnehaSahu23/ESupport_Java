...
public class TC_5781071_AMER_CH_SavedSearchScenariosSavedSearchEditDateRangeandsaveHistory_Esupport extends BaseTest {
	@Test
	public void validate_TC_5781071_AMER_CH_SavedSearchScenariosSavedSearchEditDateRangeandsaveHistory_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5781071_AMER_CH_SavedSearchScenariosSavedSearchEditDateRangeandsaveHistory_Esupport");
		...
		{
			Assert.fail("Failed while executing test case TC_5781071_AMER_CH_SavedSearchScenariosSavedSearchEditDateRangeandsaveHistory_Esupport--------->\n  "+e);
		}
	}
}

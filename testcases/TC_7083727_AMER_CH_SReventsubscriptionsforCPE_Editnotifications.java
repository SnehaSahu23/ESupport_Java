...
public class TC_7083727_AMER_CH_SReventsubscriptionsforCPE_Editnotifications extends BaseTest
{
	@Test
	public void validate_TC_7083727_AMER_CH_SReventsubscriptionsforCPE_Editnotifications() 
	{
		try
		{
			System.out.println("Starts TC_7083727_AMER_CH_SReventsubscriptionsforCPE_Editnotifications");
			Thread.sleep(10000);	
			...
			Thread.sleep(5000);	
			obj_EsupportUnifiedPortalWorkflow.signOut(driver);
		...
		{
			Assert.fail("Failed in TC_7083727_AMER_CH_SReventsubscriptionsforCPE_Editnotifications--------->\n  "+e);
		}
	}
}

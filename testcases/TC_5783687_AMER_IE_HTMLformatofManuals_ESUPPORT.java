...
public class TC_5783687_AMER_IE_HTMLformatofManuals_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5783687_AMER_IE_HTMLformatofManuals_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_5783687_AMER_IE_HTMLformatofManuals_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5783687_AMER_IE_HTMLformatofManuals_ESUPPORT--------->\n  "+e);

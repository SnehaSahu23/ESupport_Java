...
public class TC_5772944_AMER_FF_Retail_Single_ServiceTag_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5772944_AMER_FF_Retail_Single_ServiceTag_Esupport() 
	{

		try
		{
			System.out.println("Starts TC# _5772944_AMER_FF"); 
		...
		{
			Assert.fail("Failed while executing test case TC_5772944_AMER_FF_Retail_Single_ServiceTag_Esupport--------->\n  "+e);
		}
	}
}

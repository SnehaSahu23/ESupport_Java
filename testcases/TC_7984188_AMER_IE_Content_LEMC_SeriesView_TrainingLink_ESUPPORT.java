...
public class TC_7984188_AMER_IE_Content_LEMC_SeriesView_TrainingLink_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984188_AMER_IE_Content_LEMC_SeriesView_TrainingLink_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984188_AMER_IE_Content_LEMC_SeriesView_TrainingLink_ESUPPORT()");
...
//			obj_EsupportCoveoWorkflow.ClickOnTrainingLink(driver);
		...
		{
			Assert.fail("Failed in TC_7984188_AMER_IE_Content_LEMC_SeriesView_TrainingLink_ESUPPORT()--------->\n  "+e);
		}
	}
}

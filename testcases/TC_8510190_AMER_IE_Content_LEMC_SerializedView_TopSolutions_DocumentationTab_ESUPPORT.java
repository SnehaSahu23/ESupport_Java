...
public class TC_8510190_AMER_IE_Content_LEMC_SerializedView_TopSolutions_DocumentationTab_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_8510190_AMER_IE_Content_LEMC_SerializedView_TopSolutions_DocumentationTab_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_8510190_AMER_IE_Content_LEMC_SerializedView_TopSolutions_DocumentationTab_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnLinkToServiceRequestLogoOfTopSolutionsForLEMCUser(driver);
		...
		{
			Assert.fail("Failed in TC_8510190_AMER_IE_Content_LEMC_SerializedView_TopSolutions_DocumentationTab_ESUPPORT()--------->\n  "+e);
		}
	}
}

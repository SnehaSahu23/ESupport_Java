...
public class TC_7704587_AMER_FF_ContactUS_LEMC_SRCreateHES_ViewAll_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_7704587_AMER_FF_ContactUS_LEMC_SRCreateHES_ViewAll_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_7704587_AMER_FF_ContactUS_LEMC_SRCreateHES_ViewAll_ESUPPORT");
...
//			obj_EsupportIncidentsWorkflow.ValidateDetailsDisplayedUnderAttachmentsInCreateServiceRequestWindowForLEMCUser(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_7704587_AMER_FF_ContactUS_LEMC_SRCreateHES_ViewAll_ESUPPORT--------->\n  "+e);

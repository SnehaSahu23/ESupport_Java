...
public class TC_7510789_AMER_FF_ServiceEvents_LEMC_Serialized_ServiceEventstab_Escalatedevents extends BaseTest
{
	@Test
	public void validate_TC_7510789_AMER_FF_ServiceEvents_LEMC_Serialized_ServiceEventstab_Escalatedevents() 
	{
		try
		{
			System.out.println("Starts TC_7510789_AMER_FF_ServiceEvents_LEMC_Serialized_ServiceEventstab_Escalatedevents");
		...
		{
			Assert.fail("Failed in TC_7510789_AMER_FF_ServiceEvents_LEMC_Serialized_ServiceEventstab_Escalatedevents--------->\n  "+e);
		}
	}
}

...
public class TC_9808730_AMER_CH_LBK_Content_LEMCOverviewtabtopsolutionsDocumentation_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9808730_AMER_CH_LBK_Content_LEMCOverviewtabtopsolutionsDocumentation_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9808730_AMER_CH_LBK_Content_LEMCOverviewtabtopsolutionsDocumentation_ESUPPORT()");
...
//			obj_EsupportIPSWorkflow.Emaillogin(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9808730_AMER_CH_LBK_Content_LEMCOverviewtabtopsolutionsDocumentation_ESUPPORT()--------->\n  "+e);
		}
	}
}

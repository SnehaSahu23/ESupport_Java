...
public class TC_5836667_AMER_ED_Support_Search_Integrated_HomePage_Handle_articleid_onsearchbox_Esupport extends BaseTest {
	@Test
	public void validate_TC_5836667_AMER_ED_Support_Search_Integrated_HomePage_Handle_articleid_onsearchbox_Esupport() 
	{
		...
		try
		{
			...
			Assert.fail("Failed while executing test case TC_5836667_AMER_ED_Support_Search_Integrated_HomePage_Handle_articleid_onsearchbox_Esupport--------->\n  "+e);

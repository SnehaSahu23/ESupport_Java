...
public class TC_5836502_AMER_IE_SupportSearch_IntegratedUX_Up_FilterPagination_implementation_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_5836502_AMER_IE_SupportSearch_IntegratedUX_Up_FilterPagination_implementation_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 5836502"); 
		...
		{
			Assert.fail("Failed while executing test case TC_5836502_AMER_IE_SupportSearch_IntegratedUX_Up_FilterPagination_implementation_ESUPPORT--------->\n  "+e);
		}
	}
}

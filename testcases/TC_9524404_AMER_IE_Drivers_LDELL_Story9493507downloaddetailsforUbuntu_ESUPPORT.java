...
public class TC_9524404_AMER_IE_Drivers_LDELL_Story9493507downloaddetailsforUbuntu_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_9524404_AMER_IE_Drivers_LDELL_Story9493507downloaddetailsforUbuntu_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9524404_AMER_IE_Drivers_LDELL_Story9493507downloaddetailsforUbuntu_ESUPPORT");
...
//			obj_EsupportDriverandDownloadsWorkflow.clickUbuntuLink(driver,TestNGCreator.TestData.get(Esupport.Dpid.ordinal()), TestNGCreator.TestData.get(Esupport.SearchOption.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9524404_AMER_IE_Drivers_LDELL_Story9493507downloaddetailsforUbuntu_ESUPPORT--------->\n  "+e);
		}
	}
}

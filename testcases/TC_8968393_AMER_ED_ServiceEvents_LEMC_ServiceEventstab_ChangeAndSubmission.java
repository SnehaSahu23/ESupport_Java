...
public class TC_8968393_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_ChangeAndSubmission extends BaseTest
{
	@Test
	public void validate_TC_8968393_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_ChangeAndSubmission() 
	{
		try
		{
			System.out.println("Starts TC_8968393_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_ChangeAndSubmission");
		...
		{
			Assert.fail("Failed in TC_8968393_AMER_ED_ServiceEvents_LEMC_ServiceEventstab_ChangeAndSubmission--------->\n  "+e);
		}
	}
}

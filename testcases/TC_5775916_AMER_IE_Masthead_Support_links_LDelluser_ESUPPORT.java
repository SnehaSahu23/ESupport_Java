...
public class TC_5775916_AMER_IE_Masthead_Support_links_LDelluser_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_5775916_AMER_IE_Masthead_Support_links_LDelluser_ESUPPORT() 
	{
...
//			obj_EsupportCoveoWorkflow.handleCookies(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_5775916_AMER_IE_Masthead_Support_links_LDelluser_ESUPPORT--------->\n  "+e);

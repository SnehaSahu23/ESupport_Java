...
public class TC_7699100_AMER_IE_ContentTab_LEMC_LegacyEMCComponentPage_SoftwareVersions_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7699100_AMER_IE_ContentTab_LEMC_LegacyEMCComponentPage_SoftwareVersions_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7699100_AMER_IE_ContentTab_LEMC_LegacyEMCComponentPage_SoftwareVersions_ESUPPORT()");
...
//			obj_EsupportIPSWorkflow.clickSignInHereLink(driver);
		...
		{
			Assert.fail("Failed in TC_7699100_AMER_IE_ContentTab_LEMC_LegacyEMCComponentPage_SoftwareVersions_ESUPPORT()--------->\n  "+e);
		}
	}
}

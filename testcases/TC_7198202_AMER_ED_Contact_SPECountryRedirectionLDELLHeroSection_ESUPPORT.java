...
public class TC_7198202_AMER_ED_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT extends BaseTest
{
	@Test
	public void validate_TC_7198202_AMER_ED_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7198202_AMER_ED_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT");
...
//			obj_EsupportIPSWorkflow.clickEnterServiceTagPopupCloseButton(driver);u
//			obj_EsupportIPSWorkflow.clickEnterServiceTagLink(driver);			
...
//			obj_EsupportIPSWorkflow.signOut(driver);
		...
		{
			Assert.fail("Failed in TC_7198202_AMER_ED_Contact_SPECountryRedirectionLDELLHeroSection_ESUPPORT--------->\n  "+e);
		}
	}
}

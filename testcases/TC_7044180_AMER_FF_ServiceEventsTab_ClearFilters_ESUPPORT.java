...
public class TC_7044180_AMER_FF_ServiceEventsTab_ClearFilters_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7044180_AMER_FF_ServiceEventsTab_ClearFilters_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7044180_AMER_FF_ServiceEventsTab_ClearFilters_ESUPPORT");
		...
		{
			Assert.fail("Failed in TC_7044180_AMER_FF_ServiceEventsTab_ClearFilters_ESUPPORT--------->\n  "+e);
		}
	}
}

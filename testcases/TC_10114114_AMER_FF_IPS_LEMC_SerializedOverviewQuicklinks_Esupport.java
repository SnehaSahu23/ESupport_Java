...
public class TC_10114114_AMER_FF_IPS_LEMC_SerializedOverviewQuicklinks_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10114114_AMER_FF_IPS_LEMC_SerializedOverviewQuicklinks_Esupport() throws Throwable 
	{
		try
		{
			System.out.println("Starts TC_10114114_AMER_FF_IPS_LEMC_SerializedOverviewQuicklinks_Esupport");
		...
		{
			Assert.fail("Failed in TC_10114114_AMER_FF_IPS_LEMC_SerializedOverviewQuicklinks_Esupport--------->\n  "+e);
		}
	}
}

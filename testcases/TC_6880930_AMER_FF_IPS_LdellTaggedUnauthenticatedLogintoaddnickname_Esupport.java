...
public class TC_6880930_AMER_FF_IPS_LdellTaggedUnauthenticatedLogintoaddnickname_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6880930_AMER_FF_IPS_LdellTaggedUnauthenticatedLogintoaddnickname_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6880930_AMER_FF_IPS_LdellTaggedUnauthenticatedLogintoaddnickname_Esupport");
		...
		{
			Assert.fail("Failed in TC_6880930_AMER_FF_IPS_LdellTaggedUnauthenticatedLogintoaddnickname_Esupport--------->\n  "+e);
		}
	}
}

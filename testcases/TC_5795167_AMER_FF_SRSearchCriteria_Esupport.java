...
public class TC_5795167_AMER_FF_SRSearchCriteria_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_5795167_AMER_FF_SRSearchCriteria_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_5795167_AMER_FF_SRSearchCriteria_Esupport");
		...
		{
			Assert.fail("Failed while TC_5795167_AMER_FF_SRSearchCriteria_Esupport--------->\n  "+e);
		}
	}
}

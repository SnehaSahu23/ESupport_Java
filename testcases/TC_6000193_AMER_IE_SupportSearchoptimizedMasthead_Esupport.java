...
public class TC_6000193_AMER_IE_SupportSearchoptimizedMasthead_Esupport extends BaseTest 
{
	@Test
	public void validate_TC_6000193_AMER_IE_SupportSearchoptimizedMasthead_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6000193_AMER_IE_SupportSearchoptimizedMasthead_Esupport");
		...
		{
			Assert.fail("Failed while TC_6000193_AMER_IE_SupportSearchoptimizedMasthead_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_5836585_AMER_FF_SupportSearchIntegratedUXSearchboxImplementation_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5836585_AMER_FF_SupportSearchIntegratedUXSearchboxImplementation_Esupport() 
	{

		try
		{
			System.out.println("Starts TC_5836585_AMER_FF_SupportSearchIntegratedUXSearchboxImplementation_Esupport");
...
//			obj_EsupportCoveoWorkflow.validateSupportHeader_ServiceTag(driver,TestNGCreator.TestData.get(Esupport.ServiceTag.ordinal()).split(";")[2]);
			...
			Assert.fail("Failed while executing test case TC_5836585_AMER_FF_SupportSearchIntegratedUXSearchboxImplementation_Esupport--------->\n  "+e);

...
public class TC_12302719_AMER_CH_Retail_Ownership_Transfer extends BaseTest
{
    @Test
    public void validate_TC_12302719_AMER_CH_Retail_Ownership_Transfer() 
    {
    	try 
    	{
    		System.out.println("Starts TC_12302719_AMER_CH_Retail_Ownership_Transfer");
		...
		{
			Assert.fail("Failed in TC_12302719_AMER_CH_Retail_Ownership_Transfer--------->\n  "+e);
		}
    }

...
public class TC_10645518_AMER_IE_Story_10604530_CXJ_FY22_JTSA_Contact_Channel_Layout_Grayed_Out_Channels extends BaseTest
{
	@Test
	public void validate_TC_10645518_AMER_IE_Story_10604530_CXJ_FY22_JTSA_Contact_Channel_Layout_Grayed_Out_Channels()
	{
		try 
		{
...
//			obj_EsupportIncidentsWorkflow.clickOnNextButtonOnProductPage(driver);
		...
		{
			Assert.fail("Failed while TC_10645518_AMER_IE_Story_10604530_CXJ_FY22_JTSA_Contact_Channel_Layout_Grayed_Out_Channels--------->\n  "+e);
		}
	}
}

...
public class TC_6880796_AMER_FF_IPS_LDellTaggedOverviewTabQuicklinks_Esupport extends BaseTest
{
	@Test
	public void validate_TC_6880796_AMER_FF_IPS_LDellTaggedOverviewTabQuicklinks_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6880796_AMER_FF_IPS_LDellTaggedOverviewTabQuicklinks_Esupport");			
		...
		{
			Assert.fail("Failed in TC_6880796_AMER_FF_IPS_LDellTaggedOverviewTabQuicklinks_Esupport--------->\n  "+e);
		}
	}
}

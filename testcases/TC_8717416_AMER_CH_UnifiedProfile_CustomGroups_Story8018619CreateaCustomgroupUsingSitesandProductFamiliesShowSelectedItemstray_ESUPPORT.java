...
public class TC_8717416_AMER_CH_UnifiedProfile_CustomGroups_Story8018619CreateaCustomgroupUsingSitesandProductFamiliesShowSelectedItemstray_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_8717416_AMER_CH_UnifiedProfile_CustomGroups_Story8018619CreateaCustomgroupUsingSitesandProductFamiliesShowSelectedItemstray_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_8717416_AMER_CH_UnifiedProfile_CustomGroups_Story8018619CreateaCustomgroupUsingSitesandProductFamiliesShowSelectedItemstray_ESUPPORT");
			Thread.sleep(6000);
			...
			Assert.fail("Failed while executing test case TC_8717416_AMER_CH_UnifiedProfile_CustomGroups_Story8018619CreateaCustomgroupUsingSitesandProductFamiliesShowSelectedItemstray_ESUPPORT--------->\n  "+e);

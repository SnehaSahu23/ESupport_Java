...
public class TC_D920582_AMER_IE_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_D920582_AMER_IE_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT() 
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_D920582_AMER_IE_DriversNotifications_CreateEmailSubscription_Frequency_ESUPPORT--------->\n  "+e);

...
public class TC_9404238_AMER_CH_LBK_OpenContent_HowTo_Internal_L50_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9404238_AMER_CH_LBK_OpenContent_HowTo_Internal_L50_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9404238_AMER_CH_LBK_OpenContent_HowTo_Internal_L50_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ToLogin_ValidCredentials(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9404238_AMER_CH_LBK_OpenContent_HowTo_Internal_L50_ESUPPORT()--------->\n  "+e);
		}
	}
}

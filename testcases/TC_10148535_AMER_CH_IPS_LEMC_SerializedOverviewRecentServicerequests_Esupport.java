...
public class TC_10148535_AMER_CH_IPS_LEMC_SerializedOverviewRecentServicerequests_Esupport extends BaseTest
{
	@Test
	public void validate_TC_10148535_AMER_CH_IPS_LEMC_SerializedOverviewRecentServicerequests_Esupport() throws Throwable 
	{
		try
		{
		...
		{
			Assert.fail("Failed in TC_10148535_AMER_CH_IPS_LEMC_SerializedOverviewRecentServicerequests_Esupport--------->\n  "+e);
		}
	}
}

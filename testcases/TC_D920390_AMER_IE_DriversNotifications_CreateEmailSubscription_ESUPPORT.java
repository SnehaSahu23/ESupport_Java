...
public class TC_D920390_AMER_IE_DriversNotifications_CreateEmailSubscription_ESUPPORT extends BaseTest{
	@Test
	public void validate_TC_D920390_AMER_IE_DriversNotifications_CreateEmailSubscription_ESUPPORT() 
	{
		try
		{
		...
		{
			Assert.fail("Failed while executing test case TC_D920390_AMER_IE_DriversNotifications_CreateEmailSubscription_ESUPPORT--------->\n  "+e);
		}
	}
}

...
public class TC_5784228_AMER_CH_OrderHistoryScenarios_Verifysummarysection_orderdetailspage_Esupport extends BaseTest
{
	@Test
	public void validate_TC_5784228_AMER_CH_OrderHistoryScenarios_Verifysummarysection_orderdetailspage_Esupport() 
	{
		...
		{
			Assert.fail("Failed while executing test case TC_5784228_AMER_CH_OrderHistoryScenarios_Verifysummarysection_orderdetailspage_Esupport--------->\n  "+e);
		}
	}
}

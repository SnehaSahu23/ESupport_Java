...
public class TC_7510596_AMER_CH_ServiceEvents_LEMC_Overviewtab_DisplayActiveServiceEventsinfo_Escalation extends BaseTest
{
	@Test
	public void validate_TC_7510596_AMER_CH_ServiceEvents_LEMC_Overviewtab_DisplayActiveServiceEventsinfo_Escalation() 
	{
		try
		{
			System.out.println("Starts TC_7510596_AMER_CH_ServiceEvents_LEMC_Overviewtab_DisplayActiveServiceEventsinfo_Escalation");
		...
		{
			Assert.fail("Failed in TC_7510596_AMER_CH_ServiceEvents_LEMC_Overviewtab_DisplayActiveServiceEventsinfo_Escalation--------->\n  "+e);
		}
	}
}

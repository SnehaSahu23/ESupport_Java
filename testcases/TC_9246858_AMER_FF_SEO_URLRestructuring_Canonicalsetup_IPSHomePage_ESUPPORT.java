...
public class TC_9246858_AMER_FF_SEO_URLRestructuring_Canonicalsetup_IPSHomePage_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_9246858_AMER_FF_SEO_URLRestructuring_Canonicalsetup_IPSHomePage_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC_9246858_AMER_FF_SEO_URLRestructuring_Canonicalsetup_IPSHomePage_ESUPPORT");
...
//			obj_EsupportSEOWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_9246858_AMER_FF_SEO_URLRestructuring_Canonicalsetup_IPSHomePage_ESUPPORT--------->\n  "+e);

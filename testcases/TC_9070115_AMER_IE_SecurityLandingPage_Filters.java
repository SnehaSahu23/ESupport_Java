...
public class TC_9070115_AMER_IE_SecurityLandingPage_Filters extends BaseTest
{
	@Test
	public void validate_TC_9070115_AMER_IE_SecurityLandingPage_Filters() 
	{
		try
		{
			System.out.println("Starts TC_9070115_AMER_IE_SecurityLandingPage_Filters");
		...
		{
			Assert.fail("Failed in TC_9070115_AMER_IE_SecurityLandingPage_Filters--------->\n  "+e);
		}
	}
}
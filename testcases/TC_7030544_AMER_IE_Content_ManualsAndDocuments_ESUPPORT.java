...
public class TC_7030544_AMER_IE_Content_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7030544_AMER_IE_Content_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7030544_AMER_IE_Content_ManualsAndDocuments_ESUPPORT()");
		...
		{
			Assert.fail("Failed in TC_7030544_AMER_IE_Content_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_9785714_AMER_ED_LBK_OpenContent_HowTo_Partner_L40_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785714_AMER_ED_LBK_OpenContent_HowTo_Partner_L40_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785714_AMER_ED_LBK_OpenContent_HowTo_Partner_L40_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ToLogin_ValidCredentials(driver,TestNGCreator.TestData.get(Esupport.Username.ordinal()),TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed in TC_9785714_AMER_ED_LBK_OpenContent_HowTo_Partner_L40_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_7984033_AMER_IE_Content_LEMC_FamilyView_KnowledgebaseArticles_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984033_AMER_IE_Content_LEMC_FamilyView_KnowledgebaseArticles_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984033_AMER_IE_Content_LEMC_FamilyView_KnowledgebaseArticles_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ChangeBackToDisplayedCountry(driver);
		...
		{
			Assert.fail("Failed in TC_7984033_AMER_IE_Content_LEMC_FamilyView_KnowledgebaseArticles_ESUPPORT()--------->\n  "+e);
		}
	}
}

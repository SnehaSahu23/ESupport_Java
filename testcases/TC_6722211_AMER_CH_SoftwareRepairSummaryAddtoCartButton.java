...
public class TC_6722211_AMER_CH_SoftwareRepairSummaryAddtoCartButton extends BaseTest
{
	@Test
	public void validate_TC_6722211_AMER_CH_SoftwareRepairSummaryAddtoCartButton() 
	{
		try
		{
			System.out.println("Starts TC_6722211_AMER_CH_SoftwareRepairSummaryAddtoCartButton");
		...
		{
			Assert.fail("Failed in TC_6722211_AMER_CH_SoftwareRepairSummaryAddtoCartButton--------->\n  "+e);
		}
	}
}

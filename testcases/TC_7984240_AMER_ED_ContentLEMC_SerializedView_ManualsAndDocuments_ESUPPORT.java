...
public class TC_7984240_AMER_ED_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_7984240_AMER_ED_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_7984240_AMER_ED_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.ClickOnLinkToServiceRequestLogoOfManualsAndDocumentsForLEMCUser(driver);
		...
		{
			Assert.fail("Failed in TC_7984240_AMER_ED_ContentLEMC_SerializedView_ManualsAndDocuments_ESUPPORT()--------->\n  "+e);
		}
	}
}

...
public class TC_6081678_AMER_IE_Driverupdates_Newsubscription_Esupport extends BaseTest {

	@Test
	public void validate_TC_6081678_AMER_IE_Driverupdates_Newsubscription_Esupport() 
	{
		try
		{
			System.out.println("Starts TC# _6081678_IE");  
		...
		{
			Assert.fail("Failed while executing test case TC_6081678_AMER_IE_Driverupdates_Newsubscription_Esupport--------->\n  "+e);
		}
	}
}

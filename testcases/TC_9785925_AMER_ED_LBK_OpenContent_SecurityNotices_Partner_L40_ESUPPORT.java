...
public class TC_9785925_AMER_ED_LBK_OpenContent_SecurityNotices_Partner_L40_ESUPPORT extends BaseTest {


	@Test
	public void validate_TC_9785925_AMER_ED_LBK_OpenContent_SecurityNotices_Partner_L40_ESUPPORT() 
	{
		try
		{
			System.out.println("Starts TC_9785925_AMER_ED_LBK_OpenContent_SecurityNotices_Partner_L40_ESUPPORT()");
...
//			obj_EsupportContentWorkflow.validateSummaryFunctionality(driver);
		...
		{
			Assert.fail("Failed in TC_9785925_AMER_ED_LBK_OpenContent_SecurityNotices_Partner_L40_ESUPPORT()--------->\n  "+e);
		}
	}
}

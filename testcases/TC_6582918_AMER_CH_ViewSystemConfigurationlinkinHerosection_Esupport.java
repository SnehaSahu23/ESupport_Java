...
public class TC_6582918_AMER_CH_ViewSystemConfigurationlinkinHerosection_Esupport  extends BaseTest
{
	@Test
	public void validate_TC_6582918_AMER_CH_ViewSystemConfigurationlinkinHerosection_Esupport() 
	{
		try
		{
			System.out.println("Starts TC_6582918_AMER_CH_ViewSystemConfigurationlinkinHerosection_Esupport");
		...
		{
			Assert.fail("Failed in TC_6582918_AMER_CH_ViewSystemConfigurationlinkinHerosection_Esupport--------->\n  "+e);
		}
	}
}

...
public class TC_9899199_AMER_ED_GOS_PCF_OrdersupportTransactionalMyaccount_ESUPPORT extends BaseTest {

	@Test
	public void validate_TC_9899199_AMER_ED_GOS_PCF_OrdersupportTransactionalMyaccount_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# TC_9899199_AMER_ED_GOS_PCF_OrdersupportTransactionalMyaccount_ESUPPORT");        
			...
			Assert.fail("Failed while executing test case TC_9899199_AMER_ED_GOS_PCF_OrdersupportTransactionalMyaccount_ESUPPORT--------->\n  "+e);

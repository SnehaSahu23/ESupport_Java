...
public class TC_8194733_AMER_FF_EREV_EnableSoftwarerepairOfferinUS extends BaseTest
{
	@Test
	public void validate_TC_8194733_AMER_FF_EREV_EnableSoftwarerepairOfferinUS() 
	{
		try
		{
			System.out.println("Starts TC_8194733_AMER_FF_EREV_EnableSoftwarerepairOfferinUS");
...
//			driver.navigate().to("https://www.dell.com/support/home");
		...
		{
			Assert.fail("Failed in TC_8194733_AMER_FF_EREV_EnableSoftwarerepairOfferinUS--------->\n  "+e);
		}
	}
}

...
public class TC_8963710_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Advisories extends BaseTest
{
	@Test
	public void validate_TC_8963710_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Advisories() 
	{
		try
		{
			System.out.println("Starts TC_8963710_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Advisories");
		...
		{
			Assert.fail("Failed in TC_8963710_AMER_IE_ServiceEvents_LEMC_ServiceEventstab_Advisories--------->\n  "+e);
		}
	}
}
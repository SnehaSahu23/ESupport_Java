...
public class TC_7689994_AMER_FF_IPS_LEMC_ConvergedSolutionMapLocation extends BaseTest
{
	@Test
	public void validate_TC_7689994_AMER_FF_IPS_LEMC_ConvergedSolutionMapLocation() 
	{
		try
		{
			System.out.println("Starts TC_7689994_AMER_FF_IPS_LEMC_ConvergedSolutionMapLocation");
...
//			obj_EsupportIPSWorkflow.employeeLogin_Firefox(driver, TestNGCreator.TestData.get(Esupport.Username.ordinal()), TestNGCreator.TestData.get(Esupport.Password.ordinal()));
		...
		{
			Assert.fail("Failed executing TC_7689994_AMER_FF_IPS_LEMC_ConvergedSolutionMapLocation--------->\n  "+e);
		}
	}
}

...
public class TC_6106645_AMER_ED_CoveoSearchResults_SRcreation_DELLProducts_ESUPPORT extends BaseTest 
{
	@Test
	public void validate_TC_6106645_AMER_ED_CoveoSearchResults_SRcreation_DELLProducts_ESUPPORT() 
	{

		try
		{
			
			System.out.println("Starts TC_6106645_AMER_ED_CoveoSearchResults_SRcreation_DELLProducts_ESUPPORT");
		...
		catch(Exception e)
		{
			...
			Assert.fail("Failed while TC_6106645_AMER_ED_CoveoSearchResults_SRcreation_DELLProducts_ESUPPORT--------->\n  "+e);

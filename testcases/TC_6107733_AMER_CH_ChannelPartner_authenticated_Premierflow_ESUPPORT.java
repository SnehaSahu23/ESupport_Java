...
public class TC_6107733_AMER_CH_ChannelPartner_authenticated_Premierflow_ESUPPORT extends BaseTest {
	@Test
	public void validate_TC_6107733_AMER_CH_ChannelPartner_authenticated_Premierflow_ESUPPORT() 
	{

		try
		{
			System.out.println("Starts TC# 6107733_AMER_CH");
			...
			Assert.fail("Failed while executing test case TC_6107733_AMER_CH_ChannelPartner_authenticated_Premierflow_ESUPPORT--------->\n  "+e);
